<div id="header" class="app-header">
  ...
  <div class="navbar-nav">
      ...
      @endforeach
      <div class="navbar-item navbar-form d-none d-lg-block" style="line-height:0; padding:0 5px;">
      ...
      <div class="navbar-item navbar-user dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end me-1">
              ...
              @if($aller == 0)
                <a href="detail_pos_session?id={{$id}}&ref={{$ref}}&active=5&champ=1-1" wire:navigate class="dropdown-item text-black d-flex align-items-center">Backend</a>
              @elseif($aller == -1)
                <a href="detail_restau_session?id={{$id}}&ref={{$ref}}&active=5&champ=2-1&choix=1" wire:navigate class="dropdown-item text-black d-flex align-items-center">Backend</a>
              @elseif($aller == -2)
                <a href="detail_restau_session?id={{$id}}&ref={{$ref}}&active=5&champ=2-1&choix=1" wire:navigate class="dropdown-item text-black d-flex align-items-center">Backend</a>
              @elseif($aller == -3)
                <a href="restau_sessions?active=5&champ=2-1&choix=1" wire:navigate class="dropdown-item text-black d-flex align-items-center">Backend</a>
              @endif
