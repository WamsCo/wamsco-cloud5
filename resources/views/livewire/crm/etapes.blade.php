<div>
            ...
            <div class="profile-header">        
                ...
                <div class="profile-header-content">
                    <div class="profile-header-info">
                        ...
                        {{-- <h1 class="page-header mb-1">{{$title_fils}} » <span style="color:yellow">{{$etapeCount}}</span></h1>   --}}
                    </div> 
                </div> 
            </div>
        </div>
            ...
            <div class="col-sm-12">
                            ...
                            <div class="col-lg-12">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2">
                                            ...
                                            <div class="d-flex align-items-center px-3 flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="d-block fw-bold text-secondary" style="font-size: 11px;">Nombre Total catégorie</span>
                                                    <span class="d-block fw-semibold text-dark" style="font-size: 13px;">{{$nbreTotalCategorie}}</span>
                                            ...
                                            {{-- <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="fw-bold text-secondary" style="font-size: 11px;">Catégorie restaurant</span>
                                                    <span class="d-block fw-bold text-dark mt-1" style="font-size: 14px;"> <span style="font-size: 10px;"></span></span>
                                                </div>
                                            </div> --}}
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-1">
                                    ...
                                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">
                                        <li class="nav-item">                                                
                                            <a class="nav-link active" data-bs-toggle="tab" href="#home"><i class="fas fa-users text-bleu"></i> {{$title_fils}} (<span class="text-vert">{{$etapeCount}}</span>)</a>                                                
                                        </li>  
                                        <li class="nav-item">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1">                            
                                            <button href="#" data-bs-toggle="modal" data-bs-target="#ajoutEtapeModal" title="Cliquez pour ajouter" data-toggle="tooltip" class="btn btn-sm btn-danger ms-auto"><i class="fa fa-plus-circle"></i> Nouvelle étape</button>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-12 px-0">   
                                                <div class="card shadow-sm border border-light-subtle rounded-3 bg-white px-0">
                                                    ...
                                                    <div class="table-responsive border-top">
                                                        <div class="hauteur_ecran">
                                                            <div class="row pt-2 px-2">
                                                                @foreach($etape as $etapes)	
                                                                    <div class="col-lg-4 col-md-6 col-xs-12 mb-2 pointer" wire:click.prevent="edit('{{$etapes->id}}')" data-bs-toggle="modal" data-bs-target="#updateEtapeModal" title="Cliquez pour modifier ou supprimer" data-toggle="tooltip">                            
                                                                        <div class="row rounded border list_achat">                                        
                                                                            ...
                                                                            <div class="col-md-8 col-sm-8 col-xs-8 mb-2"> 
                                                                                <span class="date_achat">{{date('d-m-Y H:i:s', strtotime($etapes->created_at))}} <i class="fa fa-calendar-alt light"></i> <i class="fa fa-check-circle @if($etapes->opacite == "Oui") text-vert @else text-danger @endif" title="Opacité @if($etapes->opacite == "Oui") » Activée @else » Désactivée @endif"></i></span>
                                                                            </div>
                                                                            <div class="col-md-4 col-sm-4 col-xs-4 mb-2">
                                                                                <span class="entite_cat truncate_ok" title="{{$etapes->nom_user}}">{{Str::limit($etapes->nom_user, 12)}}</span>
                                                                            </div>                                        
                                                                        </div>                                                                
                                                                    </div> 
                                                                @endforeach
                                                        ...
                                                        <div class="bloc_pagination">{{$etape->links()}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                {{-- <div class="card mb-0 bg-2k">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="card-title text-bleu"><i class="fa fa-chart-pie text-danger" aria-hidden="true"></i> {{$title_fils}} ({{$etapeCount}})</h5>
                        <a href="#" class="btn btn-sm btn-danger ms-auto" title=" Cliquez pour ajouter" data-bs-toggle="modal" data-bs-target="#ajoutEtapeModal"><i class="fa fa-plus-circle"></i> Nouvelle étape</a>
                    </div>
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <div class="">
                            <select name="" wire:model.lazy="parPage" id="par_page" class="form-control form-select bordure w-auto"> 
    ...
    {{-- Modal --}}
    @include('livewire.crm.create')
    @include('livewire.crm.update') 
</div>
