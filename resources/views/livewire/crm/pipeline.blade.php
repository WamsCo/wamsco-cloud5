        ...
        <div class="row gx-4">
            ...
            <div class="col-sm-12">
                <div class="card mb-4 bg-2k">
                    ...
                    <div class="card-header w_contenu px-0 py-0">
                        <div class="d-flex align-items-center justify-content-end gap-3 pt-0 pb-1 px-2">                                                 
                            <div class="row g-2 align-items-center">
                                <div class="col-12 col-md-auto">
                                    <div class="d-flex gap-1">
                                        <input type="date" wire:model.live="date_debut" class="form-control bordure">
                                        <input type="date" wire:model.live="date_fin" class="form-control bordure">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 col-lg-auto">
                                    <select wire:model.live="parSource" class="form-select bordure">
                                ...
                                @if(auth()->user()->type_user == "Administrateur")
                                    <div class="col-12 col-sm-6 col-lg-auto">
                                        <select wire:model.live="parUser" class="form-select bordure"> 
                                ...
                                @endif 
                                <div class="col-12 col-sm-6 col-lg-auto">
                                    <label for="parCap" class="visually-hidden">Recherche</label>
                                    <input type="search" wire:model.live="parCap" id="parCap" class="form-control bordure" placeholder="Rech. campagne">
                                </div> 
                                <div class="col-12 col-sm-6 col-lg-auto">
                                    <label for="parSec" class="visually-hidden">Recherche</label>
