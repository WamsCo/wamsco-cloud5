                            ...
                            <div class="col-lg-12">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2">
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">                                                
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="d-block fw-bold text-secondary" style="font-size: 11px;">Total compte</span>
                                                    <span class="d-block fw-semibold text-dark" style="font-size: 13px;">{{number_format($nbreTotalEcritureBancaire,0,',',' ')}}</span>
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-1">
                                    ...
                                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">
                                        <li class="nav-item">                                                
                                            <a class="nav-link active" data-bs-toggle="tab" href="#home" title="Listing {{$title_fils}}"><i class="fas fa-receipt text-bleu"></i> {{$title_fils}} (<span class="text-vert">{{$ecritureCount}}</span>)</a>                                                
                                        </li>  
                                        <li class="nav-item">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1">   
                                            {{-- <button class="btn btn-sm btn-danger ms-auto" title="Cliquez pour enregistrer" data-toggle="tooltip" wire:click.prevent="()"><i class="fa fa-plus-circle"></i> Nouvelle Banque/Caisse</button>                          --}}
                                                ...
                                                <div class="card shadow-sm border border-light-subtle rounded-3 bg-white px-0">
                                                    <div class="d-flex align-items-center justify-content-between gap-3 pt-2 px-2">
                                                        <div class="d-flex align-items-center justify-content-between gap-1">
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between gap-1">
                                                                <h6><a href="{{asset('exporter-ecriture_banq')}}" class="btn btn-sm btn-success mt-2 d-none d-md-block"><i class="fa-solid fa-file-export"></i> Exporter Excel</a></h6>
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between gap-1">
                                                            ...
                                                            <div class="">
                                                                <select wire:model.live="parCompte" class="form-control form-select bordure w-auto"> 
                                                                    <option value="">Tous les comptes</option>
                                                                    @foreach($compteBanq as $compteBanqs)
                                                                        <option value={{$compteBanqs->id}}>{{$compteBanqs->nom_compte_bancaire}}</option>
                                                                    @endforeach
                                                                </select> 
                                                            </div>                            
                                                            <div>
                                                    ...
                                                    <div class="table-responsive border-top">
                                                        <table class="table table-striped table-hover text-nowrap m-0"> 
                                                            <thead>
                                                                <tr>
                                                                    {{-- <th class="fond_entete_table pointer" wire:click="setOrderField('id')">#</th> --}}
                                                                    ...
                                                                    <th class="fond_entete_table text-end pointer" wire:click="setOrderField('solde')">Solde <i class="fas fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="top" style="vertical-align: middle; cursor: help" aria-label="Votre solde à ce jour" data-bs-original-title="Votre solde à ce jour"></i></th>
                                                                    <th class="fond_entete_table pointer text-start" wire:click="setOrderField('date_operation')">Date opération <i class="fa fa-arrow-down-short-wide"></i></th>
                                                                    <th class="fond_entete_table pointer text-start" wire:click="setOrderField('date_valeur')">Date valeur <i class="fa fa-arrow-down-short-wide"></i></th>
                                                                    {{-- <th class="fond_entete_table text-center pointer" wire:click="setOrderField('numero')">Numéro <i class="fa fa-arrow-down-short-wide"></i></th> --}}
                                                                    {{-- <th class="fond_entete_table text-end pointer" wire:click="setOrderField('solde')">Solde <i class="fas fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="top" style="vertical-align: middle; cursor: help" aria-label="Votre solde à ce jour" data-bs-original-title="Votre solde à ce jour"></i></th> --}}
                                                                    {{-- <th class="fond_entete_table pointer" wire:click="setOrderField('releve')">Relevé</th> --}}
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('statut')">Statut <i class="fa fa-arrow-down-short-wide"></i></th>
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('rapprochement')">Rapproché <i class="fa fa-arrow-down-short-wide"></i></th>
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('numeru_cheque')">Chèque N° <i class="fa fa-arrow-down-short-wide"></i></th>
                                                            ...
                                                            <tbody>
                                                                @foreach($ecriture as $ecritures)
                                                                    <tr> 
                                                                        {{-- <td class="">#{{$ecritures->id}}</td>      --}}
                                                                        <td class="fw-semibold"><a href="#" class="text-bleu"><i class="fa fa-receipt text-danger" aria-hidden="true"></i> {{$ecritures->reference}}</a></td> 
                                                                        ...
                                                                        <td class=" fw-semibold"><a href="detail_banque?id={{$ecritures->id_compte_bancaire}}&active=8&champ=1-1" wire:navigate class="text-bleu"><i class="fa fa-university text-danger" aria-hidden="true"></i> {{$ecritures->nom_compte_bancaire}}</a></td>  
                                                                        <td class="fw-semibold">{{$ecritures->type_operation}}</td>  
                                                                        <td class="fw-semibold"><a href="detail_tier?id={{$ecritures->id_tiers}}&active=3&champ=3-2" wire:navigate class="text-bleu">@if($ecritures->tiers)<i class="fa fa-user-circle text-bleu" aria-hidden="true"></i>@endif {{$ecritures->tiers}}</a></td>                                                 
                                                                        ...
                                                                        <td class="text-start">{{date('d/m/Y', strtotime($ecritures->date_operation))}}</td>         
                                                                        <td class="text-start">{{date('d/m/Y', strtotime($ecritures->date_valeur))}}</td>  
                                                                        {{-- <td class="text-center fw-semibold">{{$ecritures->numero}}</td>   --}} 
                                                                        {{-- <td class="text-end fw-semibold">@if($ecritures->solde > 0 ) {{number_format($ecritures->solde,0,',',' ')}} @endif</td>   --}}
                                                                        {{-- <td class="text-center fw-semibold">{{$ecritures->releve}}</td>   --}}                                                
                                                                        <td class="fw-semibold">
                                                                            @if($ecritures->statut == "En cours")
                                                                                <span class="badge bg-secondary py-1" title="Facture {{$ecritures->statut}}"><i class="fa fa-refresh"></i> {{$ecritures->statut}}</span>                                                    
                                                                            @elseif($ecritures->statut == "Confirmer")
                                                                                <span class="badge bg-success py-1" title="Facture {{$ecritures->statut}}"><i class="fa fa-check-circle"></i> {{$ecritures->statut}}</span>
                                                                            @else
                                                                                <span class="badge bg-danger py-1" title="Statut Non défini"><i class="fa fa-thumbs-down"></i> Non défini</span>
                                                                            @endif 
                                                                        </td>                                                
                                                                        <td class="fw-semibold">{{$ecritures->rapprochement}}</td>  
                                                                        <td class="fw-semibold">{{$ecritures->numeru_cheque}}</td>  
                                                                        <td class="fw-semibold">
                                                                        ...
                                                                        {{-- <td class=""><a href="#" wire:navigate class=""  title="Cliquez pour modifier" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-pencil"></i></a></td>  --}}
                                                                        <td class="text-end fw-semibold">
                                                                            @if($confirmer === $ecritures->id)                                                               
                                                                                <a wire:click.prevent="supprimer({{$ecritures->id}})" class="btn btn-outline-danger btn-xs bg-danger text-white blink" style="font-size: 8px;" title="Cliquez pour confirmer la suppression"  style="font-size: 9px;" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"> Confirmer?</i></a>
                                                                            @else
                                                                                <a wire:click.prevent="confirmerDelete({{$ecritures->id}})" class="btn-outline-muted btn-xs pointer"  title="Cliquez pour supprimer" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"></i></a>
                                                                            @endif
                                                                        </td>
                                                                    </tr>                                             
                                                                @endforeach 
