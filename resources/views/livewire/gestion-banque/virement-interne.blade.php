                            ...
                            <div class="col-lg-12">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2">
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">                                                
                                                ...
                                                <div class="text-nowrap">
                                                    ...
                                                    <span class="d-block fw-semibold text-dark" style="font-size: 13px;">Actif : {{number_format($nbreTotalCompteBancaire,0,',',' ')}}</span>
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-1">
                                    ...
                                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">
                                        <li class="nav-item">                                                
                                            <a class="nav-link active" data-bs-toggle="tab" href="#home" title="Listing {{$title_fils}}"><i class="fas fa-refresh text-bleu"></i> {{$title_fils}}</a>                                                
                                        </li>  
                                        <li class="nav-item">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-12 px-0">   
                                                <div class="card shadow-sm border border-light-subtle rounded-3 bg-white px-0">
                                                    <div class="d-flex align-items-center justify-content-between gap-3 pt-2 px-2">
                                                        <div class="d-flex align-items-center justify-content-between gap-1">
                                                            <div class="text-muted fw-semibold pb-2">
                                                                Pour le virement interne d'un compte à un autre, l'application enregistrera deux opérations : un débit sur le compte d'origine et un crédit sur le compte de destination. La transaction utilisera le même montant, la même description et la même date pour les deux enregistrements.
                                                            </div>
                                                            <div class="d-flex align-items-center justify-content-between gap-1">
                                                    ...
                                                    <div class="table-responsive border-top">
                                                        <table class="table table-stripedk table-hoverk text-nowrap m-0"> 
                                                            <thead>
                                                                <tr>
                                                                    <th class="fond_entete_table">De</th>
                                                                    <th class="fond_entete_table">@if($compte_source)Vers @endif</th>
                                                            ...
                                                            <tbody>                                        
                                                                <tr> 
                                                                    <td class="px-3">  
                                                                        <div class="row mt-3">  
                                                                            <div class="col-sm-12">                                                        
                                                                                <select id="compte_source" wire:model.live="compte_source" class="form-control form-select fw-semibold bordure w-auto @error('compte_source') is-invalid @enderror">
                                                                                    <option value=""></option>	
                                                                                    @foreach($compte_banque as $compte_banques)
                                                                                        <option value="{{$compte_banques->id}}">{{substr($compte_banques->nom_compte_bancaire,0,22) > substr($compte_banques->nom_compte_bancaire,0,21) ? substr($compte_banques->nom_compte_bancaire,0,22).'...': $compte_banques->nom_compte_bancaire}}</option>
                                                                                    @endforeach	
                                                                                </select> 
                                                                            </div>
                                                                            <div class="d-flex justify-content-start">
                                                                                @error('compte_source') <span class="text-danger">{{ $message }}</span> @enderror 
                                                                            </div>   
                                                                        </div>  
                                                                    </td>
                                                                    <td class="px-3">  
                                                                        <div class="row mt-3">  
                                                                            <div class="col-sm-12">  
                                                                                @if($compte_source)                                                      
                                                                                    <select id="compte_destination" wire:model.live="compte_destination" class="form-control form-select fw-semibold bordure w-auto @error('compte_destination') is-invalid @enderror">
                                                                                        <option value=""></option>	
                                                                                        @foreach($compte_banque as $compte_banques)
                                                                                            @if($compte_source != $compte_banques->id)
                                                                                                <option value="{{$compte_banques->id}}">{{substr($compte_banques->nom_compte_bancaire,0,22) > substr($compte_banques->nom_compte_bancaire,0,21) ? substr($compte_banques->nom_compte_bancaire,0,22).'...': $compte_banques->nom_compte_bancaire}}</option>
                                                                                            @endif
                                                                                        @endforeach	
                                                                                    </select> 
                                                                            ...
                                                                            <div class="d-flex justify-content-start">
                                                                                @error('compte_destination') <span class="text-danger">{{ $message }}</span> @enderror 
                                                                            </div>   
                                                                        </div>  
                                                                    </td>
                                                                    <td class="px-3">  
                                                                        <div class="row mt-3">  
                                                                            <div class="col-sm-12">                                                        
                                                                                <select id="type_reglement" wire:model="type_reglement" class="form-control form-select fw-semibold bordure w-auto @error('type_reglement') is-invalid @enderror">
                                                                                    <option value=""></option>	
                                                                            ...
                                                                            <div class="d-flex justify-content-start">
                                                                                @error('type_reglement') <span class="text-danger">{{ $message }}</span> @enderror 
                                                                            </div>   
                                                                        </div>  
                                                                    </td>
                                                                    <td class="text-center" style="width: 150px;">
                                                                        <div class="row mt-3">
                                                                            <div class="col-sm-12">
                                                                                <input type="date" wire:model="date_operation" class="form-control bordure @error('date_operation') is-invalid @enderror" id="date_operation">
                                                                            </div>
                                                                            <div class="d-flex justify-content-start">
                                                                                @error('date_operation') <span class="text-danger">{{ $message }}</span> @enderror 
                                                                            </div>
                                                                        </div>
                                                                    </td> 
                                                                    <td class="text-muted text-bleu fw-semibold">
                                                                        <div class="row mt-3">
                                                                            <div class="col-sm-12">                                                        
                                                                                <textarea rows="1" wire:model="description" class="form-control bordure w-auto @error('description') is-invalid @enderror" id="description" placeholder="Message..."></textarea>
                                                                            </div>
                                                                            <div class="d-flex justify-content-start">
                                                                    ...
                                                                    <td class="text-center" style="width: 150px;">
                                                                        <div class="row mt-3">
                                                                            <div class="col-sm-12">
                                                                                <input type="number" wire:model="montant" placeholder="Ex: 5000" class="form-control bordure w-auto @error('montant') is-invalid @enderror" id="montant">
                                                                            </div>
                                                                            <div class="d-flex justify-content-start">
                                                                    ...
                                                                    <td class="text-end fw-semibold">
                                                                        @if($compte_destination)
                                                                            <div class="mt-3">
                                                                                <a href="#"  wire:click.prevent="valider()" class="btn btn-outline-success btn-sm"  title="Cliquez pour ajouter" data-bs-toggle="tooltip" data-bs-placement="top"><i class="ri-check-line"></i> Valider</a>
                                                                            </div>
                                                                        @endif
                                                                    </td> 
                                                                </tr>
