...
<td class="px-3">  
    <div class="row mt-3">  
        <div class="col-sm-12">                                                        
            <select id="choix_composant" wire:model.live="choix_composant" class="form-control form-select fw-semibold bordure @error('choix_composant') is-invalid @enderror">
                <option value=""></option>	
