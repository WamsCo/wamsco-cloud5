            ...
            <div class="col-sm-12">
                <div class="card mb-4 bg-2k">
                    <div class="card-header d-flex align-items-center justify-content-between border-bottom">
                        <h5 class="card-title text-bleu"><i class="fa fa-cubes text-danger"></i> {{$title_fils}} &nbsp;&nbsp;</h5>
                                    ...
                                    <div class="row pt-3 px-2">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="row mb-1">
                                                ...
                                                <div class="col-sm-9">   
                                                    <select id="nomenclatures" wire:model.live="nomenclatures" class="form-control form-select fw-bold bordure w-auto @error('nomenclatures') is-invalid @enderror">
                                                        <option value=""></option>	
                                                        @foreach($listeNomenclatur as $listeNomenclaturs)
                                                            <option value="{{$listeNomenclaturs->id}}">{{$listeNomenclaturs->code}} » {{substr($listeNomenclaturs->libelle,0,32) > substr($listeNomenclaturs->libelle,0,31) ? substr($listeNomenclaturs->libelle,0,32).'...': $listeNomenclaturs->libelle}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 px-0">
                                            ...
                                            <div class="table-responsive mt-2">
                                                <div class="table-responsive mt-1"> 
                                                    ...
                                                    <div class="tab-content table-responsive border-top border-bottom">
