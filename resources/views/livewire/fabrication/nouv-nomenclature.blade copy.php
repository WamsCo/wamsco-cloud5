            ...
            <div class="col-sm-12">
                <div class="card mb-4 bg-2k">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="card-title text-bleu"><i class="fa fa-shapes text-danger"></i> {{$title_fils}} &nbsp;&nbsp;</h5>
                    ...
                    <div class="card-body no_bordure border-top rounded-3 taille_ecran_trans">
                        <div class="row mx-0 pt-0">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 px-3 mb-0 border-end border-bottom rounded-bottom">  
                                <form>
                                    <div class="row">
                                        <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12"> 
                                            <div class="row mb-1 mt-3">
                                                <label for="libelle" class="col-sm-2 fw-bold col-form-label">Libellé</label>
                                                <div class="col-sm-10">
                                                    <input type="text" wire:model.defer="libelle" placeholder="Ex: Fabrication pain" class="form-control bordure w-100 @error('libelle') is-invalid @enderror" id="libelle">
                                                </div>
                                            ...
                                            <div class="row mb-1">
                                                <label for="inputPassword3" class="col-sm-2 fw-bold col-form-label">Type</label>
                                                <div class="col-sm-10">
                                                    <div class="card-body">
                                            ...
                                            <div class="row mb-1">
                                                <label for="produit_a_fabrique" class="col-sm-3 fw-bold col-form-label">Produit à fabriquer</label>
                                                <div class="col-sm-9">   
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="row mb-1 mt-2">
                                                ...
                                                <div class="col-sm-10">                                                        
                                                    <textarea rows="3" wire:model="description" class="form-control bordure @error('description') is-invalid @enderror" id="description" placeholder="Ajouter une note..."></textarea>
                                                </div>
                                                <div class="d-flex justify-content-start">
                                ...
                                <div class="border-top border-bottomk py-3 px-3">
                                    <button  wire:click="store()" class="btn btn-secondary btn-sm fw-bold"><i class="fa fa-check"></i> Enregistrer</button>
