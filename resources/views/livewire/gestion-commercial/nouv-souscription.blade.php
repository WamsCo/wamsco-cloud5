<div wire:ignore.self class="modal fade" id="createSouscriptionModal" tabindex="-1" data-bs-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header py-2" style="background-color: #56585d; color:#ffffff;">
                <h5 class="modal-title" id="exampleModalCenteredScrollableTitle"><i class="fa fa-plus-circle"></i> Nouvelle souscription <span class="text-vert"></span> </h5>
                            ...
                            <div class="hauteur_ecran">
                                <div class="row pt-3 px-2">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <label for="societe" class="col-lg-12 col-md-12 col-sm-12 fw-semibold col-form-label">Nom de votre commerce</label>
                                        <div class="row mb-3">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">                                                                                   
                                        <div class="row mb-1">
                                            <label for="nom_utilisateur" class="col-lg-4 col-md-5 col-sm-3 fw-bold col-form-label">Nom & Prénom</label>
                                        ...
                                        <div class="row mb-1">
                                            <label for="password" class="col-lg-4 col-md-5 col-sm-3 fw-bold col-form-label">Mot de passe</label>
                                            <div class="col-lg-8 col-md-7 col-sm-9">
                                        ...
                                        <div class="row mb-1">
                                            <label for="password_confirmation" class="col-lg-6 col-md-5 col-sm-3 fw-bold col-form-label">Confirmer mot de passe</label>
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
                                        <div class="table-responsive mt-2">
                                            <ul class="nav nav-tabs border-0" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" data-bs-toggle="tab" href="#autres">Autres</a>
                                                </li>
                                            </ul>
