                ...
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center justify-content-between gap-1">                                                       
                            <div class="d-flex align-items-center justify-content-between gap-1">                            
                                <button class="btn btn-sm btn-secondary" wire:click.prevent="store()" title="Cliquez pour créer" data-toggle="tooltip"><i class="fa fa-check"></i> Créer</button>
                                <a href="/liste_souscription?active=16&champ=1-3" wire:navigate class="btn btn-sm btn-danger" title="Cliquez pour fermer" data-toggle="tooltip"><i class="fa fa-close"></i> Fermer</a>
                            </div>
                        </div>
                        <div class="d-flex align-items-center justify-content-between gap-1">                                                       
                            <div class="d-flex align-items-center justify-content-between gap-1">                            
                                <a href="liste_souscription?active=16&champ=1-3" wire:navigate class="btn btn-sm btn-bleu d-none d-md-block ms-auto"><i class="fa fa-chevron-left"></i> Retour liste</a>
                                    ...
                                    <div class="hauteur_ecran">
                                        <div class="row pt-3 px-2">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <label for="societe" class="col-lg-2 col-md-5 col-sm-3 fw-semibold col-form-label">Nom de votre commerce</label>
                                                <div class="row mb-3">
                                                    <div class="col-lg-10 col-md-10 col-sm-10">
                                                        <input type="text" wire:model="societe" placeholder="Ex: WamsCo Sarl" class="form-control bordure fs-3 w-100 px-0 @error('societe') is-invalid @enderror" id="societe">
                                                    </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">                                                                                   
                                                <div class="row mb-1">
                                                    <label for="nom_utilisateur" class="col-lg-4 col-md-5 col-sm-3 fw-bold col-form-label">Nom & Prenom</label>
                                                    <div class="col-lg-8 col-md-7 col-sm-9">
                                                        <input type="text" wire:model="nom_utilisateur" placeholder="Ex: John Doe" class="form-control bordure w-100 @error('nom_utilisateur') is-invalid @enderror" id="nom_utilisateur">
                                                    </div>
                                                    <div class="d-flex justify-content-start">
                                                        @error('nom_utilisateur') <span class="text-danger">{{ $message }}</span> @enderror 
                                                    </div>
                                                </div>
                                                <div class="row mb-1">
                                                ...
                                                <div class="row mb-1">
                                                    <label for="telephone" class="col-lg-3 col-md-5 col-sm-3 fw-bold col-form-label">Téléphone</label>
                                                    <div class="col-lg-9 col-md-7 col-sm-9">
                                                ...
                                                <div class="row mb-1">
                                                    <label for="password" class="col-lg-3 col-md-5 col-sm-3 fw-bold col-form-label">Mot de passe</label>
                                                    <div class="col-lg-9 col-md-7 col-sm-9">
                                                        <input type="password" wire:model="password" placeholder="" class="form-control bordure w-75 @error('password') is-invalid @enderror" id="password">
                                                    </div>
                                                    <div class="d-flex justify-content-start">
                                                ...
                                                <div class="row mb-1">
                                                    <label for="password_confirmation" class="col-lg-4 col-md-5 col-sm-3 fw-bold col-form-label">Confirmer mot de passe</label>
                                                    <div class="col-lg-8 col-md-7 col-sm-9">
                                                        <input type="password" wire:model="password_confirmation" placeholder="" class="form-control bordure w-75 @error('password_confirmation') is-invalid @enderror" id="password_confirmation">
                                                    </div>
                                                    <div class="d-flex justify-content-start">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <div class="row mb-1">
                                                    <label for="pays" class="col-lg-3 col-md-5 col-sm-3 fw-bold col-form-label">Pays</label>
                                                    <div class="col-lg-9 col-md-7 col-sm-9">                                                        
                                                        <select name="pays" wire:model="pays" class="form-control form-select bordure w-75 @error('pays') is-invalid @enderror" style="color: #6b6b6b;">
                                                ...
                                                <div class="row mb-1">
                                                    <label for="ville" class="col-lg-3 col-md-5 col-sm-3 fw-bold col-form-label">Ville</label>
                                                    <div class="col-lg-9 col-md-7 col-sm-9">
                                                ...
                                                <div class="row mb-1">
                                                    <label for="adresse" class="col-lg-3 col-md-5 col-sm-3 fw-bold col-form-label">Adresse</label>
                                                    <div class="col-lg-9 col-md-7 col-sm-9">
                                                        <input type="text" wire:model="adresse" placeholder="Ex: Rue po" class="form-control bordure w-75 @error('adresse') is-invalid @enderror" id="adresse">
                                                    </div>
                                                    <div class="d-flex justify-content-start">
                                                ...
                                                <div class="row mb-1">
                                                    <label for="commercial_charge" class="col-lg-3 col-md-3 col-sm-3 fw-bold col-form-label">Votre plan</label>
                                                    <div class="col-lg-9 col-md-9 col-sm-9">                                                        
                                                        <select name="choix_plan" wire:model.defer="choix_plan" class="form-control form-select fw-bold bordure w-75 @error('choix_plan') is-invalid @enderror" style="color:#094972;;">
                                                            <option value=""></option>
                                                    ...
                                                    <div class="d-flex justify-content-start">
                                                        @error('choix_plan') <span class="text-danger">{{ $message }}</span> @enderror 
                                                    </div>
                                                </div>                                  
                                            </div>                                        
                                            <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
                                                <div class="table-responsive mt-2">
                                                    <ul class="nav nav-tabs border-0" role="tablist">
                                                        <li class="nav-item">
                                                            <a class="nav-link active" data-bs-toggle="tab" href="#home">Contact</a>
                                                        </li>
                                                        <li class="nav-item">
