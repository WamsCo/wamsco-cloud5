<div x-data="{selection: @entangle('selection').defer}">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-1">
                                    ...
                                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">
                                        <li class="nav-item">                                                
                                            <a class="nav-link active" data-bs-toggle="tab" href="#home" title="Liste des tieres : Prospects, Clients, Fournisseurs"><i class="fas fa-users text-bleu"></i> {{$title_fils}} (<span class="text-vert">{{$entite_count}}</span>)</a>                                                
                                        </li>  
                                        <li class="nav-item">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1">                            
                                            <button href="#" data-bs-toggle="modal" data-bs-target="#createSouscriptionModal" title="Cliquez pour effectuer une nouvelle souscription" data-toggle="tooltip" class="btn btn-sm btn-danger ms-auto"><i class="fa fa-plus-circle"></i> Nouvelle souscription</button>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between gap-1">
                                                            <div class="card-headerk d-flex align-items-center justify-content-end gap-1">
                                                             ...
                                                             <div>
                                                                ...
                                                                <input type="search" wire:model.live="query" id="query" class="form-control bordure" placeholder="Rechercher enseigne">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <table class="table table-striped table-hover text-nowrap m-0"> 
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="fond_entete_table pointer text-center" wire:click="setOrderField('nombre_users')">Utilisateurs() <i class="fa fa-arrow-down-short-wide"></i></th> 
                                                                ...
                                                                @foreach($liste_entit as $liste_entits) 
                                                                    <tr>                                            
                                                                        @if($liste_entits->logo != null)
                                                                            <td><a class="text-bleu" href="details_regle_com?id={{$liste_entits->id}}&active=16&champ=1-3" wire:navigate><img class="img_produit" src="storage/{{$liste_entits->logo}}"/></a></td>
                                                                        @else
                                                                            <td><a class="text-bleu" href="details_regle_com?id={{$liste_entits->id}}&active=16&champ=1-3" wire:navigate><img class="img_produit" src="storage/default/image.png"/></a></td>
                                                                        @endif                                                                   
                                                                        <td class="fw-bold"><a class="text-bleu" href="details_regle_com?id={{$liste_entits->id}}&active=16&champ=1-3" wire:navigate><i class="fa fa-university"></i> {{Str::limit($liste_entits->enseigne, 52)}}</a></td>                                                                      
    ...
    {{-- Modal --}}
    @include('livewire.gestion-commercial.nouv-souscription')
</div>
