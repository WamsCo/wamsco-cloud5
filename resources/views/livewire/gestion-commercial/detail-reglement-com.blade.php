                                    ...
                                    <div class="card border-0 shadow-sm">
                                        <div class="card-body border border-light-subtle rounded-3 bg-white position-relative custom-scroll pe-2" style="height: calc(100vh - 131px); overflow-y: auto;">
                                            <div class="text-centerk">
                                                <div class="d-flex align-items-centerk">
                                                    <div class="">
                                                        <div class="photoref">
                                                            @if($entits->logo != null)
                                                                <td><img class="img_detail_prod" src="storage/{{$entits->logo}}" data-bs-toggle="modal" data-bs-target="#entiteLogoModal"/></td>
                                                            @else
                                                                <td><img class="img_detail_prod" src="storage/default/image.png" data-bs-toggle="modal" data-bs-target="#entiteLogoModal"/></td>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <div class="ms-2">
                                            ...
                                            <div class="d-flex gap-2 mb-3">
                                                {{-- <button href="#" wire:click.prevent="edit({{$entits->id}})" data-bs-toggle="modal" data-bs-target="#soldeentitsModal" title="Cliquez pour recharger le compte client" data-toggle="tooltip" class="btn btn-sm btn-white text-danger flex-fill fw-semibold ms-auto"><i class="fas fa-file-invoice-dollar"></i> Recharge</button> --}}
                                                {{-- <button href="#" wire:click.prevent="edit({{$entits->id}})" data-bs-toggle="modal" data-bs-target="#updateentitModal" title="Cliquez pour modifier" data-toggle="tooltip" class="btn btn-sm btn-secondary flex-fill fw-semibold ms-auto"><i class="fa fa-pen"></i> Modifier</button> --}}
                                            </div>
                                            <button href="liste_souscription?active=16&champ=1-3" wire:navigate class="btn btn-sm btn-outline-success w-100 mb-4"><i class="fa fa-close"></i> Fermer</button>
                                            <h5 class="fw-bold mb-3">À propos {{Str::limit($entits->nom_user, 52) ?? 'Inconu(e)'}}</h5>
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <div class="card-header d-flex align-items-center justify-content-between border-0 px-0">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between gap-1">                            
                                                <a href="{{asset('liste_souscription?active=16&champ=1-3')}}" wire:navigate class="btn btn-sm btn-bleu d-none d-md-block ms-auto"><i class="fa fa-chevron-left"></i> Retour liste</a>
                                                                ...
                                                                <div class="table-responsive">
                                                                    ...
                                                                    <div class="table-responsive border-top rounded-0">
                                                                        <table class="table table-striped table-hover text-nowrap m-0"> 
                                                                            <thead>
                                                                                <tr>
                                                                                    <th class="fond_entete_table">Commercial charge</th> 
                                                                            ...
                                                                            <tbody>
                                                                                @foreach($entit as $entits) 
                                                                                <tr>
                                                                                    <td class="fw-bold text-bleu">{{$entits->commercial_charge}}</td>
                                                                        ...
                                                                        <tbody> 
                                                                            @foreach($reglementCom as $reglementComs)
                                                                                <tr> 
                                                                                    ...
                                                                                    <td class="taille_icon text-end"></td> 
                                                                                </tr> 
                                                                            @endforeach
                                                                            <tr> 
                                            ...
                                            <div class="card shadow-sm">  
                                                <div class="card shadow-sm border border-light-subtle rounded-3 bg-white p-2">    
                                                    ...
                                                    <div class="alert mt-3 mb-0 d-flex justify-content-between align-items-center rounded-2 px-3 py-2" style="background-color: #f4f8ff; border: 1px solid #cce0ff;">
                                                        ...
                                                        <a href="{{asset('liste_souscription?active=16&champ=1-3')}}" wire:navigate class="text-decoration-none fw-semibold text-primary" style="font-size: 13px;">Voir plus</a>
                                                    </div>
                                                </div>                                                
                                            </div>                                            
                                        </div>                                 
