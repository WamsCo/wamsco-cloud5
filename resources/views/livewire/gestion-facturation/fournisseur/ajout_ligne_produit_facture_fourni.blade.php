...
<td class="text-muted text-bleu fw-semibold">
    <div class="row mt-3">
        <label for="prix_achat" class="col-md-12 col-sm-12 fw-bold col-form-label text-start">Prix dernier achat</label>
        <div class="col-sm-12">                                                        
            <input type="number" wire:model="prix_achat" placeholder="Ex: 10000" class="form-control bordure @error('prix_achat') is-invalid @enderror" id="prix_achat">
        </div>
