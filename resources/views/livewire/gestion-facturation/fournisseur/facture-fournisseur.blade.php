                            ...
                            <div class="col-lg-12">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2">
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="d-block fw-bold text-secondary" style="font-size: 11px;">Total facture Fourni.</span>
                                                    <span class="d-block fw-semibold text-dark" style="font-size: 13px;">{{$nbreTotalFact}}</span>
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-1">
                                    ...
                                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">
                                        <li class="nav-item">                                                
                                            <a class="nav-link active" data-bs-toggle="tab" href="#home"><i class="fas fa-file-invoice text-bleu"></i> {{$title_fils}} (<span class="text-vert">{{$factFournisseurCount}}</span>)</a>                                                
                                        </li>  
                                        <li class="nav-item">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1">  
                                            <button class="btn btn-sm btn-danger ms-auto" title="Cliquez pour enregistrer" data-toggle="tooltip" wire:click.prevent="store()"><i class="fa fa-plus-circle"></i> Nouvelle facture</button>                          
                                                ...
                                                <div class="card shadow-sm border border-light-subtle rounded-3 bg-white px-0">
                                                    <div class="d-flex align-items-center justify-content-between gap-3 pt-2 px-2">
                                                        <div class="d-flex align-items-center justify-content-between gap-1">
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between gap-1">
                                                                <h6><a href="{{asset('exporter-fact_fourni')}}" class="btn btn-sm btn-success mt-2 d-none d-md-block"><i class="fa-solid fa-file-export"></i> Exporter Excel</a></h6>
                                                    ...
                                                    <div class="table-responsive border-top">
                                                        <table class="table table-striped table-hover text-nowrap m-0"> 
                                                            <thead>
                                                                <tr>
                                                                   <th class="fond_entete_table pointer" wire:click="setOrderField('code_facture')">Référence <i class="fa fa-arrow-down-short-wide"></i></th>   
                                                                    ...
                                                                    @endif
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('compte_bancaire')">Compte <i class="fa fa-arrow-down-short-wide"></i></th> 
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('etat')">Etat <i class="fa fa-arrow-down-short-wide"></i></th>  
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('etat_reception')">Réception <i class="fa fa-arrow-down-short-wide"></i></th>      
                                                            ...
                                                            <tbody>
                                                                @foreach($fact_fournisseur as $fact_fournisseurs) 
                                                                    <tr>
                                                                        <td class="fw-semibold pointer"><a href="nouveau_fact_fourni?id={{$fact_fournisseurs->id}}&ref={{$fact_fournisseurs->code_facture}}&active=7&champ=2-1&choix=1" wire:navigate><i class="fas fa-file-invoice-dollar text-danger" aria-hidden="true"></i> {{$fact_fournisseurs->code_facture}}</a></td> 
                                                                        <td class="fw-semibold pointer"><a href="detail_tier?id={{$fact_fournisseurs->id_fournisseur}}&ref={{$fact_fournisseurs->code_facture}}&active=3&champ=3-2" wire:navigate class="text-bleu">@if($fact_fournisseurs->nom_fournisseur) <i class="fa fa-user-circle"></i> @endif {{substr($fact_fournisseurs->nom_fournisseur,0,52) > substr($fact_fournisseurs->nom_fournisseur,0,51) ? substr($fact_fournisseurs->nom_fournisseur,0,52).'...': $fact_fournisseurs->nom_fournisseur}}</a></td>                                                                      
                                                                        <td class="">{{$fact_fournisseurs->mode_reglement}}</td>
                                                                        <td class="fw-semibold text-end">{{number_format($fact_fournisseurs->montant_ttc,0,',',' ')}}</td>
                                                                        <td class="fw-semibold text-end">{{number_format($fact_fournisseurs->montant_recu,0,',',' ')}}</td>
                                                                        <td class="fw-semibold text-end">{{number_format($fact_fournisseurs->reste_a_percevoir,0,',',' ')}}</td>
                                                                        @if($autoriser == 1)
                                                                        <td class="fw-semibold text-end">{{number_format($fact_fournisseurs->marge,0,',',' ')}}</td>
                                                                        @endif
                                                                        <td class="fw-semibold"><a href="detail_banque?id={{$fact_fournisseurs->id_compte_bancaire}}" wire:navigate class="text-bleu">@if($fact_fournisseurs->compte_bancaire)<i class="fa fa-university text-danger" aria-hidden="true"></i> @endif {{$fact_fournisseurs->compte_bancaire}}</a></td>                                               
                                                                        <td class="text-start">
                                                                            @if($fact_fournisseurs->etat == "Brouillon")
                                                                            <span class="badge bg-secondary py-1" title="Facture {{$fact_fournisseurs->etat}}"><i class="fa fa-box"></i> {{$fact_fournisseurs->etat}}</span>
                                                                            @elseif($fact_fournisseurs->etat == "Impayée")
                                                                            <span class="badge bg-danger py-1" title="Facture {{$fact_fournisseurs->etat}}"><i class="fa fa-times-circle"></i> {{$fact_fournisseurs->etat}}</span>
                                                                            @elseif($fact_fournisseurs->etat == "Payée")
                                                                            <span class="badge bg-success py-1" title="Facture {{$fact_fournisseurs->etat}}"><i class="fa fa-check-circle"></i> {{$fact_fournisseurs->etat}}</span>
                                                                            @elseif($fact_fournisseurs->etat == "Commencée")
                                                                            <span class="badge bg-info py-1" title="Facture {{$fact_fournisseurs->etat}}"><i class="fa fa-recycle"></i> {{$fact_fournisseurs->etat}}</span>
                                                                            @endif                                                 
                                                                        </td> 
                                                                        <td class="text-start">
                                                                            @if($fact_fournisseurs->etat_reception == "Brouillon")
                                                                            <span class="badge bg-secondary py-1" title="Réception {{$fact_fournisseurs->etat_reception}}"><i class="fas fa-dolly"></i> {{$fact_fournisseurs->etat_reception}}</span>
                                                                            @elseif($fact_fournisseurs->etat_reception == "Clôturée")
                                                                            <span class="badge bg-danger py-1" title="Réception {{$fact_fournisseurs->etat_reception}}"><i class="fas fa-dolly"></i> {{$fact_fournisseurs->etat_reception}}</span>
                                                                            @elseif($fact_fournisseurs->etat_reception == "Partiel")
                                                                            <span class="badge bg-primary py-1" title="Réception {{$fact_fournisseurs->etat_reception}}"><i class="fas fa-dolly"></i> {{$fact_fournisseurs->etat_reception}}</span>
                                                                            @elseif($fact_fournisseurs->etat_reception == "")
                                                                            <span class="badge bg-light text-dark py-1" title="Réception non créée"><i class="fas fa-dolly"></i> Non créée</span>
                                                                            @endif   
                                                                        </td>  
                                                                        <td class="">{{date('d-m-Y', strtotime($fact_fournisseurs->date_facturation))}}</td>
                                                                        <td class="">{{date('d-m-Y', strtotime($fact_fournisseurs->date_echeance))}}</td>
                                                                        <td class="fw-semibold text-muted pointer"><a href="detail_user?id={{$fact_fournisseurs->user_id}}&active=12&champ=1-1" wire:navigate><i class="fas fa-user-circle text-bleu" aria-hidden="true"></i> {{$fact_fournisseurs->nom_user}}</a></td>                                                                                                                           
                                                                        <td class="">{{date('d-m-Y H:i:s', strtotime($fact_fournisseurs->updated_at))}}</td>
                                                                        <td class="text-end"><a href="nouveau_fact_fourni?id={{$fact_fournisseurs->id}}&ref={{$fact_fournisseurs->code_facture}}&active=7&champ=2-1&choix=1" wire:navigate class="btn-outline-muted"  title="Cliquez pour voir ou modifier" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-eye"></i></a></td>
                                                                        {{-- <td class="taille_icon text-end">
                                                                            @if($confirmer === $fact_fournisseurs->id)                                                               
                                                                                <a wire:click.prevent="supprimer({{$fact_fournisseurs->id}},'{{$fact_fournisseurs->code_facture}}')" class="btn btn-outline-danger btn-xs bg-danger text-white blink" style="font-size:8px;"  title="Cliquez pour confirmer la suppression" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"> Confirmer ?</i></a>
                                                                            @else
                                                                                <a wire:click.prevent="confirmerDelete({{$fact_fournisseurs->id}})" class="btn btn-outline-muted btn-xs"  title="Cliquez pour supprimer" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"></i></a>
                                                                            @endif
                                                                        </td>  --}}
                                                                    </tr>
                                                                @endforeach
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="3" class="text-end fw-semibold" style="color:#006666">{{number_format($montantTTC,0,',',' ')}}</td>
                                                        ...
                                                        <div class="bloc_pagination">{{$fact_fournisseur->links()}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
