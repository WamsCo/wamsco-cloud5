                            ...
                            <div class="col-lg-12">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2">
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">                                                
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="d-block fw-bold text-secondary" style="font-size: 11px;">Total règlement fournisseur</span>
                                                    <span class="d-block fw-semibold text-dark" style="font-size: 13px;">{{number_format($nbreTotalReglement,0,',',' ')}}</span>
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="fw-bold text-secondary" style="font-size: 11px;">Montant réglé</span>
                                                    <span class="d-block fw-bold text-dark mt-1" style="font-size: 14px;">{{number_format($montantTregler_all,0,',',' ')}} <span style="font-size: 10px;">{{$this->devise}}</span></span>
                                                </div>
                                            </div>  
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-1">
                                    ...
                                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">
                                        <li class="nav-item">                                                
                                            <a class="nav-link active" data-bs-toggle="tab" href="#home" title="Liste des tieres : Prospects, Clients, Fournisseurs"><i class="fas fa-users text-bleu"></i> {{$title_fils}} (<span class="text-vert">{{$regleFournisseurCount}}</span>)</a>                                                
                                        </li>  
                                        <li class="nav-item">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1">                            
                                            {{-- <button href="#" data-bs-toggle="modal" data-bs-target="#createTransfertModal" title="Cliquez pour ajouter" data-toggle="tooltip" class="btn btn-sm btn-danger ms-auto"><i class="fa fa-plus-circle"></i> Nouveau transfert</button> --}}
                                                ...
                                                <div class="card shadow-sm border border-light-subtle rounded-3 bg-white px-0">
                                                    <div class="d-flex align-items-center justify-content-between gap-3 pt-2 px-2">
                                                        <div class="d-flex align-items-center justify-content-between gap-1">
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between gap-1">
                                                                <h6><a href="{{asset('exporter-regle_fourni')}}" class="btn btn-sm btn-success mt-2 d-none d-md-block"><i class="fa-solid fa-file-export"></i> Exporter Excel</a></h6>
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between gap-1">
                                                            ...
                                                            <div>
                                                                ...
                                                                <input type="search" wire:model.live="parRef" id="parRef" class="form-control bordure" placeholder="Rech. référence">
                                                            </div> 
                                                            <div>
                                                                <label for="parRef" class="sr-only">Recherche</label>
                                                                <input type="search" wire:model.live="parFact" id="parRef" class="form-control bordure" placeholder="Rech. facture">
                                                            </div>  
                                                            <div>
                                                    ...
                                                    <div class="table-responsive border-top">
                                                        <table class="table table-striped table-hover text-nowrap m-0"> 
                                                            <thead>
                                                                <tr>
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('ref_reglement')">Référence <i class="fa fa-arrow-down-short-wide"></i></th>   
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('date_reglement')">Date <i class="fa fa-arrow-down-short-wide"></i></th> 
                                                                    ...
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('ecriture_bancaire')">Ecriture bancaire <i class="fa fa-arrow-down-short-wide"></i></th> 
                                                                    ...
                                                                    <th class="fond_entete_table pointer text-start" wire:click="setOrderField('num_cheq_virement')">Numéro <i class="fa fa-arrow-down-short-wide"></i> <i class="fas fa-info-circle" title="Chèque/Virement N°" data-bs-toggle="tooltip" data-bs-placement="top" style=" vertical-align: middle; cursor: help"></i></th> 
                                                                    <th class="fond_entete_table pointer text-end" wire:click="setOrderField('montant_regler')">Montant <i class="fa fa-arrow-down-short-wide"></i></th> 
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('commentaire')">Commentaire <i class="fa fa-arrow-down-short-wide"></i></th> 
                                                            ...
                                                            <tbody>
                                                                @foreach($Reglement_fournisseur as $Reglement_fournisseurs) 
                                                                    <tr>
                                                                        <td class="fw-semibold pointer"><a href="#" wire:navigate><i class="fas fa-file-invoice-dollar text-danger" aria-hidden="true"></i> {{$Reglement_fournisseurs->ref_reglement}}</a></td> 
                                                                        <td class="">{{date('d-m-Y', strtotime($Reglement_fournisseurs->date_reglement))}}</td>
                                                                        <td class="fw-semibold pointer"><a href="detail_tier?id={{$Reglement_fournisseurs->id_fournisseur}}&ref={{$Reglement_fournisseurs->code_facture}}&active=3&champ=3-2" wire:navigate class="text-bleu">@if($Reglement_fournisseurs->nom_fournisseur) <i class="fa fa-user-circle"></i> @endif {{substr($Reglement_fournisseurs->nom_fournisseur,0,52) > substr($Reglement_fournisseurs->nom_fournisseur,0,51) ? substr($Reglement_fournisseurs->nom_fournisseur,0,52).'...': $Reglement_fournisseurs->nom_fournisseur}}</a></td>                                                                      
                                                                        <td class="">{{$Reglement_fournisseurs->mode_reglement}}</td>
                                                                        <td class="fw-semibold"><a href="detail_banque?id={{$Reglement_fournisseurs->id_compte_bancaire}}&active=8&champ=1-1"  wire:navigate class="text-bleu">@if($Reglement_fournisseurs->compte_bancaire)<i class="fa fa-university text-danger" aria-hidden="true"></i> @endif {{$Reglement_fournisseurs->compte_bancaire}}</a></td>                                               
                                                                        <td class="fw-semibold"><a href="detai?id={{$Reglement_fournisseurs->id_ecriture_bancaire}}" wire:navigate class="text-bleu"><i class="fa fa-receipt text-danger" aria-hidden="true"></i> {{$Reglement_fournisseurs->ecriture_bancaire}}</a></td>                                               
                                                                        <td class="fw-semibold"><a href="nouveau_fact_fourni?id={{$Reglement_fournisseurs->id_facture_fournisseur_entete}}&active=7&champ=2-1&choix=1" wire:navigate class="text-bleu"><i class="fas fa-file-invoice-dollar text-vert" aria-hidden="true"></i> {{$Reglement_fournisseurs->code_facture}}</a></td>                                               
                                                                        <td class="text-start">{{$Reglement_fournisseurs->num_cheq_virement}}</td>
                                                                        <td class="fw-bold text-end">{{number_format($Reglement_fournisseurs->montant_regler,0,',',' ')}}</td>
                                                                        <td class="text-start">{{$Reglement_fournisseurs->commentaire}}</td>  
                                                                        <td class="pointer"><a href="detail_user?id={{$Reglement_fournisseurs->user_id}}&active=12&champ=1-1" wire:navigate><i class="fas fa-user-circle text-bleu" aria-hidden="true"></i> {{$Reglement_fournisseurs->nom_user}}</a></td>                                       
                                                                        <td class="">{{date('d-m-Y H:i:s', strtotime($Reglement_fournisseurs->updated_at))}}</td>
                                                                        {{-- <td class="text-end"><a href="nouveau_fact_fourni?id={{$Reglement_fournisseurs->id_facture_fournisseur_entete}}&active=7&champ=2-1&choix=1" wire:navigate class=""  title="Cliquez pour modifier" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-pencil"></i></a></td> --}}
                                                                    </tr>
                                                                @endforeach
                                                            </tbody>
                                                            <tr>
                                                                ...
                                                                <td colspan="8" class="text-end fw-semibold" style="color:#006666">{{number_format($montantTregler,0,',',' ')}}</td>
                                                                <td colspan="3"></td>
                                                            </tr>
                                                        </table>
                                                        <div class="bloc_pagination">{{$Reglement_fournisseur->links()}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
