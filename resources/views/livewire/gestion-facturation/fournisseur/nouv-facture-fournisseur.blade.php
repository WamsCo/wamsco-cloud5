<div x-data="{selection: @entangle('selection').defer}">
                                    ...
                                    <div class="card-body border border-light-subtle rounded-3 bg-white position-relative custom-scroll pe-2" style="height: calc(100vh - 131px); overflow-y: auto;">
                                        <div class="text-centerk">
                                            ...
                                            <div class="d-flex align-items-center justify-content-end gap-1">
                                                <div class="statusref">
                                                    @if($etat == "Brouillon")
                                                        <span class="badge bg-secondary py-1" title="Facture {{$etat}}"><i class="fa fa-box"></i> {{$etat}} (à valider)</span>
                                                    @elseif($etat == "Impayée")
                                                        <span class="badge bg-warning py-1" title="Facture {{$etat}}"><i class="fa fa-times-circle"></i> {{$etat}}</span>
                                                    @elseif($etat == "Payée")
                                                        <span class="badge bg-success py-1" title="Facture {{$etat}}"><i class="fa fa-check-circle"></i> {{$etat}}</span>  
                                                    @elseif($etat == "Commencée")
                                                        <span class="badge bg-info py-1" title="Facture {{$etat}}"><i class="fa fa-recycle"></i> {{$etat}}</span>  
                                                    @endif
                                                </div>
                                                <div class="statusref">
                                                    @if($etat_reception == "Brouillon")
                                                        <span class="badge bg-secondary py-1" title="Réception {{$etat_reception}}"><i class="fas fa-dolly"></i> {{$etat_reception}}</span>
                                                    @elseif($etat_reception == "Clôturée")
                                                        <span class="badge bg-danger py-1" title="Réception {{$etat_reception}}"><i class="fas fa-dolly"></i> {{$etat_reception}}</span>
                                                    @elseif($etat_reception == "Partiel")
                                                        <span class="badge bg-primary py-1" title="Réception {{$etat_reception}}"><i class="fas fa-dolly"></i> {{$etat_reception}}</span> 
                                                    @endif
                                                </div>                               
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex gap-1 mb-2">  
                                            <a href="listing_fact_fourni?active=7&champ=2-1&choix=1" wire:navigate class="btn btn-sm btn-outline-danger flex-fill" title="Cliquez pour fermer" data-toggle="tooltip"><i class="fa fa-close"></i> Fermer</a>
                                            @if($factFournisseurLigneCount)
                                                @if($etat == 'Brouillon')
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1 border-bottom pb-2">  
                                            @if($factFournisseurLigneCount)
                                                @if($etat == 'Brouillon')
                                                    @if($this->fournisseur_id > 0)                                        
                                                        <button type="submit" wire:click.prevent="valider()" class="btn btn-sm btn-outline-info flex-fill text-bleu fw-bold"><i class="fa fa-check"></i> Valider Facture</button>                                                               
                                                    @endif
                                                @elseif($etat == 'Impayée')                                   
                                                    ...
                                                    <a href="#" wire:click.prevent="afficheRegler()" class="btn btn-sm btn-outline-green flex-fill fw-semibold ms-auto" data-bs-toggle="modal" data-bs-target="#saissieReglementModal" title="Cliquez pour saisir un règlement" data-toggle="tooltip"><i class="fas fa-file-invoice-dollar"></i> Saisir Règlement</a>
                                                @elseif($etat == 'Commencée')
                                                    <a href="#" wire:click.prevent="afficheRegler()" class="btn btn-sm btn-outline-green flex-fill fw-semibold ms-auto" data-bs-toggle="modal" data-bs-target="#saissieReglementModal" title="Cliquez pour saisir un règlement" data-toggle="tooltip"><i class="fas fa-file-invoice-dollar"></i> Saisir Règlement</a>
                                                @elseif($etat == 'Payée')
                                                    <a href="#" wire:click.prevent="reception()" class="btn btn-sm btn-outline-primary flex-fill fw-semibold ms-auto" title="Cliquez pour créer une réception" data-toggle="tooltip"><i class="fas fa-dolly"></i> Créer réception</a>
                                                @endif  
                                            @endif 
                                        </div> 
                                        <h5 class="text-bleu pt-3"><i class="fas fa-user-circle" style=" color: #393b83;" title="Derniers événements liés"></i> À propos du fournisseur</h5>
                                        ...
                                        <div class="table-responsive border-top rounded-0">                                        
                                            <table class="table table-striped table-hover text-nowrap m-0">
                                                ...
                                                <tbody>
                                                    @foreach($cmdFourniEntete as $cmdFourniEntetes)
                                                    <tr>
                                                        <td class="fw-semibold"><a href="nouveau_cmd_fourni?id={{$cmdFourniEntetes->id}}&ref={{$cmdFourniEntetes->code_commande}}&active=6&champ=2-1&choix=1" wire:navigate>Commande</a></td>                                                        
                                                        <td class="fw-semibold"><a href="nouveau_cmd_fourni?id={{$cmdFourniEntetes->id}}&ref={{$cmdFourniEntetes->code_commande}}&active=6&champ=2-1&choix=1" wire:navigate class="text-bleu"><i class="fas fa-file-invoice text-info" aria-hidden="true"></i> {{$cmdFourniEntetes->code_commande}}</a></td>                                                        
                                                        <td class="fw-semibold text-end">{{number_format($cmdFourniEntetes->montant_ttc,0,',',' ')}} {{$this->devise}}</td>
                                                        <td class="fw-semibold"> 
                                                            @if($cmdFourniEntetes->etat == "Brouillon")
                                                                <span class="badge bg-secondary" title="Commande {{$cmdFourniEntetes->etat}}"><i class="fa fa-box"></i> {{$cmdFourniEntetes->etat}}</span>
                                                            @elseif($cmdFourniEntetes->etat == "Impayée")
                                                                <span class="badge bg-danger" title="Commande {{$cmdFourniEntetes->etat}}"><i class="fa fa-times-circle"></i> {{$cmdFourniEntetes->etat}}</span>
                                                            @elseif($cmdFourniEntetes->etat == "Payée")
                                                                <span class="badge bg-success" title="Commande {{$cmdFourniEntetes->etat}}"><i class="fa fa-check-circle"></i> {{$cmdFourniEntetes->etat}}</span>
                                                            @elseif($cmdFourniEntetes->etat == "Validée")
                                                                <span class="badge bg-success" title="Commande {{$cmdFourniEntetes->etat}}"><i class="fa fa-check"></i> {{$cmdFourniEntetes->etat}}</span>
                                                            @endif                                                               
                                                        </td>
                                                        <td class="fw-semibold"><i class="fas fa-calendar-alt text-danger"></i> {{$cmdFourniEntetes->created_at ? date('d-m-Y H:i:s', strtotime($cmdFourniEntetes->created_at)): "" }}</td>                                                        
                                                    </tr>
                                                    @endforeach
                                                    @foreach($recpCltEntete as $recpCltEntetes)
                                                        <tr>
                                                            <td class="fw-semibold"><a href="detail_reception_fourni?id={{$recpCltEntetes->id}}&ref={{$recpCltEntetes->code_reception}}&active=6&champ=2-1&choix=2" wire:navigate>Réception</a></td>                                                        
                                                            <td class="fw-semibold"><a href="detail_reception_fourni?id={{$recpCltEntetes->id}}&ref={{$recpCltEntetes->code_reception}}&active=6&champ=2-1&choix=2" wire:navigate class="text-bleu"><i class="fas fa-dolly text-danger" aria-hidden="true"></i> {{$recpCltEntetes->code_reception}}</a></td>                                                        
                                                            <td class="fw-semibold text-end">{{number_format($recpCltEntetes->montant_ttc,0,',',' ')}} {{$this->devise}}</td>
                                                            <td class="fw-semibold"> 
                                                                @if($recpCltEntetes->etat == "Clôturée")
                                                                    <span class="badge bg-danger" title="Commande {{$recpCltEntetes->code_commande}}"><i class="fa fa-check-circle"></i> {{$recpCltEntetes->etat}}</span>                                                        
                                                                @elseif($recpCltEntetes->etat == "Partiel")
                                                                    <span class="badge bg-primary" title="Commande {{$recpCltEntetes->code_commande}}"><i class="fa fa-recycle"></i> {{$recpCltEntetes->etat}}</span>  
                                                                @endif                                                              
                                                            </td>
                                                            <td class="fw-semibold"><i class="fas fa-calendar-alt text-danger"></i> {{$recpCltEntetes->created_at ? date('d-m-Y H:i:s', strtotime($recpCltEntetes->created_at)): "" }}</td>                                                        
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>  
                            ...
                            <div class="col-lg-9">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2">
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    ...
                                                    {{-- <span class="text-bleu">{{ $this->updated_at->diffForHumans() }}</span> --}}
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="d-block fw-bold text-secondary" style="font-size: 11px;">Déjà réglé</span>
                                                    <span class="d-block fw-bold text-bleu mt-1" style="font-size: 14px;">{{number_format($dejaRegler,0,',',' ')}} <span style="font-size: 10px;" class="text-dark">{{$this->devise}}</span></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="fw-bold text-secondary" style="font-size: 11px;">Reste à payer</span>
                                                    <span class="d-block fw-bold text-danger mt-1" style="font-size: 14px;">{{number_format($reste_a_percevoir,0,',',' ')}} <span style="font-size: 10px;" class="text-dark">{{$this->devise}}</span></span>
                                                </div>
                                            </div> 
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-0">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-1">
                                        <div class="d-flex align-items-center justify-content-between gap-1"> 
                                            <a href="facturationfourni-pdf?id={{$this->ids}}&code={{$this->reference}}&format=ticket" class="btn btn-sm btn-default" title="Cliquez pour imprimer" data-toggle="tooltip" target="_blank" style="color: #161a1d;"><i class="fa fa-print"></i>Ticket</a>
                                            <a href="facturationfourni-pdf?id={{$this->ids}}&code={{$this->reference}}&format=A4" class="btn btn-sm btn-default" title="Cliquez pour imprimer" data-toggle="tooltip" target="_blank"><i class="fa fa-print"></i>A4</a>
                                        </div>                            
                                        <div class="d-flex align-items-center justify-content-between gap-1">
                                            <a href="listing_fact_fourni?active=7&champ=2-1&choix=1" wire:navigate class="btn btn-sm btn-bleu d-none d-md-block ms-auto"><i class="fa fa-chevron-left"></i> Retour liste</a>
                                                    ...
                                                    <div class="hauteur_ecran">
                                                        <div class="row pt-1 px-2 pb-2">
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                {{-- <label for="fournisseur" class="col-md-5 col-sm-3 fw-semibold col-form-label">Facture fournisseur</label> --}}
                                                                <div class="row mb-1">
                                                                    <div class="col-lg-10 col-md-10 col-sm-10">
                                                                        <input type="search" name="fournisseur" wire:model.live="fournisseur" wire:keyup="searchResult" placeholder="Rechercher par nom A-Z ou numéro 0-9" class="form-control bordure fs-3 px-0 w-100 @error('fournisseur') is-invalid @enderror" id="fournisseur"/>
                                                                        <div class="bloc_search_fournisseur" style="position: absolute;">                       
                                                                            @if($showdiv)
                                                                                @if($recordCount > 0)
                                                                                    <table class="table table-hover mb-0 text-nowrap w-75" style="overflow: auto; background:#f7f7f7;">                                                        
                                                                                        <tbody>
                                                                                            @if(!empty($records))                                                                
                                                                                                ...
                                                                                                @endforeach
                                                                                                <tr>                                         
                                                                                                    <td class="pointer fw-semibold text-danger"><a href="nouveau_tiers?active=3&champ=3-1" target="_blank" class="text-danger"><i class="fas fa-user-plus"></i> Créer fournisseur</a></td>  
                                                                                                </tr> 
                                                                                            @endif                               
                                                                                        </tbody>                                        
                                                                                    </table>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">                                            
                                                                <div class="row mb-1">
                                                                    ...
                                                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                                                        <span class="form-control sans_bordure fw-bold fs-6 text-danger">{{$this->reference}}</span>
                                                                    </div>
                                                                    <div class="d-flex justify-content-start">
                                                                ...
                                                                {{-- @if($this->code_commande)
                                                                    <div class="row mb-1">
                                                                        ...
                                                                        <div class="col-lg-8 col-md-7 col-sm-8">
                                                                            <span class="form-control sans_bordure fw-bold fs-6 pointer" wire:click.prevent="detailCmd({{$this->idx}},'{{$this->code_commande}}')"><span class="fw-bold text-bleu">@if($this->code_commande) &nbsp;» @endif {{$this->code_commande}}</span> <i class="fas fa-info-circle text-bleu" data-bs-toggle="tooltip" data-bs-placement="top" style="vertical-align: middle; cursor: help" title="Cliquez sur la référence pour voir les details commande client"></i></span>
                                                                        </div>
                                                                        <div class="d-flex justify-content-start">
                                                                            @error('reference') <span class="text-danger">{{ $message }}</span> @enderror 
                                                                        </div>
                                                                ...
                                                                @endif --}}
                                                                <div class="row mb-1">
                                                                    <label for="date_facturation" class="col-md-5 col-sm-3 fw-bold col-form-label">Date de facturation</label>
                                                                    <div class="col-md-7 col-sm-9">
                                                                        <input type="date" wire:model="date_facturation" class="form-control bordure w-50 @error('date_facturation') is-invalid @enderror" id="date_facturation">
                                                                    </div>
                                                                    <div class="d-flex justify-content-start">
                                                                ...
                                                                <div class="row mb-1">
                                                                    <label for="date_echeance" class="col-md-5 col-sm-3 fw-bold col-form-label">Date échéance</label>
                                                                    <div class="col-md-7 col-sm-9">
                                                                        <input type="date" wire:model="date_echeance"  class="form-control bordure w-50 @error('date_echeance') is-invalid @enderror" id="date_echeance">
                                                                    </div>
                                                                    <div class="d-flex justify-content-start">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="row mb-1">
                                                                    <label for="mode_reglement" class="col-md-5 col-sm-4 fw-bold col-form-label">Mode de règlement</label>
                                                                ...
                                                                <div class="row mb-1">
                                                                    <label for="compte_bancaire" class="col-md-5 col-sm-3 fw-bold col-form-label">Compte bancaire</label>
                                                                    <div class="col-md-7 col-sm-9">                                                        
                                                                        <select id="compte_bancaire" wire:model="compte_bancaire" class="form-control form-select bordure w-75 @error('compte_bancaire') is-invalid @enderror" id="compte_bancaire">
                                                                            <option value=""></option>	
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="row mb-1">
                                                                    <label for="note" class="col-sm-2 col-form-label" style="font-weight: 400;">Note <span wire:click.prevent="enregistrerNote()" title="Cliquez pour enregistrer la note" data-bs-toggle="tooltip" data-bs-placement="top"> <i class="fas fa-pencil text-muted pointer"></i> </span></label>
                                                                    <div class="col-sm-10">                                                        
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 px-0">
                                                                <div class="table-responsive mt-2"> 
                                                                    <ul class="nav nav-tabs border-0" role="tablist">
                                                                        <li class="nav-item">
                                                                            <a class="nav-link active" data-bs-toggle="tab" href="#ligneFact">Ligne de facture (<span class="text-vert">{{$factFournisseurLigneCount}}</span>)</a>
                                                                        </li>
                                                                    </ul>
                                                                    <div class="tab-content table-responsive border-top rounded-0">
                                                                        <div id="ligneFact" class="tab-pane active">                               
                                                                            <table class="table table-striped text-nowrap m-0"> 
                                                                                <thead>
                                                                                    <tr>
                                                                                        <th class="fond_entete_table pointer" wire:click="setOrderField('produit')">Produit (<span class="text-vert">{{$factFournisseurLigneCount}}</span>) <i class="fa fa-arrow-down-short-wide"></i></th>
                                                                                        <th class="fond_entete_table pointer" wire:click="setOrderField('type_produit')">Type <i class="fa fa-arrow-down-short-wide"></i></th>
                                                                                        <th class="fond_entete_table pointer text-end" wire:click="setOrderField('prix_achat')">Prix <i class="fa fa-arrow-down-short-wide"></i></th>
                                                                                ...
                                                                                <tbody>
                                                                                    @foreach($factFournisseur_ligne as $factFournisseur_lignes)
                                                                                        <tr> 
                                                                                            <td class="fw-bold"><a href="detail_product?id={{$factFournisseur_lignes->id_produit}}&active=4&champ=1-1&choix=2" wire:navigate class="text-bleu fw-bold">{{Str::limit($factFournisseur_lignes->produit, 32)}} - <span class="text-muted">{{Str::limit($factFournisseur_lignes->reference, 22)}}</a></td>                                                         
                                                                                            <td class="text-muted fw-semibold">{{$factFournisseur_lignes->type_produit}}</td>  
                                                                                            <td class="fw-bold text-end">{{$factFournisseur_lignes->prix_achat}}</td>     
                                                                                            <td class="text-center fw-bold"> 
                                                                                                @if($factFournisseur_lignes->quantite_recue == 0)
                                                                                                    {{$factFournisseur_lignes->quantite}}
                                                                                                @else 
                                                                                                    {{$factFournisseur_lignes->quantite_recue}}
                                                                                                @endif
                                                                                            </td>         
                                                                                            <td class="text-center fw-semibold @if($factFournisseur_lignes->remise > 0) text-vert @endif">{{$factFournisseur_lignes->remise}}%</td>         
                                                                                            <td class="text-end fw-semibold">{{$factFournisseur_lignes->tva}}%</td>         
                                                                                            <td class="text-center fw-semibold">{{$factFournisseur_lignes->precompte}}%</td> 
                                                                                            <td class="text-center fw-semibold @if($factFournisseur_lignes->offrir == "Oui") text-danger @endif">{{$factFournisseur_lignes->offrir}}</td> 
                                                                                            <td class="text-end fw-bold">{{number_format($factFournisseur_lignes->montant_ttc,0,',',' ')}}</td>
                                                                                            <td class="text-end fw-semibold">
                                                                                            @if($etat == 'Brouillon')
                                                                                                @if($confirmer === $factFournisseur_lignes->id)                                                               
                                                                                                    <a wire:click.prevent="supprimer({{$factFournisseur_lignes->id}})" class="btn btn-outline-danger btn-xs bg-danger text-white blink" style="font-size: 8px;" title="Cliquez pour confirmer la suppression" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"> Confirmer ?</i></a>
                                                                                                @else
                                                                                                    <a wire:click.prevent="confirmerDelete({{$factFournisseur_lignes->id}})" class="btn btn-outline-muted btn-xs"  title="Cliquez pour supprimer" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"></i></a>
                                                                                                @endif
                                                                                            @endif
                                                                                            </td> 
                                                                                        </tr> 
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 px-0">
                                                                @if($factFournisseurLigneCount)
                                                                    <div class="border-topk rounded-0">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-12"> 
                                                                                <div class="table-responsive">
                                                                                    <table class="table table-striped table-hover text-nowrap m-0"> 
                                                                                        ...
                                                                                        <tbody> 
                                                                                            @foreach($reglementFournisseur as $reglementFournisseurs)
                                                                                                <tr> 
                                                                                                    <td class="fw-semibold">{{$reglementFournisseurs->ref_reglement}}</td> 
                                                                                                    <td>{{date('d-m-Y H:i', strtotime($reglementFournisseurs->created_at))}}</td> 
                                                                                                    <td>{{$reglementFournisseurs->mode_reglement}}</td> 
                                                                                                    <td><a href="detail_banque?id={{$reglementFournisseurs->id_compte_bancaire}}&active=8&champ=1-1" class="text-bleu fw-semibold">{{$reglementFournisseurs->compte_bancaire}}</a></td>
                                                                                                    <td class="text-end text-vert fw-semibold">{{number_format($reglementFournisseurs->montant_regler,0,',',' ')}}</td> 
                                                                                                    <td class="taille_icon text-end">
                                                                                                        @if($confirmation === $reglementFournisseurs->id)                                                               
                                                                                                            <a wire:click.prevent="effacer({{$reglementFournisseurs->id}},{{$reglementFournisseurs->id_compte_bancaire}})" class="btn btn-outline-danger btn-xs bg-danger text-white blink" style="font-size:8px;" title="Cliquez pour confirmer la suppression" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"> ?</i></a>
                                                                                                        @else
                                                                                                            <a wire:click.prevent="confirmationDelete({{$reglementFournisseurs->id}})" class="btn btn-outline-muted btn-xs" style="font-size:9px;" title="Cliquez pour supprimer" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"></i></a>
                                                                                                        @endif
                                                                                                    </td> 
                                                                                                    {{-- <td class="text-end"><i class="fa fa-trash" title="Cliquez pour supprimer" data-toggle="tooltip"></i></td>  --}}
                                                                                                </tr> 
                                                                                            @endforeach
                                                                                            <tr> 
                                                                                                <td colspan="4" class="text-end fw-bold">Déjà réglé</td> 
                                                                                                <td class="text-end fw-bold text-bleu">{{number_format($dejaRegler,0,',',' ')}}</td> 
                                                                                                <td class="text-end"></td> 
                                                                                            </tr> 
                                                                                            <tr> 
                                                                                                <td colspan="4" class="text-end fw-bold">Facturé</td> 
                                                                                                <td class="text-end fw-bold">{{number_format($montantTTC,0,',',' ')}}</td> 
                                                                                                <td class="text-end"></td> 
                                                                                            </tr>
                                                                                            <tr> 
                                                                                                <td colspan="4" class="text-end fw-bold">Reste à payer</td> 
                                                                                                <td class="text-end text-danger fw-bold fs-5">{{number_format($reste_a_percevoir,0,',',' ')}}</td> 
                                                                                                <td class="text-end"></td> 
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                ...
                                                <div class="alert mt-3 mb-0 d-flex justify-content-between align-items-center rounded-2 px-3 py-2" style="background-color: #f4f8ff; border: 1px solid #cce0ff;">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <span class="text-dark" style="font-size: 13px;">
                                                            <span class="fw-bold">Voir plus de facture,</span> 
                                                            <span class="text-muted ms-1">document légal, commercial et comptable.</span>
                                                        </span>
                                                    </div>
                                                    <a href="{{asset('listing_fact_fourni?active=7&champ=2-1&choix=1')}}" wire:navigate class="text-decoration-none fw-semibold text-primary" style="font-size: 13px;">Voir plus</a>
                                                </div>
                                            </div>                                                
                                        </div>                                            
                                    </div>                                     
    ...
    {{-- Modal --}}
   @include('livewire.gestion-facturation.fournisseur.saisie_paiement')
   @if($this->type_produit == 'Service')
        @include('livewire.gestion-facturation.fournisseur.selection_ligne_service_facture_fourni')  
   @else
        @include('livewire.gestion-facturation.fournisseur.selection_ligne_produit_facture_fourni')  
   @endif 
</div>
