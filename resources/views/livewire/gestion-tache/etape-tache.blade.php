                            ...
                            <div class="col-lg-12">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2">
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="d-block fw-bold text-secondary" style="font-size: 11px;">Nombre Total Etape</span>
                                                    <span class="d-block fw-semibold text-dark" style="font-size: 13px;">{{$nbreTotalEtapeTache}}</span>
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-1">
                                    ...
                                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">
                                        <li class="nav-item">                                                
                                            <a class="nav-link active" data-bs-toggle="tab" href="#home" title="Liste des tieres : Prospects, Clients, Fournisseurs"><i class="fas fa-users text-bleu"></i> {{$title_fils}} (<span class="text-vert">{{$etapeCount}}</span>)</a>                                                
                                        </li>  
                                        <li class="nav-item">
                                                        ...
                                                        <div class="hauteur_ecran">
                                                            <div class="row pt-2 px-2">
                                                                @foreach($etape as $etapes)	
                                                                    <div class="col-lg-3 col-md-6 col-xs-12 mb-2 pointer" wire:click.prevent="edit('{{$etapes->id}}')" data-bs-toggle="modal" data-bs-target="#updateEtapeModal" title="Cliquez pour modifier ou supprimer" data-toggle="tooltip">                            
                                                                        <div class="row rounded border list_achat">                                        
                                                                            <div class="col-md-8 col-sm-8 col-xs-8 mt-2 mb-2"> 
                                                                                ...
                                                                                @endphp
                                                                                <strong class="text-bleu title_color truncate_ok" title="{{$etapes->nom_etape}}"><i class="fa fa-chart-pie"></i> {{Str::limit($etapes->nom_etape, 22)}} (<span class="text-danger" title="{{$nombre}} Tâche(s)">{{$nombre}}</span>)</strong>
                                                                            </div>                                        
                                                                            ...
                                                                            <div class="col-md-8 col-sm-8 col-xs-8 mb-2"> 
                                                                                {{-- <span class="date_achat">{{date('d-m-Y H:i:s', strtotime($etapes->created_at))}} <i class="fa fa-calendar-alt light"></i></span> --}}
