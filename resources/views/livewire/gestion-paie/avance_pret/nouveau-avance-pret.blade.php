                ...
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center justify-content-between gap-1">                                                       
                            <div class="d-flex align-items-center justify-content-between gap-1">                            
                                <button class="btn btn-sm btn-secondary" wire:click.prevent="store()" title="Cliquez pour modifier" data-toggle="tooltip"><i class="fa fa-check"></i> Valider</button>
                                    ...
                                    <div class="hauteur_ecran">
                                        <div class="row pt-1 px-2 pb-2">                                            
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <label for="nom_opportunite" class="col-md-5 col-sm-3 fw-semibold col-form-label">Nouvelle avance ou prêt</label>
                                                <div class="row mb-3">
