<div wire:ignore.self class="modal fade" id="createGrilleModal" tabindex="-1" role="dialog" aria-labelledby="slidemodalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-sm modal_wamsco_catg">
            <div class="modal-content">             
                ...
                <div class="modal-footer pt-0 pb-0 modal_peids" style="background-color: #56585d; color:#ffffff;"> 
					<button class="btn btn-sm btn-secondary fw-bold" title="Cliquez pour enregistrer" data-toggle="tooltip" wire:click.prevent="store()"><i class="fa fa-check"></i> Valider</button>              
