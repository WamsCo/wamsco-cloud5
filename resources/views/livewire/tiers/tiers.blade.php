                            ...
                            <div class="col-lg-12">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2">
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="d-block fw-bold text-secondary" style="font-size: 11px;">Total tiers</span>
                                                    <span class="d-block fw-semibold text-dark" style="font-size: 13px;">{{$nbreTotalTier}}</span>
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="d-block fw-bold text-secondary" style="font-size: 11px;">Solde Total</span>
                                                    <span class="d-block fw-bold text-dark mt-1" style="font-size: 14px;">{{number_format($SoldeTotalTier,0,',',' ')}} <span style="font-size: 10px;">{{$this->devise}}</span></span>
                                                </div>
                                            </div>                                            
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    ...
                                                    <span class="d-block fw-bold text-dark mt-1" style="font-size: 14px;">{{$nbrePointFidelite}} <span style="font-size: 10px;">Pts</span></span>
                                                </div>
                                            </div>   
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-1">
                                    ...
                                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">
                                        <li class="nav-item">                                                
                                            <a class="nav-link active" data-bs-toggle="tab" href="#home" title="Liste des tieres : Prospects, Clients, Fournisseurs"><i class="fas fa-users text-bleu"></i> {{$title_fils}} (<span class="text-vert">{{$tiersCount}}</span>)</a>                                                
                                        </li>  
                                        <li class="nav-item">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1">                            
                                            {{-- <a href="{{asset('listing-tiers?active=3&champ=3-2')}}" wire:navigate class="btn btn-sm btn-bleu d-none d-md-block ms-auto"><i class="fa fa-chevron-left"></i> Retour liste</a> --}}
                                            <button href="#" data-bs-toggle="modal" data-bs-target="#createTierModal" title="Cliquez pour ajouter un nouveau tier" data-toggle="tooltip" class="btn btn-sm btn-danger ms-auto"><i class="fa fa-plus-circle"></i> Nouveau tier</button>
                                ...
                                <div class="tab-content position-relative custom-scroll px-3" style="height: calc(100vh - 255px); overflow-y: auto;">
                                                            ...
                                                            <tbody>
                                                                @foreach($tiers as $tier) 
                                                                    <tr>                                                
                                                                        ...
                                                                        @if($activer_fidelite == 1)
                                                                            <td class="pointer"><a data-bs-toggle="modal" data-bs-target="#afficheFidelitModal" wire:click.prevent="charge({{$tier->id}})" class="btn-outline-muted"><i class="fa fa-podcast" title="Cliquez pour afficher point de fidélité" data-bs-toggle="tooltip" data-bs-placement="top"></i></a></td>
                                                                        @endif 
                                                                        <td class=""><a href="detail_tier?id={{$tier->id}}&active=3&champ=3-2" wire:navigate class="btn-outline-muted pointer"><i class="fa fa-pencil" title="Cliquez pour modifier" data-bs-toggle="tooltip" data-bs-placement="top"></i></a></td>
                                                                        <td class="taille_icon text-end">
                                                                            @if($confirmer === $tier->id)                                                               
                                                                                <a wire:click.prevent="supprimer({{$tier->id}},'{{$tier->type_entrepots}}')" class="btn btn-outline-danger btn-xs bg-danger text-white blink" style="font-size: 8px;" title="Cliquez pour confirmer la suppression" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"> Confirmer?</i></a>
                                                                            @else
                                                                                <a wire:click.prevent="confirmerDelete({{$tier->id}})" class="btn-outline-muted pointer"  title="Cliquez pour supprimer" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"></i></a>
                                                                            @endif
                                                                        </td> 
                                                                    </tr>
                                                                @endforeach
                                    ...
                                    <div id="facture" class="container-fluid tab-pane fade pas_bordure">
                                        <div class="card shadow-sm">  
                                            <div class="card shadow-sm border border-light-subtle rounded-3 bg-white p-2">    
                                                ...
                                                <div class="position-relative custom-scroll pe-2" style="height: calc(100vh - 352px); overflow-y: auto;">  
