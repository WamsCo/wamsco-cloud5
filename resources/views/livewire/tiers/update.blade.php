<div wire:ignore.self class="modal fade" id="updateTierModal" tabindex="-1" data-bs-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <h5 class="modal-title" id="exampleModalCenteredScrollableTitle"> Modification » <span class="text-vert">{{$this->nom}}</span> </h5>
                            ...
                            <div class="table-responsive mt-2">
                                <div class="table-responsive mt-1"> 
                                    <ul class="nav nav-tabs border-0" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#Compta">Comptabilité</a>
                                        </li>
                                    </ul>
