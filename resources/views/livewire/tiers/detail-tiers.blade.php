                                    ...
                                    <div class="card border-0 shadow-sm">
                                        <div class="card-body border border-light-subtle rounded-3 bg-white position-relative custom-scroll pe-2" style="height: calc(100vh - 131px); overflow-y: auto;">
                                            ...
                                            <div class="d-flex gap-2 mb-1">
                                                ...
                                                <button href="#" wire:click.prevent="edit({{$tiers->id}})" data-bs-toggle="modal" data-bs-target="#updateTierModal" title="Cliquez pour modifier" data-toggle="tooltip" class="btn btn-sm btn-outline-secondary flex-fill fw-semibold ms-auto"><i class="fa fa-pen"></i> Modifier</button>
                                            ...
                                            <button href="listing-tiers?active=3&champ=3-2" wire:navigate class="btn btn-sm btn-outline-success w-100 mb-4"><i class="fa fa-close"></i> Fermer</button>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2">     
                                                ...
                                                <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                    ...
                                                    <div class="text-nowrap">
                                                        ...
                                                        <span class="d-block fw-semibold text-dark" style="font-size: 13px;">{{ $tiers->updated_at->format('d/m/Y : H:i:s') }}</span>
                                                ...
                                                <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                    ...
                                                    <div class="text-nowrap">
                                                        ...
                                                        <span class="d-block fw-semibold text-dark" style="font-size: 13px;">{{ $tiers->created_at->format('d/m/Y : H:i:s') }}</span>
                                                        {{-- <span class="d-block text-muted" style="font-size: 11px; margin-top: -2px;">GMT+1</span> --}}
                                                    </div>
                                                </div>
                                        ...
                                        <div id="facture" class="container-fluid tab-pane fade pas_bordure">  
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-xs-12">   
                                                    <div class="card shadow-sm border border-light-subtle rounded-3 bg-white p-2">
                                                        <h6 class="fw-bold text-bleu mb-1"><i class="fas fa-file-invoice-dollar" style=" color: #393b83;" title="Mouvement de stock"></i> Les dernières factures <span class="text-vert">{{$tiers->nom}}</span> ({{$factCltEntCount}})</h6>
