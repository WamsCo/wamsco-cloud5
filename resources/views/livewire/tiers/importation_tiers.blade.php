<div wire:ignore.self class="modal fade" id="importerTiersModal" tabindex="-1" data-bs-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">    
    <form method="POST" action="{{route('importer_tier')}}" enctype="multipart/form-data">
            @csrf                   
        <div class="modal-dialog modal-md">
            <div class="modal-content">             
                <div class="modal-header wamsco" style="padding-top: 0px; padding-bottom: 0px;">                    
                    <h3 class="titre_modal_fidelite"><i class="fas fa-users"></i> Importer Tiers</h3>                    
                </div>
                <div class="modal-body">                                                         
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row mt-3">
                            <div class="col-sm-12">
                                <input type="file" name="fichier_tiers" class="form-control @error('fichier_tiers') is-invalid @enderror"/>
                            </div>
                            <div class="d-flex justify-content-start">
                                @error('fichier_tiers') <span class="text-danger">{{ $message }}</span> @enderror 
                            </div>
                        </div>                       								
                    </div> 
                </div>
