                            ...
                            <div class="col-lg-12">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2">
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="d-block fw-bold text-secondary" style="font-size: 11px;">Total réception </span>
                                                    <span class="d-block fw-semibold text-dark" style="font-size: 13px;">{{$nbreTotalRecept}}</span>
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-1">
                                    ...
                                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">
                                        <li class="nav-item">                                                
                                            <a class="nav-link active" data-bs-toggle="tab" href="#home"><i class="fas fa-file-invoice text-bleu"></i> {{$title_fils}} (<span class="text-vert">{{$receptionFournisseurCount}}</span>)</a>                                                
                                        </li>  
                                        <li class="nav-item">
                                                ...
                                                <div class="card shadow-sm border border-light-subtle rounded-3 bg-white px-0">
                                                    <div class="d-flex align-items-center justify-content-between gap-3 pt-2 px-2">
                                                        <div class="d-flex align-items-center justify-content-between gap-1">
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between gap-1">
                                                                {{-- <h6><a href="{{asset('exporter-recpt_fourni')}}" class="btn btn-sm btn-success mt-2 d-none d-md-block"><i class="fa-solid fa-file-export"></i> Exporter Excel</a></h6> --}}
                                                                <a href="{{asset('exporter-recpt_fourni?date_debut='.$this->date_debut.'&date_fin='.$this->date_fin.'&fournisseur='.$this->query.'&statut='.$this->parEtat.'&ref='.$this->ParRef)}}" class="btn btn-sm btn-success mt-2 d-none d-md-block mb-1"><i class="fa-solid fa-file-export"></i> Exporter Excel</a>
                                                    ...
                                                    <div class="table-responsive border-top">
                                                        <table class="table table-striped table-hover text-nowrap m-0"> 
                                                            <thead>
                                                                <tr>
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('code_reception')">Référence <i class="fa fa-arrow-down-short-wide"></i></th>   
                                                                    ...
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('date_echeance')">Echéance <i class="fa fa-arrow-down-short-wide"></i></th> 
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('code_facture')">Fature <i class="fa fa-arrow-down-short-wide"></i></th> 
                                                                    ...
                                                                    <th class="fond_entete_table pointer text-start" wire:click="setOrderField('methode_expedition')">Méthode <i class="fa fa-arrow-down-short-wide"></i></th> 
                                                                    ...
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('etat_facture')">Facture <i class="fa fa-arrow-down-short-wide"></i></th> 
                                                            ...
                                                            <tbody>
                                                                @foreach($reception_fournisseur as $reception_fournisseurs) 
                                                                    <tr>
                                                                        <td class="fw-semibold pointer"><a href="detail_reception_fourni?id={{$reception_fournisseurs->id}}&ref={{$reception_fournisseurs->code_reception}}&active=6&champ=2-1&choix=2" wire:navigate><i class="fas fa-dolly text-danger" aria-hidden="true"></i> {{$reception_fournisseurs->code_reception}}</a></td> 
                                                                        <td class="fw-semibold pointer"><a href="detail_tier?id={{$reception_fournisseurs->id_fournisseur}}&ref={{$reception_fournisseurs->code_facture}}&active=3&champ=3-2" wire:navigate class="text-bleu">@if($reception_fournisseurs->nom_fournisseur) <i class="fa fa-user-circle"></i> @endif {{substr($reception_fournisseurs->nom_fournisseur,0,52) > substr($reception_fournisseurs->nom_fournisseur,0,51) ? substr($reception_fournisseurs->nom_fournisseur,0,52).'...': $reception_fournisseurs->nom_fournisseur}}</a></td>                                                                      
                                                                        <td class="">{{date('d-m-Y', strtotime($reception_fournisseurs->created_at))}}</td>
                                                                        <td class="">{{date('d-m-Y', strtotime($reception_fournisseurs->date_echeance))}}</td>
                                                                        <td class="fw-semibold pointer">
                                                                            @if(!empty($reception_fournisseurs->id_facture_fournisseur_entete))
                                                                                <a href="#" wire:click.prevent="detailFact({{$reception_fournisseurs->id_facture_fournisseur_entete}}, '{{$reception_fournisseurs->code_facture}}')" class="fw-semibold fs-6" title="Numéro facture client (cliquable)"><i class="fas fa-file-invoice-dollar text-danger" aria-hidden="true"></i> {{$reception_fournisseurs->code_facture}}</a>
                                                                            @else
                                                                                <a href="#" wire:click.prevent="detailCmd({{$reception_fournisseurs->id_commande_fournisseur_entete}}, '{{$reception_fournisseurs->code_commande}}')" class="fw-semibold fs-6" title="Numéro commande client (cliquable)"><i class="fas fa-file-invoice text-vert" aria-hidden="true"></i> {{$reception_fournisseurs->code_commande}}</a>
                                                                            @endif
                                                                            {{-- <a href="nouveau_fact_fourni?id={{$reception_fournisseurs->id_facture_fournisseur_entete}}&ref={{$reception_fournisseurs->code_facture}}" wire:navigate><i class="fas fa-file-invoice-dollar text-danger" aria-hidden="true"></i> {{$reception_fournisseurs->code_facture}}</a> --}}
                                                                        </td> 
                                                                        <td class="fw-semibold text-end">{{number_format($reception_fournisseurs->montant_ttc,0,',',' ')}}</td>
                                                                        <td class="fw-semibold text-end">{{number_format($reception_fournisseurs->montant_recu,0,',',' ')}}</td>
                                                                        <td class="fw-semibold text-start">{{$reception_fournisseurs->methode_expedition}}</td>
                                                                        <td class="text-start">
                                                                            @if($reception_fournisseurs->etat == "Brouillon")
                                                                                <span class="badge bg-secondary" title="Réception {{$reception_fournisseurs->etat}}"><i class="fa fa-box"></i> {{$reception_fournisseurs->etat}}</span>
                                                                            @elseif($reception_fournisseurs->etat == "Clôturée")
                                                                                <span class="badge bg-danger" title="Réception {{$reception_fournisseurs->etat}}"><i class="fa fa-thumbs-up"></i> {{$reception_fournisseurs->etat}}</span>
                                                                            @elseif($reception_fournisseurs->etat == "Partiel")
                                                                                <span class="badge bg-primary" title="Réception {{$reception_fournisseurs->etat}}"><i class="fa fa-check-circle"></i> {{$reception_fournisseurs->etat}}</span>
                                                                            @elseif($reception_fournisseurs->etat == "")
                                                                                <span class="badge bg-light text-dark" title="Réception non créée"><i class="fas fa-dolly"></i> Non créée</span>
                                                                            @endif   
                                                                        </td>                                                 
                                                                        <td class="text-start">
                                                                            @if($reception_fournisseurs->etat_facture == "Brouillon")
                                                                                <span class="badge bg-secondary" title="Facture {{$reception_fournisseurs->etat_facture}}"><i class="fa fa-box"></i> {{$reception_fournisseurs->etat_facture}}</span>
                                                                            @elseif($reception_fournisseurs->etat_facture == "Impayée")
                                                                                <span class="badge bg-danger" title="Facture {{$reception_fournisseurs->etat_facture}}"><i class="fa fa-times-circle"></i> {{$reception_fournisseurs->etat_facture}}</span>
                                                                            @elseif($reception_fournisseurs->etat_facture == "Payée")
                                                                                <span class="badge bg-success" title="Facture {{$reception_fournisseurs->etat_facture}}"><i class="fa fa-check-circle"></i> {{$reception_fournisseurs->etat_facture}}</span>
                                                                            @elseif($reception_fournisseurs->etat_facture == "Commencée")
                                                                                <span class="badge bg-info" title="Facture {{$reception_fournisseurs->etat_facture}}"><i class="fa fa-recycle"></i> {{$reception_fournisseurs->etat_facture}}</span>
                                                                            @elseif($reception_fournisseurs->etat_facture == "Validée")
                                                                                <span class="badge bg-warning" title="Facture Non créer"><i class="fas fa-file-invoice-dollar"></i> Non créer</span>
                                                                            @endif                                                 
                                                                        </td> 
                                                                        <td class="pointer"><a href="detail_user?id={{$reception_fournisseurs->user_id}}&active=12&champ=1-1" wire:navigate><i class="fas fa-user-circle text-bleu" aria-hidden="true"></i> {{$reception_fournisseurs->nom_user}}</a></td>                                                                          
                                                                        <td class="">{{date('d-m-Y H:i:s', strtotime($reception_fournisseurs->updated_at))}}</td>
                                                                        <td class="text-end"><a href="detail_reception_fourni?id={{$reception_fournisseurs->id}}&ref={{$reception_fournisseurs->code_reception}}" wire:navigate class="btn-outline-muted"  title="Cliquez pour voir ou modifier" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-eye"></i></a></td>
                                                                        {{-- <td class="taille_icon text-end">
                                                                            @if($confirmer === $reception_fournisseurs->id)                                                               
                                                                                <a wire:click.prevent="supprimer({{$reception_fournisseurs->id}},'{{$reception_fournisseurs->code_facture}}')" class="btn btn-outline-danger btn-xs bg-danger text-white blink" style="font-size:8px;"  title="Cliquez pour confirmer la suppression" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"> Confirmer ?</i></a>
                                                                            @else
                                                                                <a wire:click.prevent="confirmerDelete({{$reception_fournisseurs->id}})" class="btn btn-outline-muted btn-xs"  title="Cliquez pour supprimer" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"></i></a>
                                                                            @endif
                                                                        </td>  --}}
                                                                    </tr>
                                                                @endforeach    
                                                        ...
                                                        <div class="bloc_pagination">{{$reception_fournisseur->links()}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
