<div x-data="{selection: @entangle('selection').defer}">
                                    ...
                                    <div class="card-body border border-light-subtle rounded-3 bg-white position-relative custom-scroll pe-2" style="height: calc(100vh - 131px); overflow-y: auto;">
                                        <div class="text-centerk">
                                            ...
                                            <div class="d-flex align-items-center justify-content-end gap-1">
                                                <div class="statusref">
                                                    @if($etat == "Brouillon")
                                                        <span class="badge bg-secondary py-1" title="Commande {{$etat}}"><i class="fa fa-box"></i> {{$etat}}</span>
                                                    @elseif($etat == "Impayée")
                                                        <span class="badge bg-danger py-1" title="Commande {{$etat}}"><i class="fa fa-times-circle"></i> {{$etat}}</span>
                                                    @elseif($etat == "Payée")
                                                        <span class="badge bg-success py-1" title="Commande {{$etat}}"><i class="fa fa-check-circle"></i> {{$etat}}</span>  
                                                    @elseif($etat == "Validée")
                                                        <span class="badge bg-success py-1" title="Commande {{$etat}}"><i class="fa fa-check"></i> {{$etat}}</span>  
                                                    @endif
                                                </div>
                                                <div class="statusref">
                                        ...
                                        <div class="d-flex gap-1 mb-2">
                                           <a href="listing_cmd_fourni?active=6&champ=2-1&choix=1" wire:navigate class="btn btn-sm btn-outline-danger flex-fill" title="Cliquez pour fermer" data-toggle="tooltip"><i class="fa fa-close"></i> Fermer</a>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1 border-bottom pb-2">
                                            @if($factFournisseurLigneCount)
                                                @if($etat == 'Brouillon')
                                                    @if($this->fournisseur_id > 0)                                        
                                                        <button type="submit" wire:click.prevent="valider()" class="btn btn-sm btn-outline-info flex-fill text-bleu fw-bold"><i class="fa fa-check"></i> Valider Commande</button>                                                               
                                                    @endif
                                                @elseif($etat == 'Validée')                                   
                                                    @if($this->etat_reception != "Clôturée")
                                                        <a href="#" class="btn btn-sm btn-outline-primary flex-fill fw-semibold ms-auto" title="Cliquez pour créer une réception" data-bs-toggle="modal" data-bs-target="#SelectLigneReceptionModal" wire:click.prevent="chargeReception('Produit')" title="Cliquez pour ajouter un produit" data-toggle="tooltip"> <i class="fa fa-dolly"></i> Créer réception</a>
                                                        <a href="#" class="btn btn-sm btn-outline-green flex-fill fw-semibold ms-auto" title="Cliquez pour créer une facturation" data-bs-toggle="modal" data-bs-target="#SelectLigneFacturationModal" wire:click.prevent="chargeFacturation('Produit')" title="Cliquez pour ajouter un produit" data-toggle="tooltip"> <i class="fa fa-money-bill"></i> Créer facture</a>
                                                    @endif  
                                                @endif  
                                            @endif
                                        </div> 
                                            ...
                                            <table class="table table-striped table-hover text-nowrap m-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($factCltEntete as $factCltEntetes)
                                                        <tr>
                                                            <td class="fw-semibold"><a href="nouveau_fact_fourni?id={{$factCltEntetes->id}}&ref={{$factCltEntetes->code_facture}}&active=7&champ=2-1&choix=1" wire:navigate>Facture</a></td>
                                                            <td class="fw-semibold"><a href="nouveau_fact_fourni?id={{$factCltEntetes->id}}&ref={{$factCltEntetes->code_facture}}&active=7&champ=2-1&choix=1" wire:navigate class="text-bleu"><i class="fa fa-money-bill text-vert" aria-hidden="true"></i> {{$factCltEntetes->code_facture}}</a></td>
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-0">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1">
                                            <a href="listing_cmd_fourni?active=6&champ=2-1&choix=1" wire:navigate class="btn btn-sm btn-bleu d-none d-md-block ms-auto"><i class="fa fa-chevron-left"></i> Retour liste</a>
                                                    ...
                                                    <div class="hauteur_ecran">
                                                        <div class="row pt-1 px-2 pb-2">
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                {{-- <label for="fournisseur" class="col-md-5 col-sm-3 fw-semibold col-form-label">Commande fournisseur</label> --}}
                                                                <div class="row mb-1">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">                                            
                                                                ...
                                                                <div class="row mb-1">
                                                                <label for="date_commande" class="col-md-5 col-sm-3 fw-bold col-form-label">Date commande</label>
                                                                    <div class="col-md-7 col-sm-9">
                                                                        <input type="date" wire:model="date_commande" class="form-control bordure w-50 @error('date_commande') is-invalid @enderror" id="date_commande">
                                                                    </div>
                                                                    <div class="d-flex justify-content-start">
                                                                ...
                                                                <div class="row mb-1">
                                                                    <label for="date_livraison" class="col-md-5 col-sm-3 fw-bold col-form-label">Date livraison</label>
                                                                    <div class="col-md-7 col-sm-9">
                                                                        <input type="date" wire:model="date_livraison"  class="form-control bordure w-50 @error('date_livraison') is-invalid @enderror" id="date_livraison">
                                                                    </div>
                                                                    <div class="d-flex justify-content-start">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                ...
                                                                <div class="row mb-1">
                                                                    <label for="condition_reglement" class="col-md-5 col-sm-3 col-form-label" style="font-weight: 400;">Conditions règlement</label>
                                                                    <div class="col-md-7 col-sm-9">                                                        
                                                                        <select id="condition_reglement" wire:model="condition_reglement" class="form-control form-select bordure w-auto @error('condition_reglement') is-invalid @enderror" id="condition_reglement">
                                                                            <option value=""></option>	
                                                                ...
                                                                <div class="table-responsive mt-2">
                                                                    <div class="table-responsive mt-1"> 
                                                                        <ul class="nav nav-tabs margin_ajuste border-0 pb-3" role="tablist">
                                                                            <li class="nav-item">
                                                                                <a class="nav-link active" data-bs-toggle="tab" href="#ligneCmd">Ligne de commande (<span class="text-vert">{{$factFournisseurLigneCount}}</span>)</a>
                                                                            </li>
                                                                            <li class="nav-item">
                                                                                <a class="nav-link" data-bs-toggle="tab" href="#recept">Réceptions - Bons de livraison (<span class="text-vert">{{$recepClientLigneCount}}</span>)</a> 
                                                                            </li>
                                                                            <li class="nav-item">
                                                                                <a class="nav-link" data-bs-toggle="tab" href="#marge">Marge</a>
                                                                            </li>
                                                                        </ul>
                                                                        <div class="tab-content table-responsive border-top rounded-0">
                                                                            <div id="ligneCmd" class="tab-pane active">                               
                                                                                <table class="table table-striped text-nowrap m-0"> 
                                                                                    ...
                                                                                    <tbody>
                                                                                        @foreach($factFournisseur_ligne as $factFournisseur_lignes)
                                                                                            <tr> 
                                                                                                <td class="fw-bold"><a href="detail_product?id={{$factFournisseur_lignes->id_produit}}" wire:navigate class="text-bleu fw-bold">{{$factFournisseur_lignes->produit}}</a></td>                                                         
                                                                                                <td class="fw-semibold text-muted">{{$factFournisseur_lignes->type_produit}}</td>     
                                                                                                <td class="fw-bold text-end">{{$factFournisseur_lignes->prix_achat}}</td>     
                                                                                                <td class="text-center fw-bold">{{$factFournisseur_lignes->quantite}}</td>         
                                                                                ...
                                                                                <table class="table table-striped table-hover text-nowrap m-0"> 
                                                                                    <thead>
                                                                                        <tr>
                                                                                            ...
                                                                                            <th class="fond_entete_table text-start">Entrepôt (Stock) <i class="fas fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="top" style="vertical-align: middle; cursor: help" title="Choisissez le magassin de reception dans les paramètres"></i></th> 
                                                                                        </tr>
                                                                                        </thead>                                       
                                                                                    <tbody>  
                                                                                        @foreach($recepClient_ligne as $recepClient_lignes)                                                    
                                                                                            <tr> 
                                                                                                <td class="fw-bold"><a href="detail_product?id={{$recepClient_lignes->id_produit}}&active=4&champ=1-1&choix=2" wire:navigate class="text-bleu fw-bold">{{Str::limit($recepClient_lignes->produit, 32)}} - <span class="text-muted">{{Str::limit($recepClient_lignes->reference, 22)}}</span></a></td>                                                         
                                                                                                <td class="text-muted fw-semibold">{{$recepClient_lignes->type_produit}}</td>         
                                                                                                <td class="text-center fw-bold">{{$recepClient_lignes->quantite}}</td>         
                                                                            ...
                                                                            <div id="marge" class="tab-pane">                               
                                                                                <div class="table-responsive">
                                                                                    <table class="table table-striped table-hover text-nowrap m-0"> 
                                                                                        <thead> 
                                                                                            <tr> 
                                                                                                <th colspan="3" class="fond_entete_table">Produits</th> 
                                                                                                <th class="fond_entete_table text-end">Prix dachat</th> 
                                                                                                <th class="fond_entete_table text-end">Prix de revient</th> 
                                                                                                <th class="fond_entete_table text-end">Marge</th> 
                                                                                                <th class="fond_entete_table text-end">Taux marge <i class="fas fa-info-circle" title="Le taux marge se calcul uniquement sur articles de type produit. (Taux marge = (montant marge/prix achat) * 100)" data-bs-toggle="tooltip" data-bs-placement="top" style=" vertical-align: middle; cursor: help"></i></th>  
                                                                                            </tr>  
                                                                                        </thead> 
                                                                                        <tbody> 
                                                                                            <tr> 
                                                                                                <td colspan="3" class="fw-semibold">Produits</td> 
                                                                                                <td class="text-end fw-semibold">{{number_format($montantPrixAchat,0,',',' ')}}</td> 
                                                                                                <td class="text-end fw-semibold">
                                                                                                    @if($autoriser == 1)                                                                    
                                                                                                ...
                                                                                                <td class="text-end text-bleu fw-semibold">
                                                                                                    @if($autoriser == 1)
                                                ...
                                                <div class="alert mt-3 mb-0 d-flex justify-content-between align-items-center rounded-2 px-3 py-2" style="background-color: #f4f8ff; border: 1px solid #cce0ff;">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <span class="text-dark" style="font-size: 13px;">
                                                            <span class="fw-bold">Voir plus de commande,</span> 
                                                            <span class="text-muted ms-1">proforma, réception, expédition etc.</span>
                                                        </span>
                                                    </div>
                                                    <a href="{{asset('listing_cmd_fourni?active=6&champ=2-1&choix=1')}}" wire:navigate class="text-decoration-none fw-semibold text-primary" style="font-size: 13px;">Voir plus</a>
                                                </div>
                                            </div>                                                
                                        </div>                                            
                                    </div>                                     
   ...
   @endif
   @include('livewire.gestion-commande.fournisseur.selection_ligne_reception') 
   @include('livewire.gestion-commande.fournisseur.selection_ligne_facturation') 
</div>
