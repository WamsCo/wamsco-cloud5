<div>
    <div wire:ignore.self class="modal fade" id="SelectLigneReceptionModal" tabindex="-1" data-bs-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
        <form enctype="multipart/form-data">							
			<div class="modal-dialog modal-lg">
				<div class="modal-content">             
					<div class="modal-header py-2" style="background-color: #56585d; color:#ffffff;">
						<h3 class="modal-title fs-5"><i class="fa fa-dolly"></i> Réception (<span class="text-warning">{{$recepClientLigneCount}}</span>) » Facturation</h3>
					</div>
                                        ...
                                        <tbody>
                                            @foreach($recepClient_ligne as $recepClient_lignes)                                                    
                                                ...
                                                @if($open === $recepClient_lignes->id) 
                                                    <tr>                                                         
                                                        @include('livewire.gestion-commande.fournisseur.ajout_ligne_reception')     
                                                    </tr>
                                                @endif
                                            @endforeach                                            
                                        </tbody>
