<div x-data="{selection: @entangle('selection').defer}">
                                ...
                                <div class="card border-0 shadow-sm">
                                    <div class="card-body border border-light-subtle rounded-3 bg-white position-relative custom-scroll pe-2" style="height: calc(100vh - 131px); overflow-y: auto;">
                                        <div class="text-centerk">
                                            ...
                                            <div class="d-flex align-items-center justify-content-end gap-1">
                                                <div class="statusref">
                                                    ...
                                                    @elseif($etat == "Impayée")
                                                        <span class="badge bg-danger py-1" title="Facture {{$etat}}"><i class="fa fa-times-circle"></i> {{$etat}}</span>
                                                    @elseif($etat == "Payée")
                                        ...
                                        <div class="d-flex gap-1 mb-1">
                                            <a href="listing_cmd_clt?active=6&champ=1-1&choix=2" wire:navigate class="btn btn-sm btn-outline-danger flex-fill" title="Cliquez pour fermer" data-toggle="tooltip"><i class="fa fa-close"></i> Fermer</a>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1 border-bottom pb-2">
                                            @if($factClientLigneCount)
                                                ...
                                                @elseif($etat == 'Validée')                                   
                                                    {{-- <button type="submit" wire:click.prevent="brouillon()" class="btn btn-sm btn-outline-default flex-fill text-bleu fw-bold"><i class="fa fa-recycle"></i> Retour Brouillon</button>  --}}
                                                    @if($this->etat_expedi != "Clôturée")
                                                        <a href="#" class="btn btn-sm btn-outline-primary flex-fill fw-semibold ms-auto" title="Cliquez pour créer une expédition" data-bs-toggle="modal" data-bs-target="#SelectLigneExpeditionModal" wire:click.prevent="chargeExpedition('Produit')" title="Cliquez pour ajouter un produit" data-toggle="tooltip"> <i class="fa fa-dolly"></i> Créer expédition</a>
                                        ...
                                        <div class="table-responsive border-top rounded-0">                                        
                                            <table class="table table-striped table-hover text-nowrap m-0">
                                                ...
                                                <tbody>
                                                    @foreach($proforCltEntete as $proforCltEntetes)
                                                    <tr>
                                                        <td class="fw-semibold"><a href="nouveau_prof_clt?id={{$proforCltEntetes->id}}&ref={{$proforCltEntetes->code_proforma}}&active=6&champ=1-1&choix=1" wire:navigate>Proforma</a></td>
                                                        <td class="fw-semibold"><a href="nouveau_prof_clt?id={{$proforCltEntetes->id}}&ref={{$proforCltEntetes->code_proforma}}&active=6&champ=1-1&choix=1" wire:navigate class="text-bleu"><i class="fas fa-file-invoice text-secondary" aria-hidden="true"></i> {{$proforCltEntetes->code_proforma}}</a></td>
                                                        <td class="fw-semibold text-end">{{number_format($proforCltEntetes->montant_ttc,0,',',' ')}} {{$this->devise}}</td>
                                                        <td class="fw-semibold"> 
                                                            @if($proforCltEntetes->etat == "Brouillon")
                                                                <span class="badge bg-secondary" title="Proforma {{$proforCltEntetes->etat}}"><i class="fa fa-box"></i> {{$proforCltEntetes->etat}}</span>                                                            
                                                            @elseif($proforCltEntetes->etat == "Validée")
                                                                <span class="badge bg-success" title="Proforma {{$proforCltEntetes->etat}}"><i class="fa fa-check-circle"></i> {{$proforCltEntetes->etat}}</span>
                                                            @endif                                                                                                                 
                                                        </td>
                                                        <td class="fw-semibold"><i class="fas fa-calendar-alt text-danger"></i> {{$proforCltEntetes->created_at ? date('d-m-Y H:i:s', strtotime($proforCltEntetes->created_at)): "" }}</td>                                                        
                                                    </tr>
                                                    @endforeach
                                                    ...
                                                    @foreach($factCltEntete as $factCltEntetes)
                                                        <tr>
                                                            <td class="fw-semibold"><a href="nouveau_fact_clt?id={{$factCltEntetes->id}}&ref={{$factCltEntetes->code_facture}}&active=7&champ=1-1&choix=1" wire:navigate>Facture</a></td>
                                                    ...
                                                    <div class="hauteur_ecran">
                                                        <div class="row pt-1 px-2 pb-2">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">                                            
                                                                ...
                                                                <div class="row mb-1">
                                                                    <label for="date_commande" class="col-lg-5 col-md-5 col-sm-4 fw-bold col-form-label">Date commande</label>
                                                                    <div class="col-lg-7 col-md-7 col-sm-8">
                                                                        <input type="date" wire:model="date_commande" class="form-control bordure w-75 @error('date_commande') is-invalid @enderror" id="date_commande">
                                                                    </div>
                                                                    <div class="d-flex justify-content-start">
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 px-0">
                                                                <div class="table-responsive mt-2"> 
                                                                    <ul class="nav nav-tabs border-0" role="tablist">
                                                                        ...
                                                                        <li class="nav-item">
                                                                            <a class="nav-link" data-bs-toggle="tab" href="#expedition">Expéditions - Bons de réceptions (<span class="text-vert">{{$expeClientLigneCount}}</span>)</a>
                                                                        </li>
                                                                        <li class="nav-item">
                                                                    ...
                                                                    <div class="tab-content table-responsive px-0" style="border-top-style: dashed; border-top-width: 1px;border-top-color: #0e04043d;">
                                                                            ...
                                                                            <table class="table table-striped text-nowrap m-0"> 
                                                                                ...
                                                                                <tbody>
                                                                                    @foreach($factClient_ligne as $factClient_lignes)
                                                                                        <tr> 
                                                                                            <td class="fw-bold"><a href="detail_product?id={{$factClient_lignes->id_produit}}" wire:navigate class="text-bleu fw-bold">{{Str::limit($factClient_lignes->produit, 32)}} - <span class="text-muted">{{Str::limit($factClient_lignes->reference, 22)}}</span></a></td>                                                         
                                                                                            ...
                                                                                            <td class="text-center fw-bold">{{$factClient_lignes->quantite}}</td>         
                                                                                            ...
                                                                                            @if($etat == 'Brouillon')
                                                                                                @if($confirmer === $factClient_lignes->id)                                                               
                                                                                                    <a wire:click.prevent="supprimer({{$factClient_lignes->id}})" class="btn btn-sm btn-outline-danger btn-xs bg-danger text-white blink" style="font-size: 8px;" title="Cliquez pour confirmer la suppression" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"> Confirmer ?</i></a>
                                                                                                @else
                                                                                                    <a wire:click.prevent="confirmerDelete({{$factClient_lignes->id}})" class="btn-outline-muted btn-xs pointer"  title="Cliquez pour supprimer" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"></i></a>
                                                                                                @endif
                                                                                            @endif
                                                                                            </td> 
                                                                                        </tr> 
                                                                        ...
                                                                        <div id="expedition" class="tab-pane"> 
                                                                            <table class="table table-striped table-hover text-nowrap m-0"> 
                                                                                <thead>
                                                                                    <tr>
                                                                                ...
                                                                                <tbody>  
                                                                                    @foreach($expeClient_ligne as $expeClient_lignes)                                                    
                                                                                        <tr> 
                                                                                            <td class="fw-bold"><a href="detail_product?id={{$expeClient_lignes->id_produit}}&active=4&champ=1-1&choix=2" wire:navigate class="text-bleu fw-bold">{{Str::limit($expeClient_lignes->produit, 32)}} - <span class="text-muted">{{Str::limit($expeClient_lignes->reference, 22)}}</span></a></td>                                                         
                                                                                            ...
                                                                                            <td class="text-center fw-semibold">{{$expeClient_lignes->reste_a_expedier}}</td>  
                                                                                                @php
                                                                                            ...
                                                                                            <td class="text-start fw-semibold">
                                                                                                @if($expeClient_lignes->type_produit == "Produit")
                                                                                                    <a href="detail_entrepot?id={{$expeClient_lignes->id_entrepot}}&active=4&champ=3-1&choix=2" class="text-bleu" wire:navigate>{{$nom_entrepot}} 
                                                ...
                                                <div class="alert mt-3 mb-0 d-flex justify-content-between align-items-center rounded-2 px-3 py-2" style="background-color: #f4f8ff; border: 1px solid #cce0ff;">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <span class="text-dark" style="font-size: 13px;">
                                                            ...
                                                            <span class="text-muted ms-1">proforma, expédition, réception etc.</span>
                                                        </span>
                                                    </div>
                                                    <a href="{{asset('listing_cmd_clt?active=6&champ=1-1&choix=2')}}" wire:navigate class="text-decoration-none fw-semibold text-primary" style="font-size: 13px;">Voir plus</a>
                                                </div>
                                            </div>                                                
                                        </div>                                            
                                    </div>                                     
    ...
    @endif 
    @include('livewire.gestion-commande.client.selection_ligne_expedition') 
    @include('livewire.gestion-commande.client.selection_ligne_facturation') 
