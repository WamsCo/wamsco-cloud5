			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">             
					<div class="modal-header py-2" style="background-color: #56585d; color:#ffffff;">
						<h3 class="modal-title fs-5"><i class="fa fa-money-bill"></i> Facturation (<span class="text-warning">{{$expeClientLigneCount}}</span>) » Expédition</h3>
					</div>
                                        ...
                                        <tbody>
                                            @foreach($expeClient_ligne as $expeClient_lignes)                                                    
                                                ...
                                                @if($open === $expeClient_lignes->id) 
                                                    <tr>                                                         
                                                        @include('livewire.gestion-commande.client.ajout_ligne_facturation')     
                                                    </tr>
                                                @endif
                                            @endforeach                                            
                                        </tbody>
