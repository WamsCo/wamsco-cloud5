<div wire:ignore.self class="modal fade" id="createFilialeModal" tabindex="-1" data-bs-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header py-2" style="background-color: #56585d; color:#ffffff;">
                <h5 class="modal-title" id="exampleModalCenteredScrollableTitle"> Nouvelle Société</h5>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-10 col-md-10 col-sm-10">
                                        <input type="text" wire:model="raison_sociale" placeholder="Raison sociale par ex: Société Sarl" class="form-control bordure fs-3 w-100 px-0 @error('raison_sociale') is-invalid @enderror" id="raison_sociale">
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">                                                                                                                                                 
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" wire:model="niu" placeholder="N.I.U" class="form-control bordure w-75 @error('niu') is-invalid @enderror" id="niu">
                                    </div>
                                    <div class="d-flex justify-content-start">
