<div wire:ignore.self class="modal fade" id="createUserModal" tabindex="-1" data-bs-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
        <div class="modal-header py-2" style="background-color: #56585d; color:#ffffff;">
            <h5 class="modal-title" id="exampleModalCenteredScrollableTitle"><i class="fa fa-plus-circle"></i> Nouveau utilisateur <span class="text-vert"></span> </h5>
                ...
                <div class="container-fluid">
                   <div class="row px-2">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="row mb-1">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10">
                                    <input type="text" wire:model="email" placeholder="Email » par ex: contact@wamsco-cloud.net" class="form-control bordure fs-3 w-100 px-0 @error('email') is-invalid @enderror" id="email">
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="row mb-1">
                                <label for="titre" class="col-sm-2 fw-bold col-form-label">Titre</label>
                                <div class="col-sm-10">                                                        
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-9">
                                    <input type="password" wire:model="password" placeholder="Mot de passe" style=" color: #393b83;" class="form-control fw-semibold bordure w-75 @error('password') is-invalid @enderror" id="password">
                                </div>
                                <div class="d-flex justify-content-start">
                            ...
                            <div class="row mb-1">
                                <label for="password_confirmation" class="col-lg-5 col-md-5 col-sm-4 fw-bold col-form-label">Confirmer passe</label>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">                                                
                            <div class="row mb-1">
                                <label for="nationalite" class="col-lg-5 col-md-5 col-sm-4 fw-bold col-form-label">Nationalité (pays)</label>
                                <div class="col-lg-7 col-md-7 col-sm-4">                                                        
                                    <select name="nationalite" wire:model.defer="nationalite" class="form-control form-select bordure w-100 @error('nationalite') is-invalid @enderror" style="color: #555555; font-weight: 600;">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9">
                                    <input type="text" wire:model="matricule" placeholder="" style="color: #ff332e;" class="form-control bordure w-auto @error('matricule') is-invalid @enderror" id="matricule">
                                </div>
                                <div class="d-flex justify-content-start">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="row mb-1">
                                <label for="inputPassword3" class="col-sm-3 fw-bold col-form-label">Salarié</label>
                                <div class="col-sm-9">
                                    <div class="card-body">
                                        <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" wire:model="salarie" value="1" name="inlineRadioOptions1" id="inlineRadio1" value="option1">
                                        <label class="form-check-label" for="inlineRadio1">Oui</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" wire:model="salarie" value="0" name="inlineRadioOptions2" id="inlineRadio2" value="option2" checked="">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="row mb-1">
                                ...
                                <div class="col-sm-9">
                                    <div class="card-body">
                                        <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" wire:model="etat" value="1" name="inlineRadioOptions3" id="inlineRadio3">
                                        <label class="form-check-label" for="inlineRadio3">Activer</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" wire:model="etat" value="0" name="inlineRadioOptions4" id="inlineRadio4" checked="">
                                    ...
                                    <div id="personnel" class="tab-pane">
                                        <div class="row mt-2 mb-2">
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                <div class="row mb-1">
                                                    <label for="lieu_naissance" class="col-lg-5 col-md-5 col-sm-5 col-form-label">Lieu de naissance</label>
                                                    <div class="col-lg-7 col-md-7 col-sm-7">
                                                ...
                                                <div class="row mb-1">
                                                    <label for="nbre_enfant" class="col-lg-7 col-md-7 col-sm-7 col-form-label">Nombre d'enfants à charge</label>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                <div class="row mb-1">
                                                    <label for="date_nais_conjoint" class="col-sm-7 col-md-7 col-sm-6 col-form-label">Date naissance conjoint(e)</label>
                                                    <div class="col-sm-5 col-md-5 col-sm-6">
                                                        <input type="date" wire:model="date_nais_conjoint"  class="form-control bordure w-auto @error('date_nais_conjoint') is-invalid @enderror" id="date_nais_conjoint">
                                                    </div>
                                                    <div class="d-flex justify-content-start">
                                    ...
                                    <div id="travail" class="tab-pane">
                                        <div class="row mt-2 mb-2">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                <div class="row mb-1">
                                                    <label for="responsable_rh" class="col-lg-5 col-md-5 col-sm-5 col-form-label">Responsable RH</label>
                                                    <div class="col-lg-7 col-md-7 col-sm-7">                                                        
                                    ...
                                    <div id="contrat" class="tab-pane active">
                                        <div class="row mt-2 mb-2">
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                <div class="row mb-1">
                                                    <label for="type_contrat" class="col-lg-5 col-md-5 col-sm-5 fw-bold col-form-label">Type de contrat</label>
                                                    <div class="col-lg-7 col-md-7 col-sm-7">                                                        
                                                        <select id="type_contrat" wire:model="type_contrat" class="form-control form-select text-bleu bordure w-100 @error('type_contrat') is-invalid @enderror">
                                                            <option value=""></option>
                                                ...
                                                <div class="row mb-1">
                                                    <label for="type_employe" class="col-lg-5 col-md-5 col-sm-5 fw-bold col-form-label">Type d'employé</label>
                                                    <div class="col-lg-7 col-md-7 col-sm-7">                                                        
                                                ...
                                                <div class="row mb-1">
                                                    <label for="date_debut_contrat" class="col-lg-6 col-md-6 col-sm-6 fw-bold col-form-label">Date début du contrat</label>
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                <div class="row mb-1">
                                                    <label for="horaire_mensuel" class="col-lg-5 col-md-5 col-sm-5 fw-bold col-form-label">Horaire Mensuel</label>
                                                    <div class="col-lg-7 col-md-7 col-sm-7">
        ...
        <div class="modal-footer py-1" style="background-color: #56585d; color:#ffffff;">
            <button type="submit" wire:click.prevent="store()" class="btn btn-sm btn-secondary fw-bold"><i class="fa fa-save"></i> Enregistrer</button>
