<div>
	<div wire:ignore.self class="modal fade" id="imageProfilModal" tabindex="-1" role="dialog" aria-labelledby="slidemodalLabel" aria-hidden="true">
                        ...
                        <div class="card-body">
                            <div class="m-0">
                              ...
                              <div class="text-center p-3">
                                    @if($profil)                                 
                                        <img class="w-full h-32 rounded-3" style="width: 72px;border-radius: 50%;" src="{{$profil->temporaryUrl() }}">
                                    @elseif($old_image)
                              ...
                              <input type="file" wire:model="profil" class="form-control @error('profil') is-invalid @enderror"  id="profil">
                              @error('profil')<div class="text-danger invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                        </div>
					</div>
