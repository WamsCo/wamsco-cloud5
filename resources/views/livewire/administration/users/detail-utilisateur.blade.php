<div>
                                    ...
                                    <div class="card border-0 shadow-sm">
                                        <div class="card-body border border-light-subtle rounded-3 bg-white position-relative custom-scroll pe-2" style="height: calc(100vh - 131px); overflow-y: auto;">
                                            ...
                                            <div class="d-flex gap-2 mb-1">
                                                <button href="#" wire:click.prevent="edit({{$users->id}})" data-bs-toggle="modal" data-bs-target="#imageProfilModal" title="Cliquez pour modifier image" data-toggle="tooltip" class="btn btn-sm btn-white text-danger flex-fill fw-semibold ms-auto"><i class="fas fa-camera"></i> Editer</button>
                                                <button href="#" wire:click.prevent="edit({{$users->id}})" data-bs-toggle="modal" data-bs-target="#updateUserModal" title="Cliquez pour modifier" data-toggle="tooltip" class="btn btn-sm btn-outline-secondary flex-fill fw-semibold ms-auto"><i class="fa fa-pen"></i> Modifier</button>
                                                @if($userDispo > 1)
                                                    @if($confirmer === $users->id)                                                               
                                                        <button wire:click.prevent="supprimer({{$users->id}})" class="btn btn-sm btn-outline-danger bg-danger text-white blink" style="font-size:11px;"  title="Cliquez pour confirmer la suppression" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"> Confirmer ?</i></button>
                                                    @else
                                                        <button wire:click.prevent="confirmerDelete({{$users->id}})" class="btn btn-sm btn-outline-muted" title="Cliquez pour supprimer" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"></i></button>
                                                    @endif 
                                                @endif 
                                            </div> 
                                            <button href="{{asset('utilisateurs?active=12&champ=1-1')}}" wire:navigate class="btn btn-sm btn-outline-success w-100 mb-4"><i class="fa fa-close"></i> Fermer</button>
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <div class="card-header d-flex align-items-center justify-content-between border-0 px-0">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between gap-1">                            
                                                <a href="{{asset('utilisateurs?active=12&champ=1-1')}}" wire:navigate class="btn btn-sm btn-bleu d-none d-md-block ms-auto"><i class="fa fa-chevron-left"></i> Retour liste</a>
    ...
    @include('livewire.administration.users.update_utilisateur') 
    @include('livewire.administration.users.image_profil') 
</div>