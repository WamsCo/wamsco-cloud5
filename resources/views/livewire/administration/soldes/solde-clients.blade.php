                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-12 px-0">   
                                                <div class="card shadow-sm border border-light-subtle rounded-3 bg-white px-0">
                                                    <div class="d-flex align-items-center justify-content-between gap-3 pt-2 px-2">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between gap-1">
                                                            <div>                                                     
                                                                <select wire:model.live="parSociete" class="form-control form-select bordure w-auto"> 
                                                        ...
                                                        <table class="table table-striped table-hover text-nowrap m-0"> 
                                                            ...
                                                            <tbody>
                                                                @foreach($liste_soldeClient as $liste_soldeClients) 
                                                                    <tr>  
                                                                        <td class="fw-semibold">#{{$liste_soldeClients->id}}</td>                                          
                                                                        @if($liste_soldeClients->logo != null)
                                                                            <td><a class="text-bleu" href="detail_entite?id={{$liste_soldeClients->id_enseigne}}&active=12&champ=1-3" wire:navigate><img class="img_produit" src="storage/{{$liste_soldeClients->logo}}"/></a></td>
                                                                        @else
                                                                            <td><a class="text-bleu" href="detail_entite?id={{$liste_soldeClients->id_enseigne}}&active=12&champ=1-3" wire:navigate><img class="img_produit" src="storage/default/image.png"/></a></td>
                                                                        @endif                                                                   
                                                                        <td class="fw-bold"><a class="text-bleu" href="detail_entite?id={{$liste_soldeClients->id_enseigne}}&active=12&champ=1-3" wire:navigate><i class="fa fa-university"></i> {{substr($liste_soldeClients->enseigne,0,52) > substr($liste_soldeClients->enseigne,0,51) ? substr($liste_soldeClients->enseigne,0,52).'...': $liste_soldeClients->enseigne}}</a></td>                                                                      
