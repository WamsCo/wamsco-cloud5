<div>
                                ...
                                <div class="card border-0 shadow-sm">
                                    <div class="card-body border border-light-subtle rounded-3 bg-white position-relative custom-scroll pe-2" style="height: calc(100vh - 131px); overflow-y: auto;">
                                        <div class="text-centerk">
                                            <div class="d-flex align-items-centerk">
                                                <div class="">
                                                    <div class="photoref">
                                                        @if($this->logo != null)
                                                            <td><img class="img_detail_prod" src="storage/{{$this->logo}}" wire:click.prevent="edit({{$this->id}})" data-bs-toggle="modal" data-bs-target="#entiteLogoModal"/></td>
                                                        @else
                                                            <td><img class="img_detail_prod" src="storage/default/image.png" wire:click.prevent="edit({{$this->id}})" data-bs-toggle="modal" data-bs-target="#entiteLogoModal"/></td>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="ms-2">
                                                    <h4 class="mb-0 fw-bold" title="{{$this->enseigne}}">{{Str::limit($this->enseigne.'', 52) ?? 'Inconu(e)'}}</h4>
                                                    <div class="text-success fw-bold"><span class="text-success fw-semibold">{{$this->societe_mere}}</span></div>
                                        ...
                                        <div class="d-flex gap-2 mb-3">
                                            <button wire:click.prevent="edit({{$this->id}})" data-bs-toggle="modal" data-bs-target="#entiteLogoModal" class="btn btn-sm btn-outline-danger flex-fill fw-semibold ms-auto" title="Cliquez pour modifier image" data-toggle="tooltip"><i class="fa fa-camera"></i> Editer</button>
                                            <button wire:click.prevent="edit({{$this->id}})" data-bs-toggle="modal" data-bs-target="#updateEntiteModal" class="btn btn-sm btn-outline-secondary flex-fill fw-semibold ms-auto" title="Cliquez pour voir les détails" data-toggle="tooltip"><i class="fa fa-save"></i> Modifier</button>
                                        </div>
                                        <div class="d-flex gap-2 mb-3">                                            
                                        </div>                               
                                        <h5 class="fw-bold mb-3">Créer par » {{Str::limit($this->nom_user, 52) ?? 'Inconu(e)'}}</h5>
                                            ...
                                            <div class="table-responsive"> 
                                                <table class="table table-borderless text-nowrap m-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="fw-semibold"><i class="fas fa-calendar-alt"></i> {{date('d-m-Y', strtotime($this->validite_mod))}}
                                                            @if($nbjoursRestant > 0 )
                            ...
                            <div class="col-lg-9">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2"> 
                                            ...
                                            {{-- <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    ...
                                                    <span class="d-block fw-bold text-dark mt-1" style="font-size: 14px;">{{$this->taux_commission}}%</span>
                                                </div>
                                            </div> --}}
                                            ...
                                            {{-- <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    ...
                                                    <span class="d-block fw-bold text-dark mt-1" style="font-size: 14px;">{{number_format($this->montant_commission,0,',',' ')}} <span style="font-size: 10px;">{{$this->devise}}</span></span>
                                                </div>
                                            </div> --}}
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    ...
                                                    <span class="d-block fw-bold text-dark mt-1" style="font-size: 13px;">{{ $this->nom_user }}</span>
                                                </div>
                                            </div>
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-0">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1">                            
                                            <a href="bienvenue?active=1" wire:navigate class="btn btn-sm btn-bleu d-none d-md-block ms-auto"><i class="fa fa-home"></i> Accueil</a>
                                        </div>
                                    </div>
                                </div>
                                                                        ...
                                                                        <table class="table text-nowrap m-0">                                        
                                                                            <tbody>
                                                                                <tr>                                                                     
                                                                                    ...
                                                                                    <td class="fw-semibold">{{$this->enseigne}} (<span class="text-bleu" title="Raison sociale » {{$this->enseigne}}">{{$this->raison_sociale}}</span>)</td>         
                                                                                </tr> 
                                                                                <tr>                                                                     
                                                                                    ...
                                                                                    <td class="fw-semibold">{{$this->societe_mere}}</td>         
                                                                                </tr>
                                                                                <tr>                                                                     
                                                                                    <td class="titlefield text-muted fw-semibold">Email</td>                                                         
                                                                                    <td class="fw-semibold">{{$this->email}}</td>         
                                                                                </tr>
                                                                                <tr>                                                                     
                                                                                    <td class="titlefield text-muted fw-semibold">Téléphone</td>                                                         
                                                                                    <td class="fw-semibold">{{$this->telephone}}</td>         
                                                                                </tr>
                                                                                <tr>       
                                                                                    @php
                                                                                    ...
                                                                                    <td class="fw-semibold">{{date('d-m-Y', strtotime($this->validite_mod))}}
                                                                                        @if($nbjoursRestant > 0 )
                                                                                            <span class="text-vert">({{$nbjoursRestant}} Jours)</span>
                                                                                        @else
                                                                                ...
                                                                                <tr>                                                                     
                                                                                    ...
                                                                                    <td class="fw-semibold"><span class="text-bleu" style="font-size: 11px">{{$this->nombre_users}}</span> | <span class="text-success" style="font-size: 11px">{{$this->nbre_user_max}}</span></td>         
                                                                                </tr>
                                                                                <tr>                                                                     
                                                                                    <td class="titlefield text-muted fw-semibold">Responsable société</td>                                                         
                                                                                    <td class="fw-semibold"><span class="text-bleu" style="font-size: 11px">{{$this->responsable_societe}}</span></td>         
                                                                                </tr>                                                               
                                                                            </tbody>
                                                                        </table>
                                                                    </div>
                                                                        ...
                                                                        <table class="table text-nowrap m-0">                                        
                                                                            <tbody>
                                                                                <tr>                                                                     
                                                                                    ...
                                                                                    <td class="text-primary fw-bold">{{number_format($this->solde,0,' ',' ')}} <span class="text-bleu" style="font-size: 10px">{{$devise}}</span></td>         
                                                                                </tr>
                                                                                <tr>                                                                     
                                                                                    <td class="titlefield text-muted fw-semibold">Plan : 
                                                                                        @if($this->etat_commission == "Gratuit")
                                                                                            <span class="badge bg-secondary" style="font-size: 8px;" title="Etat commission: {{$this->etat_commission}}"><i class="fa fa-box"></i> {{$this->etat_commission}}</span>
                                                                                        @elseif($this->etat_commission == "Payé")
                                                                                            <span class="badge bg-success" style="font-size: 8px;" title="Etat commission: {{$this->etat_commission}}"><i class="fa fa-check-circle"></i> {{$this->etat_commission}}</span>
                                                                                        @elseif($this->etat_commission == "Non payé")
                                                                                            <span class="badge bg-danger" style="font-size: 8px;" title="Etat commission: {{$this->etat_commission}}"><i class="fa fa-times-circle"></i> {{$this->etat_commission}}</span>
                                                                                        @endif
                                                                                    </td>                                                         
                                                                                    <td class="fw-semibold">
                                                                                        @if($this->periode == "Standard Annuel")
                                                                                            <span class="fw-bold text-vert">{{$this->periode}} / <span class="text-bleu">{{number_format($this->montant_paye,0,',',' ')}}</span> <span class="text-bleu" style="font-size:8px;"> {{$devise}}</span></span>                                           
                                                                                        @elseif($this->periode == "Standard Mensuel")
                                                                                            <span class="fw-bold text-danger">{{$this->periode}} / <span class="text-bleu">{{number_format($this->montant_paye,0,',',' ')}}</span> <span class="text-bleu" style="font-size:8px;"> {{$devise}}</span></span> 
                                                                                        @elseif($this->periode == "Independant Annuel")    
                                                                                            <span class="fw-bold text-warning">{{$this->periode}} / <span class="text-bleu">{{number_format($this->montant_paye,0,',',' ')}}</span> <span class="text-bleu" style="font-size:8px;"> {{$devise}}</span></span>                                         
                                                                                        @elseif($this->periode == "Independant Mensuel")
                                                                                            <span class="fw-bold text-cyan">{{$this->periode}} / <span class="text-bleu">{{number_format($this->montant_paye,0,',',' ')}}</span> <span class="text-bleu" style="font-size:8px;"> {{$devise}}</span></span> 
                                                                                        @elseif($this->periode == "Essai Gratuit")
                                                                                            <span class="fw-bold text-cyan">{{$this->periode}} / <span class="text-bleu">{{number_format($this->montant_paye,0,',',' ')}}</span> <span class="text-bleu" style="font-size:8px;"> {{$devise}}</span></span> 
                                                                                        @endif 
                                                                                    </td>         
                                                                                </tr>                                                                   
                                                                                <tr>                                                                     
                                                                                    ...
                                                                                    <td class="fw-semibold">{{$this->ville}} @if($this->pays)|@endif {{$this->pays}}</td>         
                                                                                </tr>
                                                                                <tr>                                                                     
                                                                                    <td class="titlefield text-muted fw-semibold">RCCM | NIU</td>                                                         
                                                                                    <td class="fw-semibold">{{$this->registre_commerce}} | {{$this->niu}}</td>         
                                                                                </tr>                                                                
                                                                                <tr>                                                                     
                                                                                    <td class="titlefield text-muted fw-semibold">Adresse</td>                                                         
                                                                                    <td class="fw-semibold">{{$this->adresse}}</td>         
                                                                                </tr>                                                                
                                                                                <tr>                                                                     
                                                                                    <td class="titlefield text-muted fw-semibold">Commercial</td>                                                         
                                                                                    <td class="fw-semibold">{{$this->recommandation}}</td>         
                                                                                </tr>
                                                                                <tr>                                                                     
                                                                                    <td class="titlefield text-muted fw-semibold">Création</td>                                                         
                                                                                    <td class="fw-semibold">{{date('d-m-Y H:i:s', strtotime($this->created_at))}}</td>         
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </div>
                                                                    ...
                                                                    <table class="table table-striped table-hover text-nowrap m-0"> 
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="fw-semibold text-center">{{$this->montant_point}} <span class="text-bleu" style="font-size: 10px">{{$devise}}</span></td>
                                                                                <td class="fw-semibold text-center">{{$this->objectif_point}}</td>
                                                                                <td class="fw-semibold text-center">{{$this->code_postal}}</td>
    ...
    @include('livewire.administration.entite.logo_entite_users') 
</div>