<div wire:ignore.self class="modal fade" id="soldeModal" tabindex="-1" role="dialog" aria-labelledby="slidemodalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-sm modal_wamsco_catg">
            <div class="modal-content">             
                <div class="modal-header" style="padding-top: 0px; padding-bottom: 0px; background-color: #56585d; color:#ffffff;">                    
                    <h5 class="py-1"><i class="fas fa-file-invoice-dollar"></i> Recharge (FCFA) {{$enseigne}}</h5>                    
                </div>
                ...
                <div class="modal-footer pt-0 pb-0 modal_peids" style="background-color: #56585d; color:#ffffff;"> 
					<button class="btn btn-sm btn-secondary fw-bold" title="Cliquez pour enregistrer" data-toggle="tooltip" wire:click.prevent="rechargeCredit()"><i class="fa fa-save"></i> Enregistrer</button>              
