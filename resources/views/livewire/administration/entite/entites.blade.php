<div x-data="{selection: @entangle('selection').defer}">
                            ...
                            <div class="col-lg-12">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2">
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">                                                
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="d-block fw-bold text-secondary" style="font-size: 11px;">Total entité</span>
                                                    <span class="d-block fw-semibold text-dark" style="font-size: 13px;">{{number_format($nbreTotalEntite,0,',',' ')}}</span>
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-1">
                                    ...
                                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">
                                        <li class="nav-item">                                                
                                            <a class="nav-link active" data-bs-toggle="tab" href="#home" title="Liste des entités"><i class="fas fa-university text-bleu"></i> {{$title_fils}} (<span class="text-vert">{{$entite_count}}</span>)</a>                                                
                                        </li>  
                                        <li class="nav-item">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-12 px-0">   
                                                <div class="card shadow-sm border border-light-subtle rounded-3 bg-white px-0">
                                                    <div class="d-flex align-items-center justify-content-between gap-3 pt-2 px-2">
                                                        <div class="d-flex align-items-center justify-content-between gap-1">
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between gap-1">
                                                                @if(auth()->user()->societe =="Administration")
                                                                    <h6><a href="{{asset('exporter-entites')}}" class="btn btn-sm btn-success mt-2 d-none d-md-block">Exporter Excel</a></h6>
                                                                @endif
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between gap-1">
                                                            <div>                                                     
                                                                <select wire:model.lazy="parSociete" class="form-control form-select bordure w-auto"> 
                                                    ...
                                                    <div class="table-responsive border-top">
                                                        <table class="table table-striped table-hover text-nowrap m-0"> 
                                                            <thead>
                                                                <tr>
                                                                    <th class="fond_entete_table">Logo</th>                                          
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('enseigne')">Enseigne <i class="fa fa-arrow-down-short-wide"></i></th>                                 
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('societe_mere')">Société mère <i class="fa fa-arrow-down-short-wide"></i></th> 
                                                                    <th class="fond_entete_table pointer text-end" wire:click="setOrderField('solde')">Solde <i class="fa fa-arrow-down-short-wide"></i></th>                                 
                                                                    <th class="fond_entete_table pointer text-center" wire:click="setOrderField('active')">Activer <i class="fa fa-arrow-down-short-wide"></i></th>                                 
                                                                    <th class="fond_entete_table ">Expiration</th>                                           
                                                                    <th class="fond_entete_table text-end">Jours</th> 
                                                                    <th class="fond_entete_table pointer text-center" wire:click="setOrderField('nombre_users')">Utilisateurs({{$utilisateurCount}}) <i class="fa fa-arrow-down-short-wide"></i></th> 
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('periode')">Plan <i class="fa fa-arrow-down-short-wide"></i></th>                                 
                                                                    <th class="fond_entete_table pointer text-end" wire:click="setOrderField('montant_paye')">Client Paie <i class="fa fa-arrow-down-short-wide"></i></th> 
                                                                    <th class="fond_entete_table pointer text-center" wire:click="setOrderField('taux_commission')">Taux <i class="fa fa-arrow-down-short-wide"></i></th> 
                                                                    <th class="fond_entete_table pointer text-end" wire:click="setOrderField('montant_commission')">Commission <i class="fa fa-arrow-down-short-wide"></i></th> 
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('etat_commission')">Etat <i class="fa fa-arrow-down-short-wide"></i></th>
                                                                    <th class="fond_entete_table pointer text-center" wire:click="setOrderField('nombre_societe')">Société (max) <i class="fa fa-arrow-down-short-wide"></i></th>                                        
                                                                    <th class="fond_entete_table ">Téléphone</th>  
                                                                    <th class="fond_entete_table ">Email société</th>   
                                                                    ...
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('recommandation')">Commercial <i class="fa fa-arrow-down-short-wide"></i></th>
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('created_at')">Création <i class="fa fa-arrow-down-short-wide"></i></th>  
                                                                    <th class="fond_entete_table pointer"><a href="#" data-bs-toggle="modal" data-bs-target="#supprimerModal"><i class="fa fa-trash text-danger"></i></a></th>
                                                                </tr>
                                                            </thead>                                       
                                                            <tbody>
                                                                @foreach($liste_entit as $liste_entits) 
                                                                    <tr>                                            
                                                                        @if($liste_entits->logo != null)
                                                                            <td><a class="text-bleu" href="detail_entite?id={{$liste_entits->id}}&active=12&champ=1-3" wire:navigate><img class="img_produit" src="storage/{{$liste_entits->logo}}"/></a></td>
                                                                        @else
                                                                            <td><a class="text-bleu" href="detail_entite?id={{$liste_entits->id}}&active=12&champ=1-3" wire:navigate><img class="img_produit" src="storage/default/image.png"/></a></td>
                                                                        @endif                                                                   
                                                                        <td class="fw-bold"><a class="text-bleu" href="detail_entite?id={{$liste_entits->id}}&active=12&champ=1-3" wire:navigate><i class="fa fa-university"></i> {{substr($liste_entits->enseigne,0,52) > substr($liste_entits->enseigne,0,51) ? substr($liste_entits->enseigne,0,52).'...': $liste_entits->enseigne}}</a></td>                                                                      
                                                                        <td class="fw-semibold">{{$liste_entits->societe_mere}}</td> 
                                                                        <td class="fw-semibold text-end">{{number_format($liste_entits->solde,0,',',' ')}}</td> 
                                                                        <td class="pointer text-center" wire:click.prevent="changeEtat({{$liste_entits->id}}, {{$liste_entits->active}})" title="Cliquez pour changer l'état">
                                                                            @if($liste_entits->active == 1)
                                                                                <span class="badge bg-success"><i class="fa fa-check-circle"></i></span>
                                                                            @else
                                                                                <span class="badge bg-danger"><i class="fa fa-times-circle"></i></span>
                                                                            @endif                                            
                                                                        </td>
                                                                        <td class="fw-semibold">{{$liste_entits->validite_mod}}</td> 
                                                                        <td class="fw-semibold text-end">
                                                                            @if($nbjoursRestant = round((strtotime($liste_entits->validite_mod) - strtotime($dateJour))/(60*60*24)) >= 15)
                                                                                <span class="text-vert fw-bold"> -{{round((strtotime($liste_entits->validite_mod) - strtotime($dateJour))/(60*60*24))}} Jours</span>
                                                                            @elseif($nbjoursRestant = round((strtotime($liste_entits->validite_mod) - strtotime($dateJour))/(60*60*24)) < 15 && $nbjoursRestant = round((strtotime($liste_entits->validite_mod) - strtotime($dateJour))/(60*60*24)) > 5)
                                                                                <span class="text-warning fw-bold"> -{{round((strtotime($liste_entits->validite_mod) - strtotime($dateJour))/(60*60*24))}} Jours</span>
                                                                            @elseif($nbjoursRestant = round((strtotime($liste_entits->validite_mod) - strtotime($dateJour))/(60*60*24)) <= 5 && $nbjoursRestant = round((strtotime($liste_entits->validite_mod) - strtotime($dateJour))/(60*60*24)) >= 0)
                                                                                @if(round((strtotime($liste_entits->validite_mod) - strtotime($dateJour))/(60*60*24)) == 0)
                                                                                    <span class="blink text-orange fw-bold">Dernier Jour</span>
                                                                                @else                                                        
                                                                                    <span class="blink text-red fw-bold"> -{{round((strtotime($liste_entits->validite_mod) - strtotime($dateJour))/(60*60*24))}} Jours</span>
                                                                                @endif   
                                                                            @else
                                                                                <span class="text-red fw-bold">Expirer</span>
                                                                            @endif 
                                                                        </td> 
                                                                        <td class="fw-semibold text-center">{{$liste_entits->nombre_users}} / {{$liste_entits->nbre_user_max}} <i class="fa fa-users"></i></td>
                                                                        <td class="">
                                                                            @if($liste_entits->periode == "Standard Annuel")
                                                                                <span class="fw-bold text-vert">{{$liste_entits->periode}}</span>                                           
                                                                            @elseif($liste_entits->periode == "Standard Mensuel")
                                                                                <span class="fw-bold text-danger">{{$liste_entits->periode}}</span>                                           
                                                                            @elseif($liste_entits->periode == "Independant Annuel")                                            
                                                                                <span class="fw-bold text-warning">{{$liste_entits->periode}}</span>                                           
                                                                            @else
                                                                                <span class="fw-bold text-cyan">{{$liste_entits->periode}}</span>
                                                                            @endif                                            
                                                                        </td> 
                                                                        {{-- <td class="fw-bold text-end">{{number_format($liste_entits->montant_paye,0,',',' ')}}</td> --}}
                                                                        <td class="fw-bold text-end">{{number_format($liste_entits->montant_paye,0,',',' ')}} <span class="text-bleu" style="font-size: 8px;">{{$devise}}</span></td> 
                                                                        <td class="fw-semibold text-center">{{$liste_entits->taux_commission}}%</td>
                                                                        <td class="fw-bold text-end">{{number_format($liste_entits->montant_commission,0,',',' ')}} <span class="text-bleu" style="font-size: 8px;">{{$devise}}</span></td>
                                                                        <td class="text-start">
                                                                            @if($liste_entits->etat_commission == "Gratuit")
                                                                                <span class="badge bg-secondary" title="Etat commission: {{$liste_entits->etat_commission}}"><i class="fa fa-box"></i> {{$liste_entits->etat_commission}}</span>
                                                                            @elseif($liste_entits->etat_commission == "Payé")
                                                                                <span class="badge bg-success" title="Etat commission: {{$liste_entits->etat_commission}}"><i class="fa fa-check-circle"></i> {{$liste_entits->etat_commission}}</span>
                                                                            @elseif($liste_entits->etat_commission == "Non payé")
                                                                                <span class="badge bg-danger" title="Etat commission: {{$liste_entits->etat_commission}}"><i class="fa fa-times-circle"></i> {{$liste_entits->etat_commission}}</span>
                                                                            @endif                                                  
                                                                        </td>
                                                                        <td class="fw-semibold text-center">{{$liste_entits->nombre_societe}}</td> 
                                                                        <td class="">{{$liste_entits->telephone}}</td>
                                                                        <td class="gras">{{$liste_entits->email}}</td> 
                                                                        <td class="fw-semibold">{{$liste_entits->ville}}</td> 
                                                                        <td class="fw-semibold">{{$liste_entits->pays}}</td>
                                                                        <td class="fw-semibold text-bleu">{{$liste_entits->recommandation}}</td> 
                                                                        <td class="">{{date('d-m-Y H:i:s',strtotime($liste_entits->created_at))}}</td>
                                                                        <td class=""><a href="detail_entite?id={{$liste_entits->id}}&active=12&champ=1-3" wire:navigate><i class="fa fa-eye btn-outline-muted" title="Cliquez pour modifier" data-toggle="tooltip"></i></a></td>
                                                                    </tr>                                        
                                                                @endforeach 
                                                            </tbody>
                                                        </table>
                                                        <div class="bloc_pagination">{{$liste_entit->links()}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    @include('livewire.administration.entite.create_module')  
    @include('livewire.administration.entite.supprimer')  
</div>
