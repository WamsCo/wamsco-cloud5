<div wire:ignore.self class="modal fade" id="ReglementCommercialModal" tabindex="-1" data-bs-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
        <div class="modal-header py-2" style="background-color: #56585d; color:#ffffff;">
            <h5 class="modal-title" id="exampleModalCenteredScrollableTitle"><i class="far fa-file" style=""></i> Saisie d'un règlement commercial <span class="text-bleu"></span> </h5>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label for="nom_opportunite" class="col-md-12 col-sm-8 py-0 fw-semibold col-form-label">Commercial » <span class="text-danger">{{Str::limit($this->nom_user, 52)}}</span></label>
                            <div class="row mb-1">
                                <div class="col-lg-10 col-md-10 col-sm-10">
                                    <span class="form-control bordure fs-3 text-bleu w-100 px-0"><i class="fa fa-user-circle"></i> {{$this->recommandation}}</span>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">                                                                                   
                            <div class="row mb-1">
                                <label for="raison_sociale" class="col-lg-4 col-md-5 col-sm-3 fw-bold col-form-label">Société</label>
                                <div class="col-lg-8 col-md-7 col-sm-9">
                                    <span class="form-control sans_bordure fw-bold fs-6 text-vert">{{$this->enseigne}}</span>
                                </div>
                                <div class="d-flex justify-content-start">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="row mb-1">
                                <label for="raison_sociale" class="col-lg-4 col-md-5 col-sm-3 fw-bold col-form-label">Création</label>
                                <div class="col-lg-8 col-md-7 col-sm-9">
                                    <span class="form-control sans_bordure fw-bold fs-6 text-bleu">{{date('d-m-Y H:i:s', strtotime($this->date_created_at))}}</span>
                                </div>
                                <div class="d-flex justify-content-start">
                                    @error('raison_sociale') <span class="text-danger">{{ $message }}</span> @enderror 
                                </div>
                            ...
                            <div class="row mb-1">
                                <label for="raison_sociale" class="col-lg-5 col-md-5 col-sm-3 fw-bold col-form-label">Validité module(s)</label>
                                <div class="col-lg-7 col-md-7 col-sm-9">
                                    {{-- @php
                                        $nbjoursRestant = round((strtotime($entits->validite_mod) - strtotime($dateJour))/(60*60*24));
                                    @endphp --}}
                                    <span class="form-control sans_bordure fw-bold fs-6 text-bleu">{{date('d-m-Y', strtotime($this->validite_mod))}}
                                        @if($nbjoursRestant > 0 )
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-12">                                            
                                    <form>
                                        ...
                                        <div class="row mb-1">
                                            <label for="nom_produit" class="col-lg-5 col-md-5 col-sm-4 fw-bold col-form-label">Compte à débiter</label>
                                            <div class="col-lg-7 col-md-7 col-sm-8">                                                        
                                                <select id="compte_bancaire" wire:model.defer="compte_bancaire" class="form-control form-select bordure w-100 @error('compte_bancaire') is-invalid @enderror">
                                                    <option value=""></option>
                                ...
                                <div class="col-sm-6 col-12">                                            
                                    <form>
                                        <div class="row mt-2 mb-1">
                                            <label for="quantite" class="col-sm-5 col-form-label">Montant TTC ({{$this->taux_commission}}%)</label>                                            
                                            <div class="col-sm-7">
                                                <span class="form-control sans_bordure fw-bold fs-6 text-danger">{{number_format($this->montant_commission,0,',',' ')}} <span class="text-bleu" style="font-size: 09px">{{$this->devise}}</span></span>
                                            </div>
                                            <div class="d-flex justify-content-start">
        ...
        <div class="modal-footer py-1" style="background-color: #56585d; color:#ffffff;">
            <button type="submit" wire:click.prevent="payer()" class="btn btn-sm btn-secondary fw-bold"><i class="fa fa-save"></i> Enregistrer</button>
