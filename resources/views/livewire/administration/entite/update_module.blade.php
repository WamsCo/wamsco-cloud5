...
<div wire:ignore.self class="modal fade" id="selectModuleModal" tabindex="-1" data-bs-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
    <form enctype="multipart/form-data"> 
        @csrf   
        <div class="modal-dialog modal-md modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">             
                <div class="modal-header py-1" style="background-color: #56585d; color:#ffffff;">                    
                    <h5 class="pt-2"><i class="fas fa-university"></i> Modif. Module Société</h5>
                            ...
                            <div class="nom_desig">
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bordure" style="background: #ffffff;"><i class="fas fa-university"></i> <span class="hidden-xs sombre">&nbsp;enseigne »</span></span>
                                    </div>
                                    <input type="text" wire:model.defer="enseigne" placeholder="Ex: wamsco-sas" readonly style="background: #ffffff; color:#ff1012;" class="form-control bordure @error('enseigne') is-invalid @enderror"/>
                ...
                <div class="modal-footer py-1" style="background-color: #56585d; color:#ffffff;">                    
                    <button class="btn btn-sm btn-secondary fw-bold" wire:click.prevent="updateModule()" title="Cliquez pour enregistrer" data-toggle="tooltip"><i class="fa fa-save"></i> Enregistrer</button>
