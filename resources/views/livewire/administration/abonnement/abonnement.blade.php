                                            ...
                                            <div class="col-sm-12">
                                                <div class="cardk mb-4">
                                                    {{-- <div class="card-header d-flex align-items-center justify-content-between border-bottom">
                                                        <h5 class="card-title text-bleu"><i class="fa fa-cog fa-spin text-danger" aria-hidden="true"></i> Prolongez votre abonnement (<span class="text-secondary">{{$this->plan}} » {{$this->abonnement}}</span>)</h5>
                                                        <a href="choix_plan" class="btn btn-secondary d-none d-md-block ms-auto py-1"><i class="fa fa-chevron-left"></i> Retour</a>
                                                    </div> --}}
                                                    <div class="card-body">
                                                        <div class="container-fluid pt-0 px-0">
                                                            <div class="row">
                                                                <div class="col-md-12 col-sm-12 px-0">
                                                                    <div class="table-responsive mt-1"> 
                                                                        <table class="table table-borderedk">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th class="fw-bold" style="font-size:13px">Désignation (<span class="text-secondary">{{$this->plan}} » {{$this->abonnement}}</span>)</th>
                                                                                    <th class="fw-bold" style="font-size:13px">Prix Unitaire</th>
                                                                                    <th class="fw-bold" style="font-size:13px;width: 120px;">Quantité</th>
                                                                                    <th class="fw-bold text-end" style="font-size:13px">Total HT</th>
                                                                                </tr>
                                                                            </thead>
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="fw-semibold" style="font-size:13px">{{$designation}} x <span class="text-danger">{{$quantite}}</span> <span class="text-bleu fw-bold">{{$abonnement}}</span></td>
                                                                                    <td class="text-start fw-semibold" style="font-size:13px">{{number_format($prix,0,' ',' ')}} FCFA</td>
                                                                                    <td style="font-size:13px"><input type="number" wire:model.live='quantite' class="form-control" min="1" style="width: 120px; font-size:13px;">
                                                                                        @error('quantite') <span class="text-danger">{{ $message }}</span> @enderror
                                                                                    </td>
                                                                                    <td class="text-end fw-bold" style="font-size:13px">{{number_format($prixTotalAbon,0,' ',' ')}}&nbsp;FCFA</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="fw-semibold" style="font-size:13px">Utilisateurs</td>
                                                                                    <td class="text-start fw-semibold" style="font-size:13px">{{number_format($prix_user,0,' ',' ')}} FCFA</td>
                                                                                    <td class="text-end"><input type="number" wire:model.live='quantite_saisie' class="form-control" @if($this->plan == 'Standard') min="3" @else min="1" @endif style="width: 120px;font-size:13px;">
                                                                                        @error('quantite_saisie') <span class="text-danger">{{ $message }}</span> @enderror
                                                                                    </td>
                                                                                    <td class="text-end fw-bold" style="font-size:13px">{{number_format($prixTotalUser,0,' ',' ')}}&nbsp;FCFA</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="fw-semibold" style="font-size:13px">Société / Entreprise (-15%)</td>
                                                                                    <td class="text-start fw-semibold" style="font-size:13px">{{number_format($prix_societe,0,' ',' ')}} FCFA</td>
                                                                                    <td class="text-end"><input type="number" wire:model.live='quantite_societe' class="form-control" min="1" style="width: 120px;font-size:13px;">
                                                                                        @error('quantite_societe') <span class="text-danger">{{ $message }}</span> @enderror
                                                                                    </td>
                                                                                    <td class="text-end fw-bold" style="font-size:13px">{{number_format($prixTotalSociete,0,' ',' ')}}&nbsp;FCFA</td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>                  
                                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4 ml-auto">
                                                                    <table class="table table-borderedk">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="fw-semibold" style="font-size:13px">Total HT</td>
                                                                                <td class="text-end fw-bold" style="font-size:13px">{{number_format($solde,0,' ',' ')}}&nbsp;FCFA</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="fw-semibold" style="font-size:13px">TVA</td>
                                                                                <td class="text-end fw-semibold" style="font-size:13px">0&nbsp;FCFA</td>
                                                                            </tr>
                                                                            <tr class="bold">
                                                                                <td class="fw-semibold" style="font-size:13px">Net à payer</td>
                                                                                <td class="text-end text-vert fw-bold" style="font-size:13px">{{number_format($solde,0,' ',' ')}}&nbsp;FCFA</td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                                            ...
                                                            <div class="pb-4" style="display: flex ">
                                                                <div class="ml-auto">
                                                                    @if($approuver === 3)                                                               
                                                                        <button wire:click.prevent='confirmerAbonnement("{{$plan}}","{{$abonnement}}")' class="btn btn-outline-green fw-semibold ms-auto blink"  title="Cliquez pour confirmer la validation" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-check"> Confirmer ?</i></button>
                                                                    @else
                                                                        <button wire:click.prevent="validePaie(3)" class="btn btn-outline-green fw-semibold ms-auto"  title="Cliquez pour valider" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-check"></i> Confirmer l'abonnement</button>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                        </div> 
                                                    </div>
                                                    <div class="block-pricing px-3">
                                                        <div style="font-size: 14px; font-weight:600;margin-top:15px;" class="blockTextTwo">
                                                            <div class="text-center">Nous sommes disponible pour une assistance 24h/24 et 7j/7 via 
                                                                <a href="https://api.whatsapp.com/send?phone=+237654258009&text=Bonjour WamsCo, nous souhaiterons avoir une assistance sur le paiement de votre application. Merci." target="_blank" title="cliquez pour envoyer un message whatsapp" rel="noopener"><i class="fab fa-whatsapp blink" style="color:green;font-weight:bold;"></i> <span class="text-bleu">+237 654 25 80 09</span> <i class="fa fa-phone"></i></a>
