<div wire:ignore.self class="modal fade" id="createTransfertFilialeModal" tabindex="-1" data-bs-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header py-2" style="background-color: #56585d; color:#ffffff;">
                <h5 class="modal-title" id="exampleModalCenteredScrollableTitle"><i class="fa fa-plus-circle"></i> Nouveau {{$title_fils}}<span class="text-vert"></span> </h5>
                            ...
                            <div class="hauteur_ecran">
                                <div class="row pt-3 mb-2 px-0">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">                                        
                                        <div class="row mb-1">
                                            <label for="entrepot_origine" class="col-sm-4 fw-bold col-form-label">Entrepôt origine</label>
                                            <div class="col-sm-8">                                                        
                                        ...
                                        <div class="row mb-1">
                                            <label for="filiale" class="col-sm-4 fw-bold text-bleu col-form-label">Filiale destination</label>
                                            <div class="col-sm-8">                                                        
                                                <select id="filiale" wire:model.live="filiale" class="form-control form-select bordure w-auto @error('filiale') is-invalid @enderror">
                                                    <option value=""></option>	
                                            ...
                                            <div class="d-flex justify-content-start">
                                                @error('filiale') <span class="text-danger">{{ $message }}</span> @enderror 
                                            </div>
                                        </div>
                                        <div class="row mb-1">
                                            <label for="entrepot_destination" class="col-sm-5 fw-bold col-form-label">Entrepôt destination</label>
                                            <div class="col-sm-7">                                                        
                                        ...
                                        <div class="row mb-1">
                                            <label for="date_sortie" class="col-sm-4 fw-bold col-form-label">Date de sortie</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="row mb-1">
                                            <label for="date_entree" class="col-sm-4 fw-bold col-form-label">Date d'entrée</label>
                                            <div class="col-sm-8">
