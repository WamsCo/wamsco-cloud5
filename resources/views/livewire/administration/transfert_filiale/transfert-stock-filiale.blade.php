<div x-data="{selection: @entangle('selection').defer}">
                            ...
                            <div class="col-lg-12">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2">
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">                                                
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="d-block fw-bold text-secondary" style="font-size: 11px;">Total transfert filiale</span>
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-1">
                                    ...
                                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">
                                        <li class="nav-item">                                                
                                            <a class="nav-link active" data-bs-toggle="tab" href="#home" title="Liste des tieres : Prospects, Clients, Fournisseurs"><i class="fas fa-users text-bleu"></i> {{$title_fils}} (<span class="text-vert">{{$transfertCount}}</span>)</a>                                                
                                        </li>  
                                        <li class="nav-item">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1">                            
                                            <button href="#" data-bs-toggle="modal" data-bs-target="#createTransfertFilialeModal" title="Cliquez pour ajouter un nouveau tier" data-toggle="tooltip" class="btn btn-sm btn-danger ms-auto"><i class="fa fa-plus-circle"></i> Nouveau transfert</button>
                                                        ...
                                                        <table class="table table-striped table-hover text-nowrap m-0"> 
                                                            ...
                                                            <tbody>
                                                                @foreach($transfert as $transferts) 
                                                                    <tr>  
                                                                        <td class="text-start"><a href="detail_transfert_filiale?id={{$transferts->id}}&active=11&champ=1-3" class="text-bleu fw-bold" wire:navigate><i class="fa fa-dolly"></i> #{{$transferts->id}}</a></td>                                             
                                                                        <td class="text-start"><a href="detail_transfert_filiale?id={{$transferts->id}}&active=11&champ=1-3" class="fw-semibold" wire:navigate><i class="fa fa-calendar-alt"></i> {{date('d-m-Y H:i:s', strtotime($transferts->created_at))}}</a></td>
                                                                        <td class="text-start">{{$transferts->etiquette_transfert}}</td> 
                                                                        <td class="text-start"><a href="detail_entrepot?id={{$transferts->id_entrepot_origine}}" class="text-bleu fw-semibold" wire:navigate><i class="fa fa-box-open  text-danger"></i> {{$transferts->entrepot_origine}} ({{$transferts->filiale_envoi}})</a></td>                                             
                                                                        <td class="text-start"><a href="detail_entrepot?id={{$transferts->id_entrepot_destination}}" class="text-bleu fw-semibold" wire:navigate><i class="fa fa-box-open  text-danger"></i> {{$transferts->entrepot_destination}} ({{$transferts->filiale_reception}})</a></td> 
                                                                        ...
                                                                        <td class=""><a href="detail_transfert_filiale?id={{$transferts->id}}&active=11&champ=1-3" wire:navigate><i class="fa fa-eye btn-outline-muted" title="Cliquez pour modifier" data-toggle="tooltip"></i></a></td>
                                                                        <td class="taille_icon">
                                                                            ...
                                                                            @else
                                                                                <a wire:click.prevent="confirmerDelete({{$transferts->id}})" class="btn-outline-muted btn-xs pointer"  title="Cliquez pour supprimer" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"></i></a>
                                                                            @endif
                                                                        </td> 
                                                                    </tr>
                                                                @endforeach
    ...
    {{-- Modal --}}
    @include('livewire.administration.transfert_filiale.nouveau-transfert-filiale')     
</div>
