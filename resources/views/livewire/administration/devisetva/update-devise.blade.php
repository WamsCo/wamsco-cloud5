<div wire:ignore.self class="modal fade" id="updateDeviseTvaModal" tabindex="-1" data-bs-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
	<div class="modal-dialog modal_wamsco_catg">
		<div class="modal-content new_color">
			<div class="">
				...
				<h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-file"></i> Modifier dévise » <span class="text-danger fs-5 blink">{{$devise}}</span></h5>
						...
						<div class="card-body border">					
							<div class="row">
								<div class="col-md-12 col-sm-12 col-xs-12">								
									<div class="nom_desig">
										<div class="row mb-1">
											<label for="pays" class="col-sm-3 fw-bold col-form-label">Pays</label>
											<div class="col-sm-9">                                                        
										...
										<div class="row mb-1">
											<label for="devise" class="col-sm-3 col-form-label">Dévise</label>
											<div class="col-sm-9">                                                        
												<select id="devise" wire:model.live="devise" class="form-control form-select bordure w-75 @error('devise') is-invalid @enderror">
										...
										<div class="row mb-1">
											<label for="taxe" class="col-sm-3 fw-bold col-form-label">Taxe</label>
											<div class="col-sm-9">                                                        
												<select id="taxe" wire:model="taxe" class="form-control form-select bordure w-75 @error('taxe') is-invalid @enderror">
													<option value=""></option>
											...
											<div class="d-flex justify-content-start">
												@error('taxe') <span class="text-danger">{{ $message }}</span> @enderror 
											</div>
										</div>
										<div class="row mb-1">
                                            <label for="taux_tva" class="col-sm-3 col-form-label fw-bold">Taux en %</label>
                                            <div class="col-sm-9">
                                                <input type="text" wire:model="taux_tva" placeholder="Ex: 19.25" class="form-control bordure w-50 @error('taux_tva') is-invalid @enderror" id="nom_categorie">
                                            </div>
                                            <div class="d-flex justify-content-start">
                                                @error('taux_tva') <span class="text-danger">{{ $message }}</span> @enderror 
                                            </div>
                                        </div>					                               
									</div>									
								</div>												    
