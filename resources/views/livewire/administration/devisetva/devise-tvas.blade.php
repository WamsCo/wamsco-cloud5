<div>
                            ...
                            <div class="col-lg-12">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2">
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="d-block fw-bold text-secondary" style="font-size: 11px;">Nombre Total Devise-Tva</span>
                                                    <span class="d-block fw-semibold text-dark" style="font-size: 13px;">{{$nbreTotalDeviseTva}}</span>
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-1">
                                    ...
                                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">
                                        <li class="nav-item">                                                
                                            <a class="nav-link active" data-bs-toggle="tab" href="#home" title="Liste des roles"><i class="fas fa-chart-pie text-bleu"></i> {{$title_fils}} (<span class="text-vert">{{$deviseTvacount}}</span>)</a>                                                
                                        </li>  
                                        <li class="nav-item">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1">                            
                                            <a href="#" class="btn btn-sm btn-danger ms-auto" title=" Cliquez pour ajouter" data-bs-toggle="modal" data-bs-target="#ajoutDeviseTvaModal"><i class="fa fa-plus-circle"></i> Nouvelle dévise</a>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="table-responsive border-top">
                                                        <div class="hauteur_ecran">
                                                            <div class="row pt-2 px-2">
                                                                @foreach($deviseTva as $deviseTvas)		
                                                                    <div class="col-lg-3 col-md-4 col-xs-12 mb-2 pointer" wire:click.prevent="edit('{{$deviseTvas->id}}')" data-bs-toggle="modal" data-bs-target="#updateDeviseTvaModal" title="Cliquez pour voir les détails" data-toggle="tooltip">                            
                                                                        <div class="row rounded border list_achat">                                        
                                                                            <div class="col-lg-10 col-md-10 col-xs-8 mt-2 mb-2"> 
                                                                                <strong class="title_color truncate_ok"><i class="fa fa-file"></i> {{substr($deviseTvas->pays,0,20)}} » <span style="color:#28a741">{{$deviseTvas->devise}}</span> | <span style="color:#4649c3">{{substr($deviseTvas->taxe,0,15)}}</span></strong></strong>
                                                                            </div>                                        
                                                                            <div class="col-lg-2 col-md-2 col-xs-4 mt-2 mb-2">                                                
                                                                                <span class="description_cat fw-bold">{{$deviseTvas->taux_tva}}%</span>                        
                                                                            </div>
                                                                            <div class="col-lg-8 col-md-8 col-xs-8 mb-2"> 
                                                                                <span class="date_achat">{{date('d-m-Y H:i:s', strtotime($deviseTvas->updated_at))}} <i class="fa fa-calendar light"></i></span>
                                                                            </div>
                                                                            <div class="col-lg-4 col-md-4 col-xs-4 mb-2">
                                                                                <span class="entite_cat truncate_ok">{{substr($deviseTvas->nom_user,0,12)}}</span>
                                                                            </div>                                        
                                                                        </div>                                                                
                                                                    </div> 
                                                                @endforeach
                                                        ...
                                                        <div class="bloc_pagination">{{$deviseTva->links()}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    {{-- Modal --}}
    @include('livewire.administration.devisetva.create-devise')
    @include('livewire.administration.devisetva.update-devise') 
</div>
