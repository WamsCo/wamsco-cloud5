<div wire:ignore.self class="modal fade" id="ajoutPosteModal" tabindex="-1" data-bs-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content new_color">
			<div class="">
				...
				<h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-chart-pie"></i> Nouveau poste</h5>
						...
						<div class="card-body border">					
							<div class="row">
								<div class="col-md-12 col-sm-12 col-xs-12">								
									<div class="nom_desig">
										<div class="row mb-1">
                                            <label for="nom_poste" class="col-sm-4 col-form-label fw-bold">Nom poste</label>
                                            <div class="col-sm-8">
                                                <input type="text" wire:model="nom_poste" placeholder="Ex: Comptable" class="form-control bordure @error('nom_poste') is-invalid @enderror" id="nom_poste">
                                            </div>
