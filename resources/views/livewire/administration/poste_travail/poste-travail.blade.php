<div>
    <div id="content" class="app-content">
            ...
            <div class="profile-header">        
                ...
                <div class="profile-header-content">
                    <div class="profile-header-info">
                        ...
                        {{-- <h1 class="page-header mb-1">{{$title_fils}} » <span style="color:yellow">{{$poste_travailCount}}</span></h1>   --}}
                    </div> 
                </div> 
            </div>
        </div>
                            ...
                            <div class="col-lg-12">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2">
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="d-block fw-bold text-secondary" style="font-size: 11px;">Nombre Total Poste Travail</span>
                                                    <span class="d-block fw-semibold text-dark" style="font-size: 13px;">{{$nbreTotalPosteTravail}}</span>
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-1">
                                    ...
                                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">
                                        <li class="nav-item">                                                
                                            <a class="nav-link active" data-bs-toggle="tab" href="#home" title="Liste des roles"><i class="fas fa-chart-pie text-bleu"></i> {{$title_fils}} (<span class="text-vert">{{$poste_travailCount}}</span>)</a>                                                
                                        </li>  
                                        <li class="nav-item">
                                                    ...
                                                    <div class="table-responsive border-top">
                                                        <div class="hauteur_ecran">
                                                            <div class="row pt-2 px-2">
                                                                @foreach($poste_travail as $poste_travails)	
                                                                    <div class="col-lg-3 col-md-4 col-xs-12 mb-2 pointer" wire:click.prevent="edit('{{$poste_travails->id}}')" data-bs-toggle="modal" data-bs-target="#updatePosteModal" title="Cliquez pour voir les détails" data-toggle="tooltip">                            
                                                                        <div class="row rounded border list_achat">                                        
                                                                            <div class="col-md-8 col-sm-8 col-xs-8 mt-2 mb-2"> 
                                                                                <strong class="text-bleu title_color truncate_ok"><i class="fa fa-chart-pie"></i> {{substr($poste_travails->nom_poste,0,22) > substr($poste_travails->nom_poste,0,21) ? substr($poste_travails->nom_poste,0,22).'...': $poste_travails->nom_poste}}</strong>
                                                                            </div>                                        
                                                                            <div class="col-md-4 col-sm-4 col-xs-4 mt-2 mb-2">                                                
                                                                                <span class="description_cat">{{substr($poste_travails->description,0,22) > substr($poste_travails->description,0,21) ? substr($poste_travails->description,0,22).'...': $poste_travails->description}}</span>                        
                                                                            </div>
                                                                            <div class="col-md-8 col-sm-8 col-xs-8 mb-2"> 
                                                                                <span class="date_achat">{{date('d-m-Y H:i:s', strtotime($poste_travails->updated_at))}} <i class="fa fa-calendar light"></i></span>
                                                                            </div>
                                                                            <div class="col-md-4 col-sm-4 col-xs-4 mb-2">
                                                                                <span class="entite_cat truncate_ok">{{substr($poste_travails->nom_user,0,12)}}</span>
                                                                            </div>                                        
                                                                        </div>                                                                
                                                                    </div> 
                                                                @endforeach
                                                        ...
                                                        <div class="bloc_pagination">{{$poste_travail->links()}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        {{-- Modal --}}
        @include('livewire.administration.poste_travail.create')
        @include('livewire.administration.poste_travail.update')
    </div>
</div>
