<div wire:ignore.self class="modal fade" id="updatePosteModal" tabindex="-1" data-bs-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content new_color">
			<div class="">
				...
				<h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-chart-pie"></i> Modifier poste » <span class="noir_fonce text-vert">{{$nom_poste}}</span></h5>
						...
						<div class="card-body body_titre">					
							<div class="row">
								<div class="col-md-12 col-sm-12 col-xs-12">								
									<div class="nom_desig">
                                        <div class="row mb-1">
                                            <label for="nom_poste" class="col-sm-3 col-form-label fw-bold">Nom poste</label>
                                            <div class="col-sm-9">
                                                <input type="text" wire:model="nom_poste" placeholder="Ex: Fruit" class="form-control bordure @error('nom_poste') is-invalid @enderror" id="nom_poste">
                                            </div>
                                            <div class="d-flex justify-content-start">
                                                @error('nom_poste') <span class="text-danger">{{ $message }}</span> @enderror 
                                            </div>
                                        </div>
                                        <div class="row mb-1">
