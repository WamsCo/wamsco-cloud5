                            ...
                            <div class="card border-0 shadow-sm">
                                <div class="card-body border border-light-subtle rounded-3 bg-white position-relative custom-scroll pe-2" style="height: calc(100vh - 131px); overflow-y: auto;">
                                    ...
                                    <div class="d-flex gap-2 mb-1">
                                        ...
                                        <button wire:click.prevent="update({{$this->ids}})" title="Cliquez pour enregistrer" data-toggle="tooltip" class="btn btn-sm btn-outline-secondary flex-fill fw-semibold ms-auto"><i class="fa fa-save"></i> Modifier</button>
                                                    ...
                                                    <div class="col-sm-12 col-12">                                            
                                                        <div class="row mb-2">
                                                            ...
                                                            <div class="col-md-12 col-sm-12">
                                                                <input type="text" wire:model="nom" readonly placeholder="Rôle » Ex: Comptable" style="background: #fbfbfb;" class="form-control bordure @error('nom') is-invalid @enderror" id="nom">
                                                            </div>
                                                        ...
                                                        <div class="row mb-2">
                                                            ...
                                                            <div class="col-sm-12">                                                        
                                                                <select id="societe" wire:model="societe" class="form-control form-select bordure w-100 @error('societe') is-invalid @enderror">
                                                                    {{-- <option value=""></option>    --}}
                                                                    <option value="{{$this->societe}}">{{$this->societe}}</option> 
                                                                </select> 
                                                            </div>                                                            
                                                            <div class="d-flex justify-content-start">
                                                                                ...
                                                                                <div class="bloc_role rounded mr-1">
                                                                                    ...
                                                                                    <div class="roles responsives">
                                                                                        <div class="bloc_partiel_role">
                                                                                            ...
                                                                                            <div class="titre_role">Transfert stock filiale</div>
                                                                                            <hr class="trait">
                                                                                            <div class="bloc_partiel_role">
                                                                                                <div class="form-check form-switch mb-3">
