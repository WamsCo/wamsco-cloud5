        ...
        <div class="profile-header">        
            ...
            <div class="profile-header-content">
                <div class="profile-header-info">
                    ...
                    {{-- <h1 class="page-header mb-1">{{$title_fils}} » <span style="color:yellow">{{$liste_privillegecount}}</span></h1>   --}}
                </div> 
            </div> 
        </div>
    </div>
                        ...
                        <div class="col-lg-12">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2">
                                        ...
                                        <div class="d-flex align-items-center px-3 border-end flex-fill">
                                            ...
                                            <div class="text-nowrap">
                                                <span class="d-block fw-bold text-secondary" style="font-size: 11px;">Nombre Total role</span>
                                                <span class="d-block fw-semibold text-dark" style="font-size: 13px;">{{$nbreTotalRole}}</span>
                                        ...
                                        <div class="d-flex align-items-center px-3 border-end flex-fill">
                                            ...
                                            <div class="text-nowrap">
                                                <span class="fw-bold text-secondary" style="font-size: 11px;"> </span>
                            ...
                            <div class="card-header d-flex align-items-center justify-content-between border-0 px-1">
                                ...
                                <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">
                                    <li class="nav-item">                                                
                                        <a class="nav-link active" data-bs-toggle="tab" href="#home" title="Liste des roles"><i class="fas fa-chart-pie text-bleu"></i> {{$title_fils}} (<span class="text-vert">{{$roleCount}}</span>)</a>                                                
                                    </li>  
                                    <li class="nav-item">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-1">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-1">                            
                                        <a href="nouveau_role?active=12&champ=1-2" wire:navigate class="btn btn-sm btn-danger ms-auto" title=" Cliquez pour ajouter"><i class="fa fa-plus-circle"></i> Nouveau rôle</a>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="table-responsive border-top">
                                                    <div class="hauteur_ecran">
                                                        <div class="row pt-2 px-2">
                                                            @foreach($liste_privillege as $liste_privilleges)	
                                                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mb-2 pointer" title="Cliquez pour voir les détails" data-toggle="tooltip"> 
                                                                    <a class="text-bleu" href="detail_role?id={{$liste_privilleges->id}}&active=12&champ=1-2" wire:navigate>                           
                                                                        <div class="row rounded border list_achat">                                        
                                                                            <div class="col-md-8 col-sm-8 col-xs-8 mt-2 mb-2"> 
                                                                                <strong class="text-bleu title_color truncate_ok"><i class="fa fa-chart-pie"></i> {{substr($liste_privilleges->nom,0,22) > substr($liste_privilleges->nom,0,21) ? substr($liste_privilleges->nom,0,22).'...': $liste_privilleges->nom}}</strong>
                                                                            </div>                                        
                                                                            <div class="col-md-4 col-sm-4 col-xs-4 mt-2 mb-2">                                                
                                                                                <span class="description_cat"><i class="fas fa-user-circle light"></i> {{substr($liste_privilleges->nom_user,0,22) > substr($liste_privilleges->nom_user,0,21) ? substr($liste_privilleges->nom_user,0,22).'...': $liste_privilleges->nom_user}}</span>                        
                                                                            </div>
                                                                            <div class="col-md-8 col-sm-8 col-xs-8 mb-2"> 
                                                                                <span class="date_achat">{{date('d/m/Y H:i:s', strtotime($liste_privilleges->updated_at))}} <i class="fas fa-calendar-alt light"></i></span>
                                                                            </div>
                                                                            <div class="col-md-4 col-sm-4 col-xs-4 mb-2">
                                                                                <span class="entite_cat truncate_ok">{{substr($liste_privilleges->societe,0,50)}}</span>
                                                                            </div>                                        
                                                                        </div>
                                                                    </a>                                                                
                                                                </div> 
                                                    ...
                                                    <div class="bloc_pagination">{{$liste_privillege->links()}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
