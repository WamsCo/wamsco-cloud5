                                        ...
                                        <div class="w_kanban_renderer w_renderer d-flexk user-select-none w_kanban_grouped align-content-stretch">
                                               ...
                                               {{-- fin style --}}
                                                @php
                                                    ...
                                                    // $colors = [
                                                    //     14 => '#e3f2fd', // bleu clair
                                                    //     15 => '#fff3cd', // jaune clair
                                                    //     16 => '#ffe5d1', // orange clair
                                                    //     17 => '#e9f7ef', // vert clair
                                                    //     18 => '#e9f7ef', // vert clair
                                                    //     19 => '#e9f7ef', // vert clair
                                                    //     20 => '#e9f7ef', // vert clair
                                                    // ];
                                                @endphp
                                               {{-- code --}}
                                                <div class="row g-3">
                                                    @foreach ($etapes as $etape)
                                                        <div class="col-md-12 col-lg-4">
                                                            <div class="border rounded p-3 shadow-sm"
                                                                {{-- style="background-color: {{ $colors[$etape->id] }}"> --}}
                                                                style="background-color: #e3f2fd">
                                                                <h5 class="fw-bold mb-3">Étape {{ $etape->nom_etape }}</h5>
                                                                <!-- ZONE DE DROP -->
                                                                <div class="dropzone min-vh-50 p-2 border rounded bg-white" ondrop="dropHandler(event, {{ $etape->id }})" ondragover="dragOver(event)" ondragleave="dragLeave(event)" style="min-height: 300px;">
                                                                    @foreach ($columns[$etape->id] ?? [] as $task)
