            ...
            <div class="login login-with-news-feed">    
                ...
                <div class="login-container">
                    ...
                    <div class="login-content">
                        <p class="login-box-msg text-white fw-bold fs-1 text-center">PAGE EXPIRED</p>
                        ...
                        <form action="#" method="GET" class="fs-13px">
                            ...
                            <div class="mb-15px">
                                <a href="./" class="btn btn-danger d-block h-45px w-100 btn-lg fs-14px"><i class="fa fa-hand-point-right blink"></i> Connectez-vous en cliquant ici !</a>
                            </div>
                            <div class="mb-40px pb-40px text-dark">
                                <div class="social-auth-links text-center mb-3">
                                    ...
                                    <a href="https://www.linkedin.com/company/42819872/" target="_blank" class="btn btn-block btn-dark"><i class="fab fa-linkedin mr-2"></i> Linkedin</a>
                                </div>
                            </div>
