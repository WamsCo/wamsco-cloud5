            ...
            <div class="card" style="box-shadow: 0 0;">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link" href="cuisine?active=5&champ=1-3" wire:navigate><i class="fa fa-refresh"></i> Actualiser</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" style="font-size: 13px;" data-bs-toggle="tab" href="#all">Toutes ({{$emplacement_allCount}})</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="font-size: 13px;" data-bs-toggle="tab" href="#home">A préparer ({{$emplacement_prepaCount}})</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="font-size: 13px;" data-bs-toggle="tab" href="#encours">En cours ({{$emplacement_encourCount}})</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="font-size: 13px;" data-bs-toggle="tab" href="#terminer">Terminer ({{$emplacement_terminerCount}})</a>
                        </li>
                    </ul>
                        ...
                        <div class="col-md-12">
                            <div class="table-responsivek">                                   
                                <div class="tab-content">
                                    <div id="all" class="container-fluid tab-pane active px-0">
                                    ...
                                    <div id="home" class="container-fluid tab-pane px-0">
                                        <div class="card_complete_cmd position-relative d-grid flex-grow-1 h-100 gap-3 text-reset p-3 overflow-auto" style="zoom:1">
                                            @foreach($emplacement_prepa as $emplacement_prepas) 
                                            <section class="position-relative w-100 mx-auto mb-auto overflow-hidden rounded entete_card_cuine_color">
                                                <div class="">
                                                    <div class="d-flex flex-nowrap align-items-center justify-content-between px-1 pb-1 fw-bold gap-1 entete_card_cuine_color">
                                                        <div class="text-break" style="max-width: 200px;" title="{{$emplacement_prepas->nom_table}}">{{Str::limit($emplacement_prepas->nom_table, 15)}} (<span class="text-danger" title="{{$emplacement_prepas->nom_espace}}">{{Str::limit($emplacement_prepas->nom_espace, 12)}}</span>)</div>
                                                        <div class="flex-shrink-0 ps-2 text-end">
                                                            <i class="fa fa-user-circle pe-1" aria-hidden="true"></i><span title="{{$emplacement_prepas->non_caissiere}}">{{Str::limit($emplacement_prepas->non_caissiere, 15)}}</span>
                                                        </div>
                                                    </div>
                                                    <div class="d-grid p-2 bg-100">
                                                        <div class=" d-flex justify-content-between align-items-center">
                                                            <div class="py-1 px-2 rounded-pill fw-semibold" style="background-color: #272727 !important; color: #ffffff">{{$emplacement_prepas->statut}}</div>
                                                            <div class="d-flex gap-0 align-items-center justify-content-center">
                                                                <span class="px-2 py-1 rounded-pill fw-semibold" style="background-color: @if($emplacement_prepas->lieu_consommation == "A emporter") #3b0da6; @elseif($emplacement_prepas->lieu_consommation == "Livraison") #0a9682; @else #a63c96; @endif; color: #ffffff;">{{$emplacement_prepas->lieu_consommation}}</span>
                                                            </div>
                                                            <div class="">
                                                                <div class="rounded-pill py-1 px-0 fw-semibold text-bg-danger">
                                                                    <div class="py-1 px-2 rounded-pill pointer" wire:click.prevent="preparation({{$emplacement_prepas->id}})" style="background-color: #f0f0f0 !important; color: #5f5c5c"><i class="fa fa-clock-o pe-1" aria-hidden="true"></i><span>Commencer ?</span></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="w-100 bg-white overflow-auto">
                                                    @foreach($cmdAttenteLigne as $cmdAttenteLignes)
                                                        @if($emplacement_prepas->reference == $cmdAttenteLignes->ref_table)
                                                            <section class="py-2 border-0 text-800 pointer" wire:click.prevent="barrerProd({{$cmdAttenteLignes->id}},'{{$cmdAttenteLignes->statut_cuisine}}')">
                                                                <div class="d-flex pe-2 @if($cmdAttenteLignes->statut_cuisine == "Barrer") text-decoration-line-through text-muted @endif">
                                                                    <div class="px-2 text-center text-muted">
                                                                        <div class="qte_pro">{{$cmdAttenteLignes->quantite}}x</div>
                                    ...
                                    <div id="encours" class="container-fluid tab-pane fadek px-0">                                                   
                                        <div class="card_complete_cmd position-relative d-grid flex-grow-1 h-100 gap-3 text-reset p-3 overflow-auto" style="zoom:1">
                                                ...
                                                <section class="position-relative w-100 mx-auto mb-auto overflow-hidden rounded entete_card_cuine_color">
                                                    <div class="">
                                                        <div class="d-flex flex-nowrap align-items-center justify-content-between px-1 pb-1 fw-bold gap-1 entete_card_cuine_color">
                                                            ...
                                                            <div class="flex-shrink-0 ps-2 text-end">
                                                                <i class="fa fa-user-circle pe-1" aria-hidden="true"></i><span title="{{$emplacement_encours->non_caissiere}}">{{Str::limit($emplacement_encours->non_caissiere, 15)}}</span>
                                                            </div>
                                                        </div>
                                                        <div class="d-grid p-2 bg-100">
                                                            <div class=" d-flex justify-content-between align-items-center">
                                                                ...
                                                                <div class="">
                                                                    <div class="rounded-pill py-1 px-0 fw-semibold text-bg-danger">
                                                                        <div class="py-1 px-2 rounded-pill pointer" wire:click.prevent="terminer({{$emplacement_encours->id}})" style="background-color: #f0f0f0 !important; color: #5f5c5c"><i class="fa fa-clock-o pe-1" aria-hidden="true"></i><span>Terminer ?</span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div id="terminer" class="container-fluid tab-pane fadek px-0">                                                   
                                        <div class="card_complete_cmd position-relative d-grid flex-grow-1 h-100 gap-3 text-reset p-3 overflow-auto" style="zoom:1">
                                            @foreach($emplacement_terminer as $emplacement_terminers) 
                                                <section class="position-relative w-100 mx-auto mb-auto overflow-hidden rounded entete_card_cuine_color">
                                                    <div class="">
                                                        <div class="d-flex flex-nowrap align-items-center justify-content-between px-1 pb-1 fw-bold gap-1 entete_card_cuine_color">
                                                        ...
                                                        <div class="d-grid p-2 bg-100">
                                                            <div class=" d-flex justify-content-between align-items-center">
                                                                <div class="py-1 px-2 rounded-pill fw-semibold" style="background-color: #28a745  !important; color: #ffffff">{{$emplacement_terminers->statut}}</div>
                                                                <div class="d-flex gap-0 align-items-center justify-content-center">
                                                                    {{-- <span class="px-2 py-1 rounded-pill">Sur place</span> --}}
                                                                ...
                                                                <div class="">
                                                                    <div class="rounded-pill py-1 px-2 text-bg-danger">
                                                                        {{-- <div><i class="fa fa-clock-o pe-1" aria-hidden="true"></i><span>1317</span></div> --}}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="w-100 bg-white overflow-auto">
                                                        @foreach($cmdAttenteLigne as $cmdAttenteLignes)
                                                            @if($emplacement_terminers->reference == $cmdAttenteLignes->ref_table)
                                                                <section class="py-2 border-0 text-800">
                                                                    <div class="d-flex pe-2 @if($cmdAttenteLignes->statut_cuisine == "Barrer") text-decoration-line-through text-muted @endif">
                                                                        <div class="px-2 text-center text-muted">
                                                                            <div class="qte_pro">{{$cmdAttenteLignes->quantite}}x</div>
                                                                        </div>
