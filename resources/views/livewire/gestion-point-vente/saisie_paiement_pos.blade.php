<div wire:ignore.self class="modal fade" id="saissieReglementPosModal" tabindex="-1" data-bs-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header py-2" style="background-color: #56585d;color:#ffffff;">
                <h5 class="modal-title" id="exampleModalCenteredScrollableTitle"><i class="far fa-file" style=""></i> Saisie d'un règlement reçu du client <span class="text-bleu"></span> </h5>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                                ...
                                <div class="row mb-1">
                                    <div class="col-lg-10 col-md-10 col-sm-10">
                                        @if(!empty($clients->nom_client))
                                            <span class="form-control bordure fs-3 text-bleu w-100 px-0"><i class="fa fa-user-circle"></i> {{substr($clients->nom_client,0,24) > substr($clients->nom_client,0,23) ? substr($clients->nom_client,0,24).'...': $clients->nom_client}}</span>
                                        @else
                                            <span class="form-control bordure fs-3 blink text-danger w-100 px-0"><i class="fa fa-user-circle"></i> Client Inconnu</span>
                                        @endif
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">                                                                                   
                                ...
                                <div class="row mb-1">
                                    <label for="date_reglement" class="col-lg-4 col-md-5 col-sm-3 fw-bold col-form-label">Date facturation</label>
                                    <div class="col-lg-8 col-md-7 col-sm-9">
                                        <span class="form-control sans_bordure fw-bold fs-6 text-bleu">{{date('d/m/Y', strtotime($this->date_facturation))}}</span>
                                    </div>
                                    <div class="d-flex justify-content-start">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="row mb-1">
                                    ...
                                    <div class="col-lg-8 col-md-7 col-sm-8">                                                        
                                        <select id="mode_reglement" wire:model.live="mode_reglement" class="form-control form-select bordure w-100 @error('mode_reglement') is-invalid @enderror" id="mode_reglement">
                                            <option value=""></option>	
                                            ...
                                            <option value="Solde en compte">Solde en compte ({{number_format($this->soldeClientDispo,0,',',' ')}} <span class="" style="font-size: 09px">{{$this->devise}}</span>)</option>
                                        </select>  
                                    </div>
                                    <div class="d-flex justify-content-start">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="row mb-2">
                                    <label for="commentaire" class="col-lg-3 col-md-4 col-sm-4 col-form-label">Commentaires</label>
                                    ...
                                    <div class="col-sm-6 col-12">                                            
                                        <form>
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col-sm-8">
                                                    <span class="form-control sans_bordure fw-bold fs-6 text-vert">{{number_format($montantRecu,0,',',' ')}} <span class="text-bleu" style="font-size: 09px">{{$this->devise}}</span></span>
                                                </div>
                                                <div class="d-flex justify-content-start">
                                    ...
                                    <div class="col-sm-6 col-12">                                            
                                        <form>
                                            <div class="row mt-2 mb-0">
                                                ...
                                                @else 
                                                    <label for="quantite" class="col-sm-5 col-form-label text-danger">Rendu</label>
                                                    <div class="col-sm-7">
                                                        <span class="form-control sans_bordure fw-bold fs-6 text-danger blink">{{number_format(-$Reste_a_Percevoir,0,',',' ')}} <span class="text-bleu" style="font-size: 09px">{{$this->devise}}</span></span>
                                                    </div> 
                                                @endif 
                                                <div class="d-flex justify-content-start">
                                                    @error('quantite') <span class="text-danger">{{ $message }}</span> @enderror 
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" wire:model.live="montant_reglement" placeholder="" class="form-control bordure w-auto @error('montant_reglement') is-invalid @enderror" id="montant_reglement">
                                                </div>
                                                <div class="d-flex justify-content-start">
            ...
            <div class="modal-footer d-flex align-items-center justify-content-between py-1" style="background-color: #56585d; color:#ffffff;">
                <div>
                    <button type="submit" wire:click="encompte()" class="btn btn-sm btn-info fw-bold"><i class="fa fa-user-plus"></i> En compte</button>
                </div>
                <div>
                    @if($this->mode_reglement == "Solde en compte")
                        <button type="submit" wire:click.prevent="payerAvecSolde()" class="btn btn-sm btn-white text-bleu fw-bold"><i class="fa fa-check"></i> Payer avec le solde ({{number_format($this->soldeClientDispo,0,',',' ')}} <span class="" style="font-size: 09px">{{$this->devise}}</span>)</button>
                    @else
                        <button type="submit" wire:click="payer()" class="btn btn-sm btn-secondary fw-bold"><i class="fa fa-check"></i> Payer</button>
                    @endif
