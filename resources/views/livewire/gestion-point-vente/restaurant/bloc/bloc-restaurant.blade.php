<div>
            ...
            <div class="profile-header">        
                ...
                <div class="profile-header-content">
                    <div class="profile-header-info">
                        ...
                        {{-- <h1 class="page-header mb-1">{{$title_fils}} » <span style="color:yellow">{{$espaceCount}}</span></h1>   --}}
                    </div> 
                </div> 
            </div>
        </div>
                            ...
                            <div class="col-lg-12">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2">
                                            ...
                                            <div class="d-flex align-items-center px-3 flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="d-block fw-bold text-secondary" style="font-size: 11px;">Nombre Total espace</span>
                                                    <span class="d-block fw-semibold text-dark" style="font-size: 13px;">{{$nbreTotalEspaceRestau}}</span>
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">
                                                ...
                                                <div class="text-nowrap">
                                                    ...
                                                    {{-- <span class="d-block fw-bold text-dark mt-1" style="font-size: 14px;">{{$catRestau}} <span style="font-size: 10px;"></span></span> --}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-1">
                                    ...
                                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">
                                        <li class="nav-item">                                                
                                            <a class="nav-link active" data-bs-toggle="tab" href="#home" title="Liste des tieres : Prospects, Clients, Fournisseurs"><i class="fas fa-users text-bleu"></i> {{$title_fils}} (<span class="text-vert">{{$espaceCount}}</span>)</a>                                                
                                        </li>  
                                        <li class="nav-item">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1">                            
                                            <a href="#" class="btn btn-sm btn-danger ms-auto" title=" Cliquez pour ajouter" data-bs-toggle="modal" data-bs-target="#ajoutEspaceModal"><i class="fa fa-plus-circle"></i> Nouveau espace</a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-12 px-0">   
                                                <div class="card shadow-sm border border-light-subtle rounded-3 bg-white px-0">
                                                    <div class="d-flex align-items-center justify-content-between gap-3 pt-2 px-2">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between gap-1">
                                                            ...
                                                            <div>
                                                                ...
                                                                <input type="search" wire:model.live="query" id="query" class="form-control bordure" placeholder="Rechercher espace">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="table-responsive border-top">
                                                        <div class="hauteur_ecran">
                                                            <div class="row pt-2 px-2">
                                                                @foreach($espace as $espaces)	
                                                                    <div class="col-lg-3 col-md-6 col-xs-12 mb-2 pointer" wire:click.prevent="edit('{{$espaces->id}}')" data-bs-toggle="modal" data-bs-target="#updateEspaceModal" title="Cliquez pour modifier ou supprimer" data-toggle="tooltip">                            
                                                                        <div class="row rounded border list_achat">                                        
                                                                            <div class="col-md-8 col-sm-8 col-xs-8 mt-2 mb-2"> 
                                                                                ...
                                                                                @endphp --}}
                                                                                <strong class="text-bleu title_color truncate_ok" title="{{$espaces->nom_espace}}"><i class="fa fa-chart-pie"></i> {{Str::limit($espaces->nom_espace, 22)}}</strong>
                                                                            </div>                                        
                                                                            <div class="col-md-4 col-sm-4 col-xs-4 mt-2 mb-2">                                                
                                                                                <span class="description_cat" title="{{$espaces->description}}">{{Str::limit($espaces->description, 16)}}</span>                        
                                                                            </div>
                                                                            <div class="col-md-8 col-sm-8 col-xs-8 mb-2"> 
                                                                                <span class="date_achat">{{date('d-m-Y H:i:s', strtotime($espaces->created_at))}} <i class="fa fa-calendar-alt light"></i> <i class="fa fa-check-circle @if($espaces->opacite == "Oui") text-vert @else text-danger @endif" title="Opacité @if($espaces->opacite == "Oui") » Activée @else » Désactivée @endif"></i></span>
                                                                            </div>
                                                                            <div class="col-md-4 col-sm-4 col-xs-4 mb-2">
                                                                                <span class="entite_cat truncate_ok" title="{{$espaces->nom_user}}">{{Str::limit($espaces->nom_user, 12)}}</span>
                                                                            </div>                                        
                                                                        </div>                                                                
                                                                    </div> 
                                                                @endforeach
                                                        ...
                                                        <div class="bloc_pagination">{{$espace->links()}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    {{-- Modal --}}
    @include('livewire.gestion-point-vente.restaurant.bloc.create')
    @include('livewire.gestion-point-vente.restaurant.bloc.update')
</div>
