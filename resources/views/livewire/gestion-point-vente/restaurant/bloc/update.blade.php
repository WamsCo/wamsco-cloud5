<div wire:ignore.self class="modal fade" id="updateEspaceModal" tabindex="-1" data-bs-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content new_color">
			<div class="">
				...
				<h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-chart-pie"></i> Modifier bloc » <span class="noir_fonce text-vert">{{$nom_espace}}</span></h5>
