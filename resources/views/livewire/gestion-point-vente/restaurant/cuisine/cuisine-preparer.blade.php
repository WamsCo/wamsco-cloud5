            ...
            <div class="card" style="box-shadow: 0 0;">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">                        
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" style="font-size: 13px;" href="{{asset('cuisine_prepare?active=5&champ=1-3')}}" wire:navigate>A préparer ({{$emplacement_prepaCount}})</a>
                        </li>
                        <li class="nav-item">
                                                ...
                                                <section class="position-relative w-100 mx-auto mb-auto overflow-hidden rounded entete_card_cuine_color">
                                                    <div class="">
                                                        <div class="d-flex flex-nowrap align-items-center justify-content-between px-1 pb-1 fw-bold gap-1 entete_card_cuine_color">
                                                            ...
                                                            <div class="flex-shrink-0 ps-2 text-end">
                                                                <i class="fa fa-user-circle pe-1" aria-hidden="true"></i><span title="Auteur » {{$emplacement_prepas->non_caissiere}}">{{Str::limit($emplacement_prepas->non_caissiere, 15)}}</span>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class=" d-flex justify-content-between align-items-center">
                                                                ...
                                                                {{-- <div class="">
                                                                    <div class="rounded-pill py-1 px-0 fw-semibold text-bg-danger">
                                                                        <div class="py-1 px-2 rounded-pill pointer" wire:click.prevent="preparation({{$emplacement_prepas->id}})" style="background-color: #f0f0f0 !important; color: #5f5c5c"><i class="far fa-hand-point-right text-danger blink" aria-hidden="true"></i> <span>Commencer ?</span></div>
                                                                    </div>
                                                                </div> --}}
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="cmd_card_footer bg-100">
                                                        <div class="d-flex pt-1">                                                         
                                                            @if($emplacement_prepas->statut == "A préparer")
                                                                <button wire:click.prevent="preparation('{{$emplacement_prepas->id}}')" class="btn btn-lg btn-outline-dark fw-semibold flex-fill py-2 rounded" title="Cliquez pour changer le statut de la commande" type="button">
