            ...
            <div class="card" style="box-shadow: 0 0;">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">                        
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" style="font-size: 13px;" href="{{asset('cuisine_terminer?active=5&champ=1-3')}}" wire:navigate>Terminer ({{$emplacement_terminerCount}})</a>
                        </li>
                    </ul>
                        ...
                        <div class="col-md-12">
                            <div class="table-responsivek">                                   
                                <div class="tab-content">                                    
                                    <div id="terminer" class="container-fluid px-0">                                                   
