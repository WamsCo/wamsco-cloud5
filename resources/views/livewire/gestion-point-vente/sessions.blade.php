                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-nowrap overflow-auto py-2">
                                            ...
                                            <div class="d-flex align-items-center px-3 border-end flex-fill">                                                
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="d-block fw-bold text-secondary" style="font-size: 11px;">Total session Point de vente</span>
                                                    <span class="d-block fw-semibold text-dark" style="font-size: 13px;">{{number_format($nbreTotalSessionPos,0,',',' ')}}</span>
                                                ...
                                                <div class="card shadow-sm border border-light-subtle rounded-3 bg-white px-0">
                                                    <div class="d-flex align-items-center justify-content-between gap-3 pt-2 px-2">
                                                        <div class="d-flex align-items-center justify-content-between gap-1">
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between gap-1">
                                                                <a href="{{asset('exporter-sessions?date_debut='.$this->date_debut.'&date_fin='.$this->date_fin.'&user='.$this->parUser)}}" class="btn btn-sm btn-success mt-2 d-none d-md-block mb-1"><i class="fa-solid fa-file-export"></i> Exporter Excel</a>
                                                        ...
                                                        <table class="table table-striped table-hover text-nowrap m-0"> 
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="fond_entete_table pointer" wire:click="setOrderField('nom_point_vente')">Point de vente <i class="fa fa-arrow-down-short-wide"></i></th> 
                                                            ...
                                                            <tbody>
                                                                @foreach($session as $sessions) 
                                                                    <tr>
                                                                        <td class="fw-semibold pointer"><a href="detail_pos_session?id={{$sessions->id}}&ref={{$sessions->session_id}}&active=5&champ=1-1" wire:navigate title="Cliquez pour voir les details"><i class="fa fa-cash-register text-danger" aria-hidden="true"></i> {{$sessions->session_id}}</a></td> 
                                                                        ...
                                                                        <td style="font-weight: 600; color:#ff5b57;">
                                                                        ...
                                                                        <td class="text-start">
                                                                            ...
                                                                            @elseif($sessions->etat == "Contrôle à l'ouverture")
                                                                                <span class="badge bg-secondary py-1" title="Session {{$sessions->etat}}"><i class="fa fa-money-bill"></i> {{$sessions->etat}}</span>
                                                                        ...
                                                                        <td class="text-end"><a href="detail_pos_session?id={{$sessions->id}}&ref={{$sessions->session_id}}&active=5&champ=1-1" wire:navigate class="btn-outline-muted" title="Cliquez pour voir les details" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-eye"></i></a></td>
