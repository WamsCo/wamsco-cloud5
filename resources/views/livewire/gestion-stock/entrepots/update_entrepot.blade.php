<div wire:ignore.self class="modal fade" id="modifierEntrepotModal" tabindex="-1" data-bs-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header py-2" style="background-color: #56585d; color:#ffffff;">
                <h5 class="modal-title" id="exampleModalCenteredScrollableTitle"><i class="fa fa-plus-circle"></i> Modification entrepôt » <span class="text-vert">{{$this->nom}}</span> </h5>
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-lg-8 col-md-7 col-sm-9">                                                        
                                                <select id="entrepot_parent" wire:model="entrepot_parent" class="form-control form-select bordure w-100 @error('entrepot_parent') is-invalid @enderror">
                                                    <option value=""></option>   
                                                    @foreach($entrepo as $entrepos)                                                                                                                                                                
                                                        <option value="{{$entrepos->nom}}">{{$entrepos->nom}}</option>
                                                    @endforeach
                                                </select> 
                                            </div>
                                            <div class="d-flex justify-content-start">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-9">
                                                <div class="card-body">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" wire:model.live="etats" value="1" name="inlineRadioOptions" id="inlineRadio3">
                                                        <label class="form-check-label" for="inlineRadio3">Activer</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" wire:model.live="etats" value="0" name="inlineRadioOptions" id="inlineRadio4">
                                                        <label class="form-check-label" for="inlineRadio4">Désactiver</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-start">
                                                @error('etats') <span class="text-danger">{{ $message }}</span> @enderror 
                                            </div>
                                        </div>
                                    </div>                                        
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="modal-footer py-1" style="background-color: #56585d; color:#ffffff;">
                <button type="submit" wire:click.prevent="update()" class="btn btn-sm btn-secondary fw-semibold"><i class="fas fa-save"></i> Modifier</button>
