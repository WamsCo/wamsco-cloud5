        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">             
                <div class="modal-header py-1" style="padding-top: 0px; padding-bottom: 0px; background-color: #56585d; color:#ffffff;">                    
                    <h4 class="titre_modal_fidelite text-white"><i class="fa fa-chart-pie text-danger"></i> Modifier » <span class="noir_fonce text-vert">{{$nom_categorie}}</span></h4>                    
                </div>
                ...
                <div class="d-flex d-flex justify-content-center gap-1 pt-1 pb-1" style="background-color: #56585d; color:#ffffff;">                    
                    <button class="btn btn-sm btn-secondary" wire:click.prevent="update()" title="Cliquez pour modifier" data-toggle="tooltip"><i class="fa fa-save"></i> Modifier</button>
