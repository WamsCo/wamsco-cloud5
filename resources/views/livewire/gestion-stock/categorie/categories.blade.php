                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-1">
                                    ...
                                    <ul class="nav nav-tabs margin_ajuste border-0" role="tablist">
                                        <li class="nav-item">                                                
                                            <a class="nav-link active" data-bs-toggle="tab" href="#home" title="Liste des categories"><i class="fas fa-users text-bleu"></i> {{$title_fils}} (<span class="text-vert">{{$categoriecount}}</span>)</a>                                                
                                        </li>  
                                        <li class="nav-item">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1">                            
                                            <button href="#" data-bs-toggle="modal" data-bs-target="#ajoutCategorieModal" title="Cliquez pour ajouter" data-toggle="tooltip" class="btn btn-sm btn-danger ms-auto"><i class="fa fa-plus-circle"></i> Nouvelle catégorie</button>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="hauteur_ecran">
                                                            <div class="row pt-2 px-2">
                                                                @foreach($categorie as $categories)	
                                                                    <div class="col-lg-3 col-md-6 col-xs-12 mb-2 pointer" wire:click.prevent="edit('{{$categories->id}}')" data-bs-toggle="modal" data-bs-target="#updateCategorieModal" title="Cliquez pour voir les détails" data-toggle="tooltip">                            
