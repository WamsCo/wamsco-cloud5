                                    ...
                                    <div class="card-body border border-light-subtle rounded-3 bg-white position-relative custom-scroll pe-2" style="height: calc(100vh - 131px); overflow-y: auto;">
                                        <div class="text-centerk">
                                            <div class="d-flex align-items-centerk">
                                                <div class="">
                                                    <div class="photoref">
                                                        <span class="fas fa-boxes em080" style=" color: #ff5252;" title="No photo"></span>
                                                    </div>
                                                </div>
                                                <div class="ms-2">
                                                    <h5 class="mb-0 fw-bold" title="Entrepôt origine » {{$this->libelle}}">{{Str::limit($this->libelle, 31) ?? 'Inconu(e)'}}</h5>
                                        ...
                                        <div class="d-flex gap-2 mb-1">   
                                            <a href="{{asset('inventaires?active=4&champ=3-1&choix=7')}}" title="Cliquez pour modifier image" data-toggle="tooltip" class="btn btn-sm btn-outline-success flex-fill fw-semibold ms-auto"><i class="fa fa-close"></i> Fermer</a>
                                            @if($etat == 'Brouillon')
                                        ...
                                        <div class="d-flex gap-2 mb-3 border-bottom py-2">
                                            @if($inventaireLigneCount)
                                                @if($etat == 'Brouillon')
                                                    <button  wire:click.prevent="generer()" class="btn btn-sm btn-outline-dark fw-semibold text-uppercase flex-fill blink"><i class="fa-solid fa-recycle"></i> Générer les mouvements</button>                                    
                                                @endif
                                            @endif
                                        </div>
                                        <h5 class="fw-bold mb-3">Inventaire » N°#{{$ids}}</h5>
                                        <table class="table table-borderless">                                                
                                            <tr>
                                                <td class="text-muted fw-semibold">Libelle</td>
                                                <td class="text-muted">{{$this->libelle}}</td> 
                                            </tr>
                                            <tr>
                                                <td class="text-muted fw-semibold">Référence</td>
                                                <td class="text-primary fw-semibold">{{$this->reference}}</td> 
                                            </tr>
                                            <tr>
                                                <td class="text-muted fw-semibold">Entrepôt</td>
                                                <td class="text-muted">{{$this->entrepot_nom}}</td>
                                            </tr>                                                
                                            <tr>
                                                <td class="text-muted fw-semibold">Date</td>
                                                <td class="text-primary fw-semibold">{{date('d-m-Y', strtotime($this->date_inventaire))}}</td>
                                            </tr>                                           
                                            <tr>
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-0">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1">                            
                                            <a href="{{asset('inventaires?active=4&champ=3-1&choix=7')}}" wire:navigate class="btn btn-sm btn-bleu d-none d-md-block ms-auto"><i class="fa fa-chevron-left"></i> Retour liste</a>
                                    ...
                                    <div id="home" class="container-fluid tab-pane active pas_bordure">
                                        <div class="card shadow-sm">  
                                            <div class="card shadow-sm border border-light-subtle rounded-3 bg-white p-2">    
                                                <h6 class="fw-bold text-bleu mb-1"><i class="fas fa-boxes" style=" color: #393b83;" title="Derniers événements liés"></i> Fiche inventaire</h6>
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 px-0">
                                                                <div class="table-responsive mt-2"> 
                                                                    <ul class="nav nav-tabs border-0" role="tablist">
                                                                        <li class="nav-item">
                                                                            <a class="nav-link active" data-bs-toggle="tab" href="#inventaire"><i class="fas fa-boxes text-bleu"></i> Inventaire <span>({{$inventaireLigneCount}})</span></a>
                                                                        </li>
                                                                        <li class="nav-item">
                                                                    ...
                                                                    <div class="tab-content table-responsive border-topk" style="border-top-style: dashed; border-top-width: 1px;border-top-color: #0e04043d;">
                                                                        <div id="inventaire" class="tab-pane active">
                                                                            <div class="table-responsive border-topk pt-4">
                                                                                <table class="table table-striped table-hover text-nowrap mx-1"> 
                                                                                    <thead>
                                                                                        <tr>
                                                                                        <th class="fond_entete_table">Entrepôt</th>
                                                                                        <th class="fond_entete_table">Produits</th>
                                                                                        <th class="fond_entete_table text-center"><span>Qté attendue</span></th>
                                                                                        <th class="fond_entete_table text-center">Quantité réelle <i class="fas fa-info-circle" title="Définissez la valeur sur 0 pour réinitialiser la quantité. Supprimez la ligne pour qu'elle reste inchangé" data-bs-toggle="tooltip" data-bs-placement="top" style=" vertical-align: middle; cursor: help"></i></th>
                                                                                        <th class="fond_entete_table text-center"><span>Ecart</span></th>
                                                                                        <th class="fond_entete_table"></th>
                                                                                        </tr>
                                                                                    </thead>                                       
                                                                                    <tbody>
                                                                                        @foreach($inventaire_lignes as $inventaire_ligne)
                                                                                            <tr> 
                                                                                                <td class="text-bleu fw-semibold"><a href="detail_entrepot?id={{$inventaire_ligne->id_entrepot}}&active=4&champ=3-1&choix=2" wire:navigate class="text-bleu">{{$inventaire_ligne->entrepot}}</a></td>                                                         
                                                                                                <td class="text-bleu fw-semibold"><a href="detail_product?id={{$inventaire_ligne->id_produit}}&active=4&champ=1-1&choix=2" wire:navigate class="text-bleu">{{$inventaire_ligne->produit}}</a></td>                                                         
                                                                                                <td class="text-center fw-semibold">{{$inventaire_ligne->quantite_initiale}}</td>         
                                                                                                <td class="text-center fw-semibold">{{$inventaire_ligne->quantite_reelle}}</td>  
                                                                                                <td class="text-center fw-semibold @if($inventaire_ligne->ecart < 0) text-danger @endif">{{$inventaire_ligne->ecart}}</td>  
                                                                                                <td class="text-end fw-semibold">
                                                                                                @if($etat == 'Brouillon')
                                                                                                    @if($confirmer === $inventaire_ligne->id)                                                               
                                                                                                        <a wire:click.prevent="supprimer({{$inventaire_ligne->id}})" class="btn btn-outline-danger btn-xs bg-danger text-white blink"  title="Cliquez pour confirmer la suppression" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"> Confirmer ?</i></a>
                                                                                                    @else
                                                                                                        <a wire:click.prevent="confirmerDelete({{$inventaire_ligne->id}})" class="btn btn-outline-muted btn-xs"  title="Cliquez pour supprimer" data-bs-toggle="tooltip" data-bs-placement="top"><i class="fa fa-trash"></i></a>
                                                                                                    @endif
                                                                                                @endif
                                                                                                </td> 
                                                                                            </tr> 
                                                                                        ...
                                                                                        @if($ouvre === 1) 
                                                                                            <tr> 
                                                                                                @include('livewire.gestion-stock.inventaires.ajout_ligne_inventaire')     
                                                                                            </tr>
                                                                                        @endif
                                                                                        @if($etat == 'Brouillon')
                                                ...
                                                <div class="alert mt-3 mb-0 d-flex justify-content-between align-items-center rounded-2 px-3 py-2" style="background-color: #f4f8ff; border: 1px solid #cce0ff;">
                                                    ...
                                                    <a href="{{asset('transferts?active=4&champ=3-1&choix=5')}}" wire:navigate class="text-decoration-none fw-semibold text-primary" style="font-size: 13px;">Voir plus</a>
                                                </div>
                                            </div>                                                
                                        </div>                                            
                                    </div>                                                                               
