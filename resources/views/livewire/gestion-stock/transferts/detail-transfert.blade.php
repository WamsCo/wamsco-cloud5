                                    ...
                                    <div class="card-body border border-light-subtle rounded-3 bg-white position-relative custom-scroll pe-2" style="height: calc(100vh - 131px); overflow-y: auto;">
                                        <div class="text-centerk">
                                            <div class="d-flex align-items-centerk">
                                                ...
                                                <div class="ms-2">
                                                    <h5 class="mb-0 fw-bold" title="Entrepôt origine » {{$this->libelle_origine}}">{{Str::limit($this->libelle_origine, 31) ?? 'Inconu(e)'}}</h5>
                                        ...
                                        <div class="d-flex gap-2 mb-1">
                                            <a href="{{asset('transferts?active=4&champ=3-1&choix=5')}}" title="Cliquez pour modifier" data-toggle="tooltip" class="btn btn-sm btn-outline-success flex-fill fw-semibold ms-auto"><i class="fa fa-close"></i> Fermer</a>
                                                @if($etat == 'Brouillon')
                                        ...
                                        <div class="table-responsive"> 
                                            <table class="table table-borderless text-nowrap m-0">                                                
                                                <tr>
                                                    ...
                                                    <td class="text-muted">{{$this->libelle_origine}}</td> 
                                                </tr>
                                                <tr>
                                                    <td class="text-muted fw-semibold">Destination</td>
                                                    <td class="text-muted">{{$this->libelle_destination}}</td>
                                                </tr>                                                
                                                <tr>
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between border-0 px-0">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-1">                            
                                            <a href="{{asset('transferts?active=4&champ=3-1&choix=5')}}" wire:navigate class="btn btn-sm btn-bleu d-none d-md-block ms-auto"><i class="fa fa-chevron-left"></i> Retour liste</a>
                                                    ...
                                                    <div class="hauteur_ecran">
                                                        <div class="row pt-2 mb-2 px-0">                                            
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="row mb-1">
                                                                    <label for="nombre_paquets" class="col-lg-4 col-form-label fw-bold w-auto">N° transfert</label>
                                                                    <div class="col-lg-8">
                                                                        <label for="nombre_paquets" class="fw-bold text-bleu col-form-label">#{{$ids}}</label>
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-1">
                                                                    <label for="entrepot_origine" class="col-lg-4 col-form-label fw-bold w-auto">Entrepôt origine</label>
                                                                    <div class="col-lg-8 w-auto">                                                        
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-sm-4">                                                
                                                                        <a href="detail_entrepot?id={{$ide}}" class="text-bleu fw-semibold" target="_blank"><i class="fa fa-box-open"></i> {{$nameEntrepot}}</a>
                                                                    </div>
                                                                ...
                                                                <div class="row mb-1">
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-sm-4">                                                
                                                                        <a href="detail_entrepot?id={{$ide2}}" class="text-bleu fw-semibold" target="_blank"><i class="fa fa-box-open"></i> {{$nameEntrepot2}}</a>
                                                                    </div>
                                                                    <div class="d-flex justify-content-start">
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="row mb-1">
                                                                    <label for="etiquette_transfert" class="col-lg-3 col-md-3 col-sm-4 fw-bold col-form-label w-auto">Etiquette du transfert</label>
                                                                                ...
                                                                                <table class="table table-striped table-hover text-nowrap m-0"> 
                                                                                    <thead>
                                                                                        <tr>
                                                                                            ...
                                                                                            <th class="fond_entete_table text-center">
                                                                                                <span><i class="fa fa-dolly"></i></span> <br>
                                                                                                <span>Quantité</span>  
                                                                                            </th>
                                                                                            <th class="fond_entete_table text-center">
                                                                                                <span>Stock</span> <br> 
                                                                                                <span>Entrepôt origine</span> 
                                                                                            </th>
                                                                                            <th class="fond_entete_table text-center">
                                                                                                <span>Stock</span> <br> 
                                                                                    ...
                                                                                    <tbody>
                                                                                        @foreach($transfert_lignes as $transfert_ligne)
                                                                                            <tr> 
                                                                                                <td class="fw-semibold"><a href="detail_product?id={{$transfert_ligne->id_produit}}&active=4&champ=1-1&choix=2" class="text-bleu" wire:navigate title="Cliquez pour voir les détails du produit" data-bs-toggle="tooltip">{{$transfert_ligne->produit}}</a></td>                                                         
                                                                                                <td class="">{{$transfert_ligne->message}}</td>     
                                                                                                <td class="text-center fw-semibold">{{$transfert_ligne->quantite}}</td>         
                                                                                                <td class="text-center fw-semibold">{{$transfert_ligne->quantite_stock_entre_origine}}</td>         
                                                                                                <td class="text-center fw-semibold">{{$transfert_ligne->quantite_stock_entre_destination}}</td> 
                                                                                        ...
                                                                                        @if($ouvre === 1) 
                                                                                            <tr> 
                                                                                                @include('livewire.gestion-stock.transferts.ajout_ligne_transfert')     
                                                                                            </tr>
                                                                                        @endif
                                                                                        @if($etat == 'Brouillon')
