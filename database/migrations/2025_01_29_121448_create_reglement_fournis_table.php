...
return new class extends Migration
{
    ...
    {
        Schema::create('reglement_fournis', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('num_cheq_virement')->nullable();
            $table->string('emetteur_cheq_virement')->nullable();
            $table->string('banque_cheq_virement')->nullable();
    ...
    {
        Schema::dropIfExists('reglement_fournis');
    }
};
