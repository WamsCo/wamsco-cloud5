...
return new class extends Migration
{
    ...
    {
        Schema::create('commande_fournisseur_entetes', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('etat_reception')->nullable();;            
    ...
    {
        Schema::dropIfExists('commande_fournisseur_entetes');
    }
};
