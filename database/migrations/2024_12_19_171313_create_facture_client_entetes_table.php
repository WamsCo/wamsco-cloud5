...
return new class extends Migration
{
    ...
    {
        Schema::create('facture_client_entetes', function (Blueprint $table) {
            $table->id();            
            $table->string('code_facture');
            $table->string('code_commande')->nullable();
            $table->string('id_commande_client_entete')->nullable();
    ...
    {
        Schema::dropIfExists('facture_client_entetes');
    }
};
