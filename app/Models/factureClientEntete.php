...
class factureClientEntete extends Model
{
    ...
    'reste_a_percevoir','statut','etat','etat_expedi','id_session_pos','ref_session_pos','lieu_consommation','date_consommation','adresse_livraison','user_id','nom_user','societe'];
}
