...
class NouveauTicket extends Component
{
    ...
    public function render(){
        ...
        if($dateJour <= $jourValid){ 
            if($mod_ticket == 1){             
                $title = 'Nouveau Ticket | WamsCo';
                $module = 'Gestion ticket';
                $title_fils = 'Nouveau ticket';
                ...
                return view('livewire.gestion-ticket.nouveau-ticket',compact('title_fils','module','lien','dateJour','listUser','liste_entite','log','logCount'))->layout('components.layouts.app',compact('title','active','champ','choix','entite_mod','dateJour','soldeClient','nbjoursRestant'));
            }
            else{
                $title = 'Bienvenue'; 
                $module = 'Home';
