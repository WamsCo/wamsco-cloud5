...
class NouvProduits extends Component
{    
    use WithFileUploads; 
    ...
    public function render(){
        ...
        if($dateJour <= $jourValid){
            if($mod_gestion_stock == 1){
                $title = 'Nouveau Produit | WamsCo';
                $module = 'Gestion stock';
                $title_fils = 'Nouveau produit';
                $lien = 'produit';
                ...
                return view('livewire.gestion-stock.produits.create-produit',compact('module','title_fils','lien','dateJour','listCategorie','listEntrepot','listFourni','listUser','listedeviseTva','log','logCount'))->layout('components.layouts.app',compact('title','active','champ','choix','entite_mod','dateJour','soldeClient','nbjoursRestant'));
            }
            else{
                $title = 'Bienvenue'; 
                $module = 'Home';
