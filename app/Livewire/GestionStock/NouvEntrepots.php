...
class NouvEntrepots extends Component
{
    // #[Validate('required', message: 'Veuillez renseigner le nom!')] pour des cas specifique
    #[Validate('required')]
    public $nom; 
    ...
    public function render()
    {
        ...
        if($dateJour <= $jourValid){
            if($mod_gestion_stock == 1){
                $title = 'Nouveau magasin | WamsCo';
                $module = 'Gestion stock';
                $title_fils = 'Nouveau magasin';
                $lien = 'entrepot';
                ...
                return view('livewire.gestion-stock.entrepots.create-entrepots', compact('title_fils','module','lien','dateJour','entrepot','entrepotTest','log','logCount'))->layout('components.layouts.app',compact('title','active','champ','choix','entite_mod','dateJour','soldeClient','nbjoursRestant'));
            }
            else{
                $title = 'Bienvenue'; 
                $module = 'Home';
