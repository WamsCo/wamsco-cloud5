...
class Souscription extends Component
{
    ...
    public function render(){
        ...
        if($dateJour <= $jourValid){ 
            if($mod_gestion_commercial == 1){             
                $title = 'Nouveau Souscription | WamsCo';
                $module = 'Gestion commerciale';
                $title_fils = 'Nouveau souscription';
                ...
                return view('livewire.gestion-commercial.souscription',compact('title_fils','module','lien','dateJour','log','logCount'))->layout('components.layouts.app',compact('title','active','champ','choix','entite_mod','dateJour','soldeClient','nbjoursRestant')); 
            }
            else{
                $title = 'Bienvenue'; 
                $module = 'Home';
    ...
    public function store(){ 
        ...
        try {
            ...
            Entite :: create(['solde'=>$solde,'enseigne'=>$this->societe,'societe_mere'=>$this->societe,'raison_sociale'=>$this->societe,'responsable_societe'=>$this->nom_utilisateur,'telephone'=>$this->telephone,'ville'=>$this->ville,'adresse'=>$this->adresse,
            ...
            $retrait_point = 0;
            $objectif_point = 0;
            Tier::create(['nom'=>$nom_tier,'raison_sociale'=>$nom_tier,'type_tiers'=>$type_tiers,'etat'=>1,'telephone'=>$this->telephone,'email'=>$this->email,
