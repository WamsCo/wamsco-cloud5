    ...
    public function render()
    {
        ...
        if($dateJour <= $jourValid){
            if($mod_facturation == 1){
                ...
                $fact_fourni = factureFournisseurLigne::where('societe',auth()->user()->societe)->where('code_facture','like','%'.$this->parFact.'%')->where('nom_fournisseur','like','%'.$this->query.'%')->where('id_produit','like','%'.$this->parNomProduit.'%')->whereBetween('created_at',[$start, $end])->orderBy($this->orderField, $this->orderDirection)->paginate($this->parPage);
                ...
                // pour les KPI
                $resultat = factureFournisseurLigne::where('societe',auth()->user()->societe)->get();  
                ...
                $derniereActivite = factureFournisseurLigne::where('societe',auth()->user()->societe)->latest('updated_at')->first();
