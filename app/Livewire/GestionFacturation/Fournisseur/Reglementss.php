...
class Reglementss extends Component
{
    ...
    public function render(){
        ...
        if($dateJour <= $jourValid){
            if($mod_facturation == 1){
                $title = 'Règlements fournisseurs | WamsCo';
                $module = 'Gestion facturation';
                $title_fils = 'Règlements fournisseurs';
                ...
                return view('livewire.gestion-facturation.fournisseur.reglements',compact('title_fils','module','lien','dateJour','Reglement_fournisseur','regleFournisseurCount','montantTregler',
                'nbreTotalReglement','montantTregler_all','derniereActivite','log','logCount'))->layout('components.layouts.app',compact('title','active','champ','choix','entite_mod','dateJour','soldeClient','nbjoursRestant'));
            }
            else{
                $title = 'Bienvenue'; 
                $module = 'Home';
