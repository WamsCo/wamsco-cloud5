...
class CuisineTerminer extends Component
{
    use WithPagination;
    use WithFileUploads;
    ...
    public function render()
    {
        ...
        if($dateJour <= $jourValid){
            if($mod_cuisine == 1){
                ...
                return view('livewire.gestion-point-vente.restaurant.cuisine.cuisine-terminer',compact('title_fils','module','lien','dateJour','emplacement_allCount','emplacement_prepaCount','emplacement_encourCount',
                'emplacement_terminer','emplacement_terminerCount','cmdAttenteLigne'))->layout('components.layouts.app_pos',compact('title','active','champ','choix','entite_mod','dateJour','soldeClient','nbjoursRestant','aller'));
            }
            else{
                $title = 'Bienvenue'; 
                $module = 'Home';
