...
class PosRestaurant extends Component
{
    ...
    public function render()
    {
        ...
        if($dateJour <= $jourValid){
            if($mod_pointe_vente == 1){
                ...
                $categorieProd = Categorie::where('societe',auth()->user()->societe)->where('restaurant','Oui')->orderBy('nom_categorie','asc')->get(); 
                ...
                // $test_vide = RestauPosFactureClientLigne ::where('user_id',auth()->user()->id)->where('societe',auth()->user()->societe)->where('ref_table',$this->id_table_restau)->count();
                $test_vide = RestauPosFactureClientLigne ::where('societe',auth()->user()->societe)->where('ref_table',$this->id_table_restau)->count();
                $ligne_cmd = RestauPosFactureClientLigne::where('societe',auth()->user()->societe)->where('ref_table',$this->id_table_restau)->orderBy('id','asc')->get(); 
                $nbreCmd = $ligne_cmd->count();
                $QteCmd = $ligne_cmd->sum('quantite');
                $montant_ttc = $ligne_cmd->sum('montant_ttc');                
                $reste_a_percevoir = RestauPosfactureClientEntete::where('user_id',auth()->user()->id)->where('societe',auth()->user()->societe)->where('ref_table',$this->id_table_restau)->sum('reste_a_percevoir');

            
                $test_posFcltEnteteExiste = RestauPosfactureClientEntete::where('user_id',auth()->user()->id)->where('societe',auth()->user()->societe)->where('ref_table',$this->id_table_restau)->limit(1)->count();
                if($test_posFcltEnteteExiste > 0){
                    $this->client = RestauPosfactureClientEntete::where('user_id',auth()->user()->id)->where('societe',auth()->user()->societe)->where('ref_table',$this->id_table_restau)->limit(1)->get();
                    $clients = RestauPosfactureClientEntete::where('user_id',auth()->user()->id)->where('societe',auth()->user()->societe)->where('ref_table',$this->id_table_restau)->limit(1)->get();
                    $idFclt = $clients[0]->id;
                ...
                $reste_a_payer = RestauPosfactureClientEntete::where('user_id',auth()->user()->id)->where('societe',auth()->user()->societe)->where('ref_table',$this->id_table_restau)->sum('reste_a_percevoir');
                $this->Reste_a_Percevoir =  ((double)$reste_a_payer - (double)$this->montant_reglement);  

                $statu = TableRestau::where('societe',auth()->user()->societe)->where('reference',$this->id_table_restau)->first(); 
                ...
                // $verifieSession = SessionRestau::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('etat','En cours')->count();
                $verifieSession = SessionRestau::where('societe',auth()->user()->societe)->where('session_id',$this->ref_session_restau)->where('etat','En cours')->count();                
    ...
    public function choisir($id){
        ...
        if($test > 0){
            ...
            if($autoriser == 1){
                // ceci verifie si une session est ouverte ou pas
                // $testSessions = SessionRestau::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('etat','En cours')->count(); 
                $testSessions = SessionRestau::where('societe',auth()->user()->societe)->where('session_id',$this->ref_session_restau)->where('etat','En cours')->count(); 
                if($testSessions > 0){ 
                    ...
                    // pour mouvement
                    $sessions = SessionRestau::where('societe',auth()->user()->societe)->where('session_id',$this->ref_session_restau)->where('etat','En cours')->first(); 
                    ...
                    if($quantite_stock <= 0){ 
                        ...
                        $test = RestauPosfactureClientEntete ::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->count();
                        if($test > 0){     
                            $test_paye = RestauPosfactureClientEntete ::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->first();
                            $etat_payes = $test_paye->etat;
                            if($etat_payes == "Brouillon"){
                                $test2 = RestauPosFactureClientLigne ::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->where('id_produit',$id_produit)->where('id_entrepot',$id_entrepot)->count();
                                if($test2 > 0){
                                    
                                    $quantite = 1;   
                                    $cmd = RestauPosFactureClientLigne ::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->where('id_produit',$id_produit)->where('id_entrepot',$id_entrepot)->first();
                                    $id_Fligne = $cmd->id;
                                    ...
                                    $ligne_resto = RestauPosFactureClientLigne::where('societe',auth()->user()->societe)->where('id_facture_client_entete',$id_Posfact_cltEntete)->where('ref_table',$this->id_table_restau)->get(); 
                                    ...
                                    $recup = RestauPosfactureClientEntete ::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->first();
                                    ...
                                    $ligne_restos = RestauPosFactureClientLigne::where('societe',auth()->user()->societe)->where('id_facture_client_entete',$id_fPosEntete)->where('ref_table',$this->id_table_restau)->get(); 
                            ...
                            $test_count = RestauPosfactureClientEntete ::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->count();
                            if($test_count != 0){
                                $test_paye = RestauPosfactureClientEntete ::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->first();
                            ...
                            if($etat_paye == "Brouillon"){
                                ...
                                RestauPosfactureClientEntete :: create(['ref_table'=>$this->id_table_restau,'nom_table'=>$this->nom_table,'id_session_pos'=>$id_session_pos,'ref_session_pos'=>$ref_session_pos,'code_facture'=>$token_ok,'nom_client'=>$client,'id_client'=>$id_client,'date_facturation'=>$date_facturation,'date_echeance'=>$date_echeance,
                                ...
                                $dernier_id = RestauPosfactureClientEntete::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->latest()->first()->id; 
                                ...
                                $ligne_restos = RestauPosFactureClientLigne::where('societe',auth()->user()->societe)->where('id_facture_client_entete',$dernier_id)->where('ref_table',$this->id_table_restau)->get(); 
                                $montantHT = $ligne_restos->sum('montant_ht');
                                $montantTTC = $ligne_restos->sum('montant_ttc');
                                $montantRemise = $ligne_restos->sum('montant_remise');
                                $montantTva = $ligne_restos->sum('montant_tva');
        ...
        if($test > 0){
            ...
            if($autoriser == 1){      
                if($id){   
                    ...
                    $quantitActuel = RestauPosFactureClientLigne::where('societe',auth()->user()->societe)->where('id',$id)->where('ref_table',$this->id_table_restau)->first();
                    ...
                    $testLigne =  RestauPosFactureClientLigne::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->count();
                    if($testLigne == 1){ 
                       RestauPosFactureClientLigne::where('id',$id)->delete();
                       RestauPosfactureClientEntete::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->delete();

                       RestauCommandeAttenteEntete::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->delete(); 
                       RestauCommandeAttenteLigne::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->delete();
                       // Suppression Fin 
                    ...
                    $ligne_restau = RestauPosFactureClientLigne::where('societe',auth()->user()->societe)->where('id_facture_client_entete',$id_Posfact_cltEntete)->where('ref_table',$this->id_table_restau)->get(); 
                    ...
                    $testEntete =  RestauPosfactureClientEntete::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->count();
                    if($testEntete > 0){
                    ...
                    // $sessions = SessionRestau::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('etat','En cours')->first(); 
                    $sessions = SessionRestau::where('societe',auth()->user()->societe)->where('session_id',$this->ref_session_restau)->where('etat','En cours')->first();
                    $id_session_pos = $sessions->id;
                    $ref_session_pos = $sessions->session_id;
    ...
    public function edit($id){  
        $cmd = RestauPosFactureClientLigne ::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('id',$id)->where('ref_table',$this->id_table_restau)->first();
        $this->ids = $cmd->id;
            ...
            if($this->offrir == 'Non'){                     
                ...
                elseif($this->quantite_ajoute < -1){
                    ...
                    if($montant_remiser_ht < $montant_achat_avec_qte){
                        ...
                        $ligne_restau = RestauPosFactureClientLigne::where('societe',auth()->user()->societe)->where('id_facture_client_entete',$id_fPosEntete)->where('ref_table',$this->id_table_restau)->get(); 
                        $montantHT = $ligne_restau->sum('montant_ht');
                        $montantTTC = $ligne_restau->sum('montant_ttc');
                        $montantRemise = $ligne_restau->sum('montant_remise');
                        $montantTva = $ligne_restau->sum('montant_tva');
    ...
    public function prendre(int $id){
        ...
        RestauPosfactureClientEntete::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->update(['nom_client'=>$nom_tier,'id_client'=>$id_tier,'societe'=>auth()->user()->societe,'nom_user'=>auth()->user()->name,'user_id'=>auth()->user()->id]);
        RestauPosFactureClientLigne::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->update(['nom_client'=>$nom_tier,'id_client'=>$id_tier,'societe'=>auth()->user()->societe,'nom_user'=>auth()->user()->name,'user_id'=>auth()->user()->id]);
        $this->dispatch('alert',                    
        ...
        if($test > 0){      
            ...
            if($autoriser == 1){                   
                ...
                Tier::create(['nom'=>$this->nom,'raison_sociale'=>$this->raison_sociale,'type_tiers'=>$this->type_tiers,'etat'=>$this->statut,'telephone'=>$this->telephone,
                    ...
                    RestauPosfactureClientEntete::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->update(['nom_client'=>$this->nom,'id_client'=>$dernier_id]);
                    RestauPosFactureClientLigne::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->update(['nom_client'=>$this->nom,'id_client'=>$dernier_id]);
    ...
    public function AffichePaie(){
        $comptes = RestauPosfactureClientEntete::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->first(); 
    ...
    public function coller(){
        $comptes = RestauPosfactureClientEntete::where('societe',auth()->user()->societe)->where('id',$this->idPosFClt)->where('ref_table',$this->id_table_restau)->first();               
                    ...
                    if(!empty($this->nom_client)){
                        if($this->resteApercevoir > 0){
                            ...
                            if($this->montant_reglement >= $this->resteApercevoir){
                                ...
                                RestauPosFactureClientLigne::where('societe',auth()->user()->societe)->where('id_facture_client_entete',$this->idPosFClt)->update(['etat'=>$etat,'nom_user'=>auth()->user()->name,'user_id'=>auth()->user()->id]);
    ...
    public function effacer(int $id, int $id_cpteBq){         
        if($id){            
            ...
            $factClient = RestauPosfactureClientEntete::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->first();
            ...
            RestauPosFactureClientLigne::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->update(['etat'=>$etat]);
    ...
    public function NewCommande(){
        ...
        if($testSessions > 0){ 
            ...
            $id_session_pos = $sessions->id;
            $ref_session_pos = $sessions->session_id;
            RestauPosfactureClientEntete::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->update(['id_session_pos'=>$id_session_pos,'ref_session_pos'=>$ref_session_pos]);
                        
            // copier la table RestauPosfactureClientEntete dans factureClientEntete
            $PosenteteFactClient = RestauPosfactureClientEntete::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->get(); 
            ...
            $PosligneFactClient = RestauPosFactureClientLigne::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->get(); 
            ...
            $PosenteteFactClt = RestauPosfactureClientEntete::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->first(); 
            ...
            $solde_initial = SessionRestau::where('societe',auth()->user()->societe)->where('id',$id_session_pos)->sum('solde_initial'); 
            $solde_final = $montant_recus + $solde_initial;
            SessionRestau::where('societe',auth()->user()->societe)->where('id',$id_session_pos)->update(['solde_cloture_theorique'=>$solde_final]);

            // *** Tres imoptant: Update table factureClientEntete avec montant_recu pour etre sur ***
            $montant_recuPosenteteFactClient = RestauPosfactureClientEntete::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->sum('montant_recu');
            factureClientEntete::where('societe',auth()->user()->societe)->where('id',$dernier_id)->update(['montant_recu'=>$montant_recuPosenteteFactClient]);
             ...
             // Suppression
            RestauPosfactureClientEntete::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->delete(); 
            RestauPosFactureClientLigne::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->delete();
    ...
    public function validerLieu(){
        ...
        if($test > 0){      
            ...
            if($autoriser == 1){  
                if($this->lieu_conso == 'Livraison'){           
                    RestauPosfactureClientEntete::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->update(['lieu_consommation'=>$this->lieu_conso,'date_consommation'=>date('Y-m-d H:i', strtotime($this->date_conso)),'adresse_livraison'=>$this->adresse_livraison]);
                }
                else{
                    $adresse_livraison = '';
                    RestauPosfactureClientEntete::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->update(['lieu_consommation'=>$this->lieu_conso,'date_consommation'=>date('Y-m-d H:i', strtotime($this->date_conso)),'adresse_livraison'=>$adresse_livraison]);
                }
        ...
        if($test > 0){ 
            ...
            if($autoriser == 1){
                ...
                if($test > 0){   
                    ...
                    $utiliateur = RestauCommandeAttenteEntete ::where('societe',auth()->user()->societe)->where('user_id',auth()->user()->id)->where('ref_table',$this->id_table_restau)->limit(1)->get();  
