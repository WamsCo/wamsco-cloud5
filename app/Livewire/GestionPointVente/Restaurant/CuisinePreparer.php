...
class CuisinePreparer extends Component
{
    use WithPagination;
    use WithFileUploads;
    ...
    public function render()
    {
        ...
        if($dateJour <= $jourValid){
            if($mod_cuisine == 1){
                ...
                // statut A préparer
                $emplacement_prepa = TableRestau::where('societe_id',auth()->user()->societe_id)->where('utiliser','Oui')->where('statut','A préparer')->orderBy('updated_at', 'DESC')->get(); 
                ...
                return view('livewire.gestion-point-vente.restaurant.cuisine.cuisine-preparer',compact('title_fils','module','lien','dateJour','emplacement_allCount','emplacement_prepa','emplacement_prepaCount','emplacement_encourCount',
