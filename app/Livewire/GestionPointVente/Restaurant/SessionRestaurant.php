...
class SessionRestaurant extends Component
{
    ...
    public function render()
    {
        ...
        if($dateJour <= $jourValid){
            if($mod_pointe_vente == 1){
                $title = 'Restaurant | WamsCo';
                $module = 'Gestion Point de vente';
                $title_fils = 'Restaurant';
                ...
                return view('livewire.gestion-point-vente.restaurant.session.session-restaurant',compact('title_fils','module','lien','dateJour','session','sessionCount','utilisat','nbreTotalSessionRestau','derniereActivite',
        ...
        if($test > 0){
            ...
            if($autoriser == 1){   
                ...
                if($countSession == 0){  
                     ...
                     $this->redirect('/detail_restau_session?id='.$dernier_id.'&ref='.$token_ok.'&active=5&champ=1-1', navigate: true);
                }
                else{
