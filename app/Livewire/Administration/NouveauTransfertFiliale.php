...
class NouveauTransfertFiliale extends Component
{
    public $id;  
    ...
    public function mount(){        
        ...
        $this->etiquette_transfert = 'Transfert de stock filiale '.date('Y-m-d H:i');
    }
    public function render()
    {
        ...
        if($dateJour <= $jourValid){
            if($mod_multisociete == 1){
                $title = 'Nouveau transfert entre filiale | WamsCo';
                $module = 'Multi-société';
                $title_fils = 'Nouveau transfert entre filiale';
                ...
                return view('livewire.administration.transfert_filiale.nouveau-transfert-filiale',compact('title_fils','module','lien','dateJour','listedeviseTva','log','logCount','liste_entit','listeProduit','listEntrepotOrigine','listEntrepotDestination',))->layout('components.layouts.app',compact('title','active','champ','choix','entite_mod','dateJour','soldeClient','nbjoursRestant'));
            }
            else{
                $title = 'Bienvenue'; 
                $module = 'Home';
