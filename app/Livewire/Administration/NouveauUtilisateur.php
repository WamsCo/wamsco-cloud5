    ...
    public function render(){
        ...
        if($dateJour <= $jourValid){
            if($mod_administration == 1){
                $title = 'Nouveau utilisateur | WamsCo';
                $module = 'Paramètres';
                $title_fils = 'Nouveau utilisateur';
                ...
                return view('livewire.administration.users.create_utilisateur',compact('title_fils','module','lien','dateJour','entite','departe','posteTravail','privillege','log','logCount','utilisa'))->layout('components.layouts.app',compact('title','active','champ','choix','entite_mod','dateJour','soldeClient','nbjoursRestant'));
            }
            else{
                $title = 'Bienvenue'; 
                $module = 'Home';
