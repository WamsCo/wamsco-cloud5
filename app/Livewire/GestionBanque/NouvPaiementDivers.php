...
class NouvPaiementDivers extends Component
{
    ...
    public function render(){
        ...
        if($dateJour <= $jourValid){
            if($mod_banque_caisse == 1){
                $title = 'Nouveau paiement divers | WamsCo';
                $module = 'Gestion Banque & Caisse';
                $title_fils = 'Nouveau paiement divers';
                ...
                return view('livewire.gestion-banque.nouv-paiement-divers',compact('title_fils','module','lien','dateJour','compteBancaire','infos','log','logCount'))->layout('components.layouts.app',compact('title','active','champ','choix','entite_mod','dateJour','soldeClient','nbjoursRestant')); 
            }
            else{
                $title = 'Bienvenue'; 
                $module = 'Home';
